...
/*if($_SESSION['location']['district_id']=='21')
	...
	//"http://192.168.1.254/epension/data.php";
		//$get_data = callAPI('GET', 'http://192.168.1.254/epension/data.php', $data);
		 //$get_data = callAPI('GET', '202.61.117.90/webfd/billDetailsWithBeneficiary.html', $data);
		 
		 //$get_data = callAPI('GET', 'http://192.168.1.59:90/ifms_testing/data.php', $data);
