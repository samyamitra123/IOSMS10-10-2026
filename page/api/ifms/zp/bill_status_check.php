...
//http://202.61.117.90/webfd/billStatus.html?drnNumber=
    
   // $url = "http://202.61.117.90/webfd/billStatus.html";

$data = array (
        'drnNumber' =>$drn_number
     );

 //$get_data = StatusCheckAPI('GET', 'http://202.61.117.90/webfd/billStatus.html', $data);
//$get_data = StatusCheckAPI('GET', '202.61.117.96/webfd/billStatus.html', $data);up
$get_data = StatusCheckAPI('GET', 'https://wbifms.gov.in/webfd/billStatus.html', $data);
