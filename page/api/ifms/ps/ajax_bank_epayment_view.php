...
$wrong_employee_data_fetch=$db->fetch_table("  SELECT 
												...
												WHERE benf.response_from='10' AND emp_id_pk='".$emp_id."'");
...
<div class="col-sm-12">
        ...
        <div class="form-group" style="height:50px;">
            <label for="inputEmail3" class="col-sm-3 control-label">Employee Name<span class="star_color">*</span></label>
            <div class="col-sm-3">
        ...
        <div class="form-group" style="height:50px;">
        <label for="inputPassword3" class="col-sm-3 control-label">Bank Name<span class="star_color">*</span></label>
        <div class="col-sm-3">
            <?
            $db = new database();
            $arr = $db->fetch_table("select bank_code,bank_name from prd_dise_bank_master order by bank_name");
    ...
    <div class="form-group" style="height:50px;">
        <label for="inputEmail3" class="col-sm-3 control-label">Account No <span class="star_color">*</span></label>
        <div class="col-sm-3">
...
function valid_code()
{ 
var sftp_bnf_id='<?php echo $benf_id; ?>';
	...
	$.post('<?= $config['base_url'] ?>page/api/ifms/ps/employee_bank_details_insert_epayment.php',$("#form_edit").serialize(), function(data){
	...
	{
		$.post('<?= $config['base_url'] ?>page/api/ifms/ps/epayment_wrong_data_edit.php?benf_id='+sftp_bnf_id, function (data) {
            //alert(data);
            $("#mbody").html(data);
            $("#empshow").html(data);
