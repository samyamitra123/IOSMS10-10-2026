...
var sftp_bnf_id='<?php echo $benf_id; ?>';
	...
	$.post('<?= $config['base_url'] ?>page/api/ifms/ps/employee_bank_details_insert.php',$("#form_edit").serialize(), function(data){
	...
	{
		$.post('<?= $config['base_url'] ?>page/api/ifms/ps/sftp_wrong_data_edit.php?benf_id='+sftp_bnf_id, function (data) {
            //alert(data);
            $("#mbody").html(data);
            $("#empshow").html(data);
