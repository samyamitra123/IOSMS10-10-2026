...
<div class="botton">
          <ul>
            ...
            <li>
            <!--<i class="fa fa-life-ring"></i> <img src="<?= $config['base_url'] ?>themes/default/image/support_mail.png" style="width:160px" />-->
            <a href="http://43.239.110.159:8092/" target="_blank"><img src="<?= $config['base_url'] ?>themes/default/img/techsupport.png" />
            </a>
            <li>
            <!--<div style="font-size:10px;margin: 3px;">Note: While Sending Email to Support Mention your Login ID not password including Phone Number to Contact</div>
            </li>
            <li>
            <div style="font-size:10px;margin: 3px;">Note: For Bill Deletion write to support mentioning DRN Number on BDO / EO / AEO Letter Head</div>
          </li>
            ...
            <li><div style="font-size:10px; margin: 3px;">Note: We generally answer all email during working hours.Do not call just after sending email. Wait for 1 day if not replied you may call us.</div>
            </li>
            <li><div style="font-size:10px; margin: 3px;">Note: Do not send uneccessary to head office for Information you may directly email us the problem we will revert back with soultion. </div>
            </li> -->
            <a href="<?=$config['base_url'] ?>readwrite/Operation_Manual_on_Employee_Basic_Change.pdf" target="_blank" rel="noopener noreferrer">
            <li><i class="fa fa-book"></i>  <span style="font-size:14px; font-weight:bolder;">Employee Basic Change Manual</span></li>
            </a>                       
            <?php if(strlen($_SESSION['user_info']['stake_user']) == 7 || strlen($_SESSION['user_info']['stake_user']) == 10) {?>
    ...
    <div class="modal-content">
	 ...
	 <h4 class="modal-title" id="myModalLabel">Confirm Logout</h4>
      ...
      <div class="modal-footer">
        <a class="btn btn-success btn-sm" href="<?=$config['base_url'] ?>page/logout.php">YES</a> 
