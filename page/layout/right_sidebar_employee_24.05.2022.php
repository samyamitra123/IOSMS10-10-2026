	...
	<span class="span">Login</span>
		...
		<input type="button" class="button" style="width: 100%" onclick="open_login_gp();" value="Gram Panchayat"/>
			...
			<div class="office_emp_login_gp" >
			  ...
			  <a style="margin-top: -38px; margin-left: 53%;" href="<?=$config['base_url'] ?>page/login.php?val=<?php echo $crypto->encode($emp,3); ?>"><i class="fa fa-key" style="color:#FF8A65;"></i>Employee Login</a>
			</div> 
