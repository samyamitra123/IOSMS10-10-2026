...
<link rel="stylesheet" type="text/css" href="<?php echo $config['base_url']; ?>themes/default/bootstrap_v5/css/bootstrap.css">
<link rel="stylesheet" type="text/css" href="<?php echo $config['base_url']; ?>themes/default/bootstrap_v5/css/bootstrap.min.css">

<script src="<?php echo $config['base_url']; ?>themes/default/bootstrap_v5/js/bootstrap.js" type="text/javascript"></script>
<script src="<?php echo $config['base_url']; ?>themes/default/bootstrap_v5/js/bootstrap.min.js" type="text/javascript"></script>
...
<!----- new development-------------------->
<script src="<?php echo $config['base_url']; ?>themes/default/js/jquery-ui.min-1.13.0-rc.2.js" type="text/javascript"></script>
<script src="<?php echo $config['base_url']; ?>themes/default/js/jquery-ui-1.13.0-rc.2.js" type="text/javascript"></script>
...
<link href="<?php echo $config['base_url']; ?>themes/default/css/jquery-ui.min-1.13.0-rc.2.css" rel="stylesheet" type="text/css">
<link href="<?php echo $config['base_url']; ?>themes/default/css/jquery-ui.structure.min-1.13.0-rc.2.css" rel="stylesheet" type="text/css">
<link href="<?php echo $config['base_url']; ?>themes/default/css/jquery-ui.structure-1.13.0-rc.2.css" rel="stylesheet" type="text/css">
<link href="<?php echo $config['base_url']; ?>themes/default/css/jquery-ui.theme.min-1.13.0-rc.2.css" rel="stylesheet" type="text/css">
<link href="<?php echo $config['base_url']; ?>themes/default/css/jquery-ui.theme-1.13.0-rc.2.css" rel="stylesheet" type="text/css">
