  ...
  <?php require '../../../common_back_btns.php'; ?>	
	...
	<div class="content">
      <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
        <div class="col-sm-12">
    <h1 class="heading">Edit Paychange Order</h1>
    <div class="border"></div>
		...
		if(isset($_GET['order_id']))
		{
			...
			$paychange_order = $db->fetch_table("select * from psemp_admin_paychange
											where paychange_id_pk=$order_id
										");
									
									//echo $paychange_order[0]['order_file_name'];
		}
		?>
        ...
        <form class="form-horizontal" action="paychange_order_edit_submit.php" name="form_emp_contact" id="form_emp_contact" method="post" enctype="multipart/form-data" >
                ...
                <div class="col-sm-3">
                <input type="text" class="form-control" autocomplete="off" name="activation_date"  id="create_date" placeholder="Enter Activation Date" value="<?php echo dbdate(trim($paychange_order[0]['paychange_fromdate']));?>">
                </div>
                </div>
                ...
                <input type="file" class="form-control" autocomplete="off" name="order_file"  id="order_file" value="">
                 ...
                 <label for="show" class="alert alert-info" style="text-align:center; padding:5px"><?php echo $paychange_order[0]['order_file_name'];  ?></label>
	       ...
	       <span style="color:#838683;font-weight:bold;">File Size must not be 0 and maximum file size should be 2MB.</span>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-5 col-sm-7">
                      <button type="submit" name="ptax_order_submit" id="btnSubmit" class="btn btn-info">SUBMIT</button>
                    </div>
                  </div>
                      <input type="hidden" name="ptax_id_pk" value="<?php echo $paychange_order[0]['paychange_id_pk']?>" />
                      <input type="hidden" name="file_name" value="<?php echo $paychange_order[0]['order_file_name'];?>" />
      	</form>
    </div>
</div>
</div>
