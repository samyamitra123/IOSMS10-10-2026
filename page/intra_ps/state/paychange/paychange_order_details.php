...
$cryptography=new cryptography();	
					 ...
					 $arr2 = $db->fetch_table("
										select count(*) AS count FROM psemp_admin_paychange									
									");
...
?>
<a href="<?= $config['base_url']?>page/intra_ps/state/paychange/paychange_order_insert.php" class="btn btn-info btn-sm">Add New Order</a><br/><br/>
...
<td>
<a href="<?=$config['base_url'] ?>page/intra_ps/state/paychange/paychange_order_download.php?order_file_name=<?php  echo $key['order_file_name']  ?>"><i class="fa fa-download fa-2x"></i></a>
