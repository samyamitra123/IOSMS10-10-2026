...
<div class="row" id="cont">
      <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
        <div class="col-sm-12">
<h1 class="heading">Reset Password For DA </h1>
...
<input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
    <form class="form-horizontal" method="post" name="login_form" action="<?= $config['base_url']?>page/intra_ps/changepassword/reset_password_insert_update.php" onsubmit="return validContact();">
    <div class="form-group">
    <div class="col-sm-2"></div>
    <label for="inputPassword3" class="col-sm-3 control-label">DA CODE: <span class="star_color">*</span></label>
    <div class="col-sm-3">
    <?php
			$db=new database();
			$ps_code=$db->fetch_table("SELECT ps_code FROM prd_location_master_panchayat_samiti WHERE ps_id_pk='".$_SESSION['location']['ps_id']."'");
			$ps_fetch=$db->fetch_table("SELECT stake_user FROM prd_stack_user_login WHERE stake_level_id_fk='37' AND stake_user like '".$ps_code[0]['ps_code']."%'");
	 ?>
	
	<input type="text" class="form-control" readonly name="da_code" id="da_code" value="<?php echo $_SESSION['location']['block_code'].'PSDA'; ?>" />
	
	<input type="hidden" class="form-control" readonly name="da" id="da" value="<?php echo $ps_fetch[0]['stake_user']?>" />
    </div>
    ...
    <div class="col-sm-offset-5 col-sm-7">
      <input type="submit" name="change_da" value="SUBMIT" class="btn btn-info">
    </div>
  </div>
