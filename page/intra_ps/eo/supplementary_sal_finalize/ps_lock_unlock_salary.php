...
$priv_salary_status=$db->fetch_table("select DISTINCT status_flag from prd_employee_salary_save where ps_id_fk = '".$_SESSION['location']['ps_id']."'AND delete_status='1' AND salary_monthyear='".date('Ym')."' AND is_saved='1' AND requisition_type='".$requisition_type."'");
...
if($query_lock){
	...
	$present_salary_status=$db->fetch_table("select DISTINCT status_flag from prd_employee_salary_save where ps_id_fk = '".$_SESSION['location']['ps_id']."'AND delete_status='1' AND salary_monthyear='".date('Ym')."' AND is_saved='1' AND requisition_type='".$requisition_type."'");
			...
			$security = $db->insert("
										...
										VALUES 			(
															...
															'".$priv_salary_status[0]['status_flag']."',
															'".$present_salary_status[0]['status_flag']."',
		...
		header('Location:ps_salary_locking.php');
	}
