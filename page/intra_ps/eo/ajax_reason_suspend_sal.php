...
$('#suspend_sal_employee').click(function(e) 
{
	...
	else
	{
		...
		$.post('<?= $config['base_url'] ?>page/intra_ps/eo/stop_start_suspend_submit.php?id='+link1+'&flag=suspend',$(this).closest("form").serialize(), function(data){
...
<table width="100%">
    ...
    <tr>
        ...
        <td id="td_suspention_header">
        	<input type="text" name="suspention_withdrawn_date" id="suspention_withdrawn_date" class="form-control col-md-2"  placeholder="DD-MM-YYYY" style="width: auto;" /> 
        </td>
        <td>
