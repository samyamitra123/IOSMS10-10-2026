...
?>
<div class="downpdf" align="right"><a href="<?= $config['base_url']?>page/intra_ps/eo/pdf_employe_details.php?id=<?php echo $_GET['id'] ?>"><img src="<?= $config['base_url'] ?>themes/default/image/pdf_download.png"/></a></div>
<div id="accordion">
