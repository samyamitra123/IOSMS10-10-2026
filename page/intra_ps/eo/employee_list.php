...
$arr=$db->fetch_table("select emp_first_name,emp_second_name,emp_last_name,emp_desig,emp_status,emp_id_pk,emp_system_code,gp_id_fk from prd_employee_master where emp_status in('6','1') AND ps_id_fk='".$_SESSION['location']['ps_id']."' order by emp_first_name");
