...
$mpdf->WriteHTML('<div class="segment">
				...
				<tr>
					...
					<td  class="col1" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;">NGIPF Account No :</td>
					<td style="width:25%;">'.$gpfAccountNo.'</td>
				</tr>
				<tr>
...
$mpdf->WriteHTML('<div class="segment">
				...
				<tr>
					...
					<td colspan="3" style="width:25%;">'.fun_common( $emp_data[0]['emp_desig'],$code_data).'</td>
				</tr>
				<tr>
