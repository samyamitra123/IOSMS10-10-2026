            ...
            <div class="col-sm-12" style="width:98%;">
                ...
                <div id="form_show" class="dashcontenr invisible"> 
                    <form class="form-horizontal" name="teacher_info" id="teacher_info" method="post" action="profile_entry_prof_insert.php" onsubmit="return validateCode();">
                        ...
                        <input type="hidden" name="emp_id_pk" value="<?= $cryptoGraph->decode($_GET['emp_id_pk'],4) ?>" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="first_join_date" id="first_join_date"  placeholder="DD-MM-YYYY" autocomplete="off" value="<?=$emp_first_join_date=='0001-01-01' ? '' : dateshow($emp_first_join_date);?>" readonly style="background-color:#FFF;cursor:pointer;">
                            </div>
                        </div>
                       ...
                       <div class="row mb-3">
                            ...
                            <div class="col-sm-3 confirm_date_div" style="display:none"> 
                                <input type="text" class="form-control" name="confirm_date" id="confirm_date" placeholder="DD-MM-YYYY" autocomplete="off" value="<?=$emp_conf_join_date=='0001-01-01' ? '' : dateshow($emp_conf_join_date);?>" readonly style="background-color:#FFF;cursor:pointer;">
                            </div>
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="present_post_date" id="present_post_date" placeholder="DD-MM-YYYY" autocomplete="off"  value="<?=$emp_join_prsnt_post_date=='0001-01-01' ? '' : dateshow($emp_join_prsnt_post_date);?>" readonly style="background-color:#FFF;cursor:pointer;"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="present_office_date" id="present_office_date" placeholder="DD-MM-YYYY" autocomplete="off"  value="<?=$emp_join_prsnt_office_date=='0001-01-01' ? '' : dateshow($emp_join_prsnt_office_date);?>" readonly style="background-color:#FFF;cursor:pointer;">
                            </div>
                            <label for="inputPassword3" class="col-sm-3 control-label">Date of Retirement / Termination <span class="star_color">*</span></label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="emp_date_retirement" id="emp_date_termination" readonly placeholder="DD-MM-YYYY" autocomplete="off"  value="<?  echo dateshow($emp_retirement_date); ?>">
                            </div>
                        </div>
	...
	<? } ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <?
                                $db = new database();
                                $arr = $db->fetch_table("select code,description from prd_dise_code_master where length(code)=4 and (code like '90%') or(code like '11%') and code in('9001','9002','9003','9004','9005','9006','9007','9008','9009','9012','9013','9014','9015','9016','9017','1114','1115','1118','1117') order by code");
                                ?>
                                <select class="form-control" name="first_desig" id="first_desig">
                                    ...
                                    <option value="<?= $key['code']; ?>" 
                                    <? 
                                    if($emp_desig_first_app==$key['code'] || $first_desig==$key['code']){ echo "selected";}?>><?php if($key['code']=='1114' ||$key['code']=='1115'||$key['code']=='1118'||$key['code']=='1117')
                                    {
                                        echo 'GP&nbsp;';
                                    }
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control"  name="increment_date" id="increment_date"  placeholder="DD-MM-YYYY" autocomplete="off"  value="<?=$emp_next_increment_date=='0001-01-01' || $emp_next_increment_date=='01-01-1970'  ? '' : dateshow($emp_next_increment_date);?>" readonly style="background-color:#FFF;cursor:pointer;">
                            </div>
                        </div>
...
<script>
	...
	{
		if(type=='9012' || type=='9013' || type=='9014'|| type=='9015'|| type=='9016' ||type=='9017')
		{
			$('#deput_label').hide();
			$('#deput_field').hide();
			$('#group_label').hide();
	...
	function validateCode()
	{
		...
		if($('#vice_desig').val()!='9012' && $('#vice_desig').val()!='9013' && $('#vice_desig').val()!='9014' && $('#vice_desig').val()!='9015' && $('#vice_desig').val()!='9016' && $('#vice_desig').val()!='9017')
		{
			if($('#deputation').val()=='')
			{
	...
	function valid_updation()
	{
		...
		if(emp_desig!='9012' && emp_desig!='9013' && emp_desig!='9014' && emp_desig!='9015' && emp_desig!='9016' && emp_desig!='9017')
		{
		...
		{
			var val_emp_status_deputation=0;
			var val_emp_group=0;
		}
		//alert(emp_group + val_emp_group);
		/*var val_emp_group= $('#employee_group').val();
		alert(val_emp_group);*/
	...
	/*******************Visibility of Form*********************/
		...
		if(document.getElementById('desg').value=='9012' || document.getElementById('desg').value=='9013' || document.getElementById('desg').value=='9014' || document.getElementById('desg').value=='9015' || document.getElementById('desg').value=='9016' || document.getElementById('desg').value=='9017')
		{
			$('#deput_label').hide();
			$('#deput_field').hide();
			$('#group_label').hide();
