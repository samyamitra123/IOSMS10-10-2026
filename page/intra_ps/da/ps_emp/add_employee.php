...
<input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
    ...
    <div class="col-sm-2"></div>
      <label for="inputEmail3" class="col-sm-3 control-label">Select Type: <span class="star_color">*</span></label>
    <div class="col-sm-3">
     <select name="type" id="type" class="form-control">
      <option value="">Please Select</option>
      <option value="1">New Employee</option>
      <option value="2">Transferred Employee</option>
     <option value="3">Direct Recruitment under PRI as Department Candidate</option>
     </select>
    </div>
    <div class="col-sm-3">
    </div>
