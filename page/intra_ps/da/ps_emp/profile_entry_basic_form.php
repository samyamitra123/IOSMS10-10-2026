...
<form class="form-horizontal" id="first_form" method="post" action="profile_entry_basic_insert.php" onsubmit="return valid_code();"> 
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="tch_dob" name="tch_dob" onChange="calculate_retireyear(this.value)" value="<?=$tch_dob=='0001-01-01' ? '' : dateshow($dob);?>" placeholder="DD-MM-YYYY" readonly style="background-color:#FFF;cursor:pointer;" />
    </div>
