...
function generate_excel()
{
	...
	window.location.href= "salary_requisition_excel_ropa_2019.php?year="+year+"&month="+month;
}
	...
	?>
           <div class="row mb-3">
              <div class="col-sm-4"></div>
                    ...
                    <div class="row mb-3">
                       <div class="col-sm-4"></div>
                        <label for="inputPassword3" class="col-sm-2 control-label" style="margin-top:.23cm;color:#0070A3;">Select Month<span class="star_color">*</span>:</label>
                           <div class="col-sm-4">
                          <select class="form-control upper_case" name="month" id="month" style="width:150px;" >
                            <option value="">-Please Select-</option>
                  ...
                  <div class="col-sm-12" style="margin-top:15px; margin-left: 39%;">
