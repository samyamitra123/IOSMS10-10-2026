...
<div id="dialog-confirm" title="Do you want to finalize your requisition?">
      ...
      <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
        <div class="col-sm-12">
<h1 class="heading">Employee Salary Requisition ROPA 2009</h1>
...
?>
<div class="border_val" style="width: 98%;"></div>
...
<div class="school">
          ...
          <?php
$db = new database();
	$id_const= $db->fetch_table("SELECT * FROM
							prd_employee_master 
							WHERE
							ps_id_fk =  '".$_SESSION['location']['ps_id']."'
							AND (emp_status='1' OR emp_status='9')
...
?>
    ...
    <?php if($_SESSION['location']['ps_id']=='88')
{?>
...
<?php require_once 'ps_requisition_form.php'; 
