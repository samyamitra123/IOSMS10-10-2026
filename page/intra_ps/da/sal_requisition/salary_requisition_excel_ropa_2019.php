...
//-------------------------------------------------------QUERY-----------------------------------------------------------------
	...
	/*$tch= $db->fetch_table("SELECT sal.ps_id_fk,tch.emp_status, sal.empcd, 
			   ...
			   sal.overdrawn, sal.salary_type, sal.cause, sal.part_day,   sal.gsli,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.hra_deduction,
									...
									INNER JOIN 
										...
										AND sal.status_flag in('1','2','3')  AND sal.delete_status='1' AND salary_monthyear='".$monthyear."' 
		...
		$tch= $db->fetch_table("SELECT sal.ps_id_fk,tch.emp_status, sal.empcd, 
				   ...
				   sal.overdrawn, sal.salary_type, sal.cause, sal.part_day, sal.ropa_level,  sal.gsli,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.hra_deduction,
										...
										INNER JOIN 
											...
											AND sal.ps_id_fk = '".$_SESSION['location']['ps_id']."'
											AND sal.net != '0' AND sal.delete_status='1'
											AND sal.status_flag in('1','2','3','4')  AND sal.delete_status='1' AND salary_monthyear='".$monthyear."' 
											AND is_saved='1'  AND requisition_type='".$requisition_type."' AND sal.ropa_status IN ('1')
											order by tch.emp_first_name ;
									");
	}
	else
	{
		...
		$tch= $db->fetch_table("SELECT sal.ps_id_fk,tch.emp_status, sal.empcd, 
				   ...
				   sal.spl_alo,sal.status_flag, sal.salary_monthyear,sal.consolidated_pay, 
				   sal.category_id, sal.block_code, sal.emp_id_fk, sal.pay_payband, sal.tch_grade_pay, 
				   sal.hill_allowance, sal.gpf, sal.gross_salary, sal.is_saved, sal.conv_allow, sal.ropa_level,
				   sal.overdrawn, sal.salary_type, sal.cause,  
				   sal.gsli,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.hra_deduction,
											tch.emp_first_name,
											tch.emp_second_name,
											tch.emp_desig,
											tch.emp_last_name,
										...
										INNER JOIN 
											...
											AND sal.ps_id_fk = '".$_SESSION['location']['ps_id']."'
											AND sal.net != '0' AND sal.delete_status='1'
											AND sal.status_flag IN ('3','4') AND sal.delete_status='1' AND salary_monthyear='".$monthyear."' 
											AND is_saved='1'  AND requisition_type='".$requisition_type."' AND sal.ropa_status IN ('1')
											order by tch.emp_first_name 
									");
...
<table width="100" border="1">
  ...
  <tr>
    ...
    <th scope="col">GPF</th>
    <th scope="col">PF-LOAN RECOVERY</th>
