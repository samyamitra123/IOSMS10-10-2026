...
$.post('<?= $config['base_url'] ?>page/intra_ps/da/supplementary_sal/ajax_ps_requisition_edit.php?id='+link+'&ps_id='+link1, function(data){                    
$("#mbody").html(data);
});
});
...
$.post('<?= $config['base_url'] ?>page/intra_ps/da/supplementary_sal/ajax_ps_rq_save.php?emp_id_pk='+emp_id_pk+'&empcd='+empcd+'&sec_tok='+sec_tok, function(data){
//alert(data);
...
$.post('<?= $config['base_url'] ?>page/intra_ps/da/supplementary_sal/ajax_ps_rq_finalize.php', function(data){
//alert(data);
//$("#mbody").html(data);
});
});
