...
<div class="col-sm-6">
    ...
    <div class="col-sm-6 ">
        <div style="width:140px; margin-left:70%; border:rgb(60, 175, 187) 3px solid; text-align:center; padding-top:3px; box-shadow: 7px 7px 7px #888888; border-radius: 5px;">
			<?php 
            if($query[0]['ps_status']=='0' )
            { ?>
        		<a data-bs-toggle="modal" data-bs-target="#send" style="cursor:pointer;"><i class="fa fa-share-square-o fa-2x reason_view" aria-hidden="true"><span class="tooltiptext">Send To EO</span></i></a>
        	<?php 
			}
        	else
        	{ ?>
        	...
        	if($query[0]['ps_status']=='0' || $query[0]['ps_status']=='3' || $query[0]['ps_status']=='8')
        	{ ?>
...
<div class="downpdf" style="margin-left:88%"><a href="<?= $config['base_url']?>page/intra_ps/da/pdf_ps_profile_details.php"><img src="<?= $config['base_url'] ?>themes/default/image/pdf_download.png"/></a></div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">VTC Details</h4>
      </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
     <div class="modal-header">
      ...
      <div class="modal-body"> 
      <p class="alert alert-warning"><strong><i class="fa fa-exclamation-triangle"></i> Do You Want To Send This PS Profile For Approval ?</strong></p>
      </div>
      <div class="modal-footer">
      <div class="btn-group">
        <a class="btn btn-success" href="<?php echo $config['base_url'] ?>page/intra_ps/da/sent_ps_profile.php?action=<?php echo $sent ?>">YES</a> 
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
     <div class="modal-header">
      ...
      <div class="modal-body"> 
      <p class="alert alert-warning"><strong><i class="fa fa-exclamation-triangle"></i> Do You Want To Send This PS Profile For Unlock ?</strong></p>
      </div>
      <div class="modal-footer">
      <div class="btn-group">
        <a class="btn btn-success" href="<?php echo $config['base_url'] ?>page/intra_ps/da/sent_ps_profile.php?action=<?php echo $unlock_sent ?>">YES</a> 
        <button type="button" class="btn btn-warning" data-bs-dismiss="modal">NO</button>      
      </div>
      </div>
    </div>
