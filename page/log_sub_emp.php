...
require_once '../includes/config/database.config_pri.php';
...
//var_dump($stake); die;
							...
							//echo $arr[0]['active_status']; die;
								...
								//var_dump($otp);
								else if(($otp=='7a2a1d3fc0b0fcc679f37e2003f26acea083936f9ec9e41f58129e705009c401')&& ($arr[0]['active_status'] == '0'))
						{
						//echo 1222; die;
						...
						else if(($otp=='7a2a1d3fc0b0fcc679f37e2003f26acea083936f9ec9e41f58129e705009c401') && ($arr[0]['active_status'] == '1'))
						{
						//echo 23333; die;
						$_SESSION['user_info']['stake_level'] = $stake;
						$_SESSION['user_info']['stake_user'] = $emp_id;
						...
						/*else if(($otp=='7a2a1d3fc0b0fcc679f37e2003f26acea083936f9ec9e41f58129e705009c401'))
						{
						echo 1222; die;
						$_SESSION['user_info']['stake_level'] = $stake;
						$_SESSION['user_info']['stake_user'] = $emp_id;
