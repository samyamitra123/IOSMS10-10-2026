...
WHERE SUBSTRING(cast(mas.emp_retirement_date as text),1,7)='".date("Y-m", strtotime("+13 months"))."' 
...
where date = max_my_date and reason='1993' AND (SUBSTRING(cast(date as text),1,7)>='".date("Y-m", strtotime("-1 months"))."') and SUBSTRING(cast(date as text),1,7)<='".date("Y-m", strtotime("+1 months"))."') as stop ON mas1.emp_id_pk=stop.emp_id_fk )");
...
from prd_employee_master mas WHERE  mas.emp_id_pk='".$mas_data['emp_id_pk']."' and SUBSTRING(cast(mas.emp_retirement_date as text),1,7)<='".date("Y-m", strtotime("+13 months"))."'
AND mas.emp_status in('1') AND mas.gp_id_fk NOT IN('3355','3380','3383','3400','3401','3402','3403') 
AND (mas.zp_id_fk is null or mas.zp_id_fk not in('21'))
and (mas.ps_id_fk!='0' or mas.gp_id_fk!='0' or (mas.zp_id_fk!='0' and mas.zp_emp_type='367'))
 AND mas.ps_id_fk NOT IN ('342','343') AND mas.emp_id_const!='0' 
AND mas.emp_desig NOT IN('1120','1124','9012','9013','9014','9015','9016','9017','1'))
...
AND mas.emp_status in('2') AND mas.gp_id_fk NOT IN('3355','3380','3383','3400','3401','3402','3403') 
AND (mas.zp_id_fk is null or mas.zp_id_fk not in('21'))
and (mas.ps_id_fk!='0' or mas.gp_id_fk!='0' or (mas.zp_id_fk!='0' and mas.zp_emp_type='367'))
 AND mas.ps_id_fk NOT IN ('342','343') AND mas.emp_id_const!='0'
 AND mas.emp_desig NOT IN('1120','1124','9012','9013','9014','9015','9016','9017','1'))mas1
...
from prd_stop_sal_reason)A where date = max_my_date and reason='1993' AND (SUBSTRING(cast(date as text),1,7)>='".date("Y-m", strtotime("-1 months"))."') and SUBSTRING(cast(date as text),1,7)<='".date("Y-m", strtotime("+1 months"))."') as stop ON mas1.emp_id_pk=stop.emp_id_fk ))b");										
...
from prd_stop_sal_reason)A where date = max_my_date and reason='1993') as stop ON pen.emp_id_fk=stop.emp_id_fk 
 where emp.emp_pension_status='2' 
