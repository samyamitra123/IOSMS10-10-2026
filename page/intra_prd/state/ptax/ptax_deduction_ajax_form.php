...
<?php 
	 				$db = new database();
					$ptax_deduction = $db->fetch_table("select pd.ptax_id_pk,pd.mn_amount,pd.mx_amount,pd.ptax_amount,pd.ptax_order_id_fk from ehrms_ptax_deduction as pd 
													INNER JOIN ehrms_ptax_order_file as pf ON pd.ptax_order_id_fk=pf.ptax_orderfile_pk  WHERE pf.active_status=1 ORDER BY pd.ptax_id_pk
												");
  ...
  <div class="dashboard-main"> 
    ...
    <div class="dashcontenr"> 
      ...
      <!-- <link href='http://fonts.googleapis.com/css?family=Engagement' rel='stylesheet' type='text/css'>-->
        ...
        <form action="page/intra_ehrms/state/ptax/ptax_deduction_insert_submit.php" name="form_emp_contact" id="form_emp_contact" method="post" enctype="multipart/form-data" onsubmit="return validContact();" >
