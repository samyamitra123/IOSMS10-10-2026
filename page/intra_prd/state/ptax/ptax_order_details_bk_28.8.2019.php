...
?>
     <a href="<?= $config['base_url']?>page/intra_prd/state/ptax/ptax_order_insert.php" class="btn btn-info btn-sm">Add New Order</a><br/><br/>
...
<td>
<a href="<?=$config['base_url'] ?>page/intra_prd/state/ptax/ptax_order_download.php?order_file_name=<?php  echo $key['file_name']  ?>"><i class="fa fa-download fa-2x"></i></a>
</td>
