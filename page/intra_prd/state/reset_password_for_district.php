...
<script>
  ...
  if(document.getElementById('pass_chk').value!='yes'){
	...
	function fun_block(district_id){
		   ...
		   $('#loader').show();
			$.post('<?= $config['base_url']?>page/intra_prd/block/block_list.php',{district_id:district_id},function(data){
			    //alert(data) ;
...
<div class="row" id="cont">
      <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
        <div class="col-sm-12">
<h1 class="heading"> Reset Password For District </h1>
...
<input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
    ...
    <div class="col-sm-3">
      <select class="form-control upper_case" name="district" id="district_name">
      <option value="">-Please Select-</option>
        <?php 
				
				$district = $db->fetch_table("select district_code,district_name from prd_location_master_district") ; 
				?>
                 <?php
    ...
    <div class="col-sm-offset-5 col-sm-7">
      <input type="submit" name="change_district" value="SUBMIT" class="btn btn-info">
    </div>
  </div>
