		  ...
		  ////alert($('#line').val());
			...
			$.post('block_code.php',{block_code:block_code},function(data){
				...
				else
				{
					...
					document.getElementById('tan_no').value = item['tan_no'] ;
    ...
    <? if($_GET['msg_er']){
        ...
        <input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
                ...
                <?php
                    ...
                    $district_name = $db->fetch_table("
						select district_code,district_name from prd_location_master_district order by district_name
					");
					$name="<option value=''>-Please Select-</option>";
					foreach($district_name as $item){
						//echo $item['district_code']." ".$item['district_name'] ;
						$name.="<option value='".$item['district_code']."'>".$item['district_name']."</option>";
						//echo $name ;
					}
                    ?>
                    <select name="district_name" id="district_name" class="form-control" onchange="return block_name_fetch(this.value)">
                    <?php echo $name ; ?>
                    </select>
                </div>
                </div>
                ...
                <div class="form-group">
                <div class="col-sm-2"></div>
                <label for="WithEffectFrom" class="col-sm-3 control-label">Treasury Block Code<span class="star_color">*</span></label>
                <div class="col-sm-3">
                <input type="text" class="form-control upper" autocomplete="off" name="treasury_block_code"  id="treasury_block_code" placeholder="Enter Treasury Block Code" onkeypress="return keyRestrict(event,'0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-');">
                   ...
                   <div class="form-group">
                <div class="col-sm-2"></div>
                <label for="WithEffectFrom" class="col-sm-3 control-label">Designation of Block<span class="star_color">*</span></label>
                <div class="col-sm-3">
                <input type="text" class="form-control upper" autocomplete="off" name="desig_block"  id="desig_block" placeholder="Designation of Block" onkeypress="return keyRestrict(event,'0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-');">
                </div>
                </div> 
                  ...
                  <div class="form-group">
                <div class="col-sm-2"></div>
                <label for="WithEffectFrom" class="col-sm-3 control-label">Line1<span class="star_color">*</span></label>
                <div class="col-sm-3">
               ...
               <div class="form-group">
                <div class="col-sm-2"></div>
                <label for="WithEffectFrom" class="col-sm-3 control-label">Duration of Permanent Post(for Approval)</label>
                <div class="col-sm-3">
                <input type="text" class="form-control upper" autocomplete="off" name="dpp"  id="dpp" placeholder="Duration of Permanent Post" onkeypress="return keyRestrict(event,'0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-');">
                </div>
                </div>         
                 ...
                 <div class="form-group">
                <div class="col-sm-2"></div>
                <label for="WithEffectFrom" class="col-sm-3 control-label">TAN No :</label>
                <div class="col-sm-3">
                <input type="text" class="form-control upper" autocomplete="off" name="tan_no"  id="tan_no" placeholder="Enter Tan No." onkeypress="return keyRestrict(event,'0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-');">
                </div>
                </div>       
