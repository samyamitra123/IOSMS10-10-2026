	...
	<div class="mainContent float_l" style="min-height: 400px;">
		<script>
			...
			$("#year,#month").change(function(){
				...
				$("#show1").html('<a class="btn btn-info btn-sm" href="monthly_salary_status.php?mo='+mo+'&ye='+ye+'" style="width: 90%;text-align: left;"><i class="fa fa-file-text"></i>  Salary Submission Status Report</a>');
            ...
            <div class="form-group">
            	<label for="inputPassword3" class="col-sm-3 control-label">Salary Report Month: </label>
            		...
            		<label for="inputPassword3" class="col-sm-3 control-label">Salary Report Year: </label>
                        ...
                        <div class="form-group">
                        <div class="col-sm-offset-3 col-md-4"  id="show1"></div>
                        </div>
                         <div class="form-group">
