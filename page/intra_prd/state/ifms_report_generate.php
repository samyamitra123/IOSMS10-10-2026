...
<div style="padding:10px">
	...
	<div class="mainContent float_l" style="min-height: 400px;">
		<script>
			...
			$("#stake,#year,#month").change(function(){
				//alert('123');
				...
				$("#show").html('<a class="btn btn-info btn-sm" href="ifms_details_report.php?stk='+stk+'&mo='+mo+'&ye='+ye+'" style="width: 90%;text-align: left;"><i class="fa fa-file-text"></i>  IFMS UPLOAD DETAILS</a>');
