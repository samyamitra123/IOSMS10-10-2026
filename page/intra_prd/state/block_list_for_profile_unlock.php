...
WHERE district_id_fk='".$cryptoGraph->decode($_REQUEST['id'],4)."'
order by block_code");
?>
<style>
h1 {
...
<td class="view"><a class="btn btn-primary" href="<?= $config['base_url'] ?>page/intra_prd/state/unlock_bdo_profile.php?id=<?= $cryptoGraph->encode($item['block_code'],4);?>"><i class="fa fa-lock"></i></a></td>
<? }else if($item['block_status']=='6'){ ?>
