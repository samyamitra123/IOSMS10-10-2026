...
<td><?= $item['gp_name']?></td>
<td><?= $item['total'] ?> </td>
<td><a href="<?= $config['base_url'] ?>page/intra_prd/state/update_bank_details.php?gp_id=<?= $cryptoGraph->encode($item['gp_id_pk'],4);?>"><img src="<?= $config['base_url'] ?>themes/default/image/view_icon.png" width="25" alt="view" /></a></td></tr>
<?php $cnt++;} ?> 
<tr>
<td></td>
<td></td>
