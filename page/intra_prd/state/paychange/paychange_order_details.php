...
<td>
<a href="<?=$config['base_url'] ?>page/intra_prd/state/paychange/paychange_order_download.php?order_file_name=<?php  echo $key['order_file_name']  ?>"><i class="fa fa-download fa-2x"></i></a>
