<?
//echo 'PHP Version: ' . phpversion();exit;
...
$arr=$db->fetch_table("select emp_first_name,emp_status,emp_second_name,emp_last_name,emp_id_pk,emp_form_status,emp_id_pk,emp_desig,emp_status,recruitment_type from prd_employee_master where emp_form_status in('1','2','3','4','5') AND emp_status in('10','7','11') AND gp_id_fk='".$_SESSION['location']['gp_id']."' order by emp_first_name");
...
<td><? if(($item['emp_form_status']=='1' || $item['emp_form_status']=='2' || $item['emp_form_status']=='3' || $item['emp_form_status']=='4' || $item['emp_form_status']=='5') && $item['emp_status']!='11' ){ ?>
...
<td>
<? if(($item['emp_form_status']=='3'|| $item['emp_form_status']=='4' || $item['emp_form_status']=='5') && $item['emp_status']!='11'){ ?>
...
<td><? if(($item['emp_form_status']=='4' || $item['emp_form_status']=='4' || $item['emp_form_status']=='5') && $item['emp_status']!='11'){ ?>
...
<td><? if($item['emp_form_status']=='5' && $item['emp_status']!='11' ){ ?>
...
<td class="sendtoddo"><? if($item['recruitment_type']!='0' && $item['emp_form_status']=='5'){ ?><a href="<?php echo $cryptoGraph->encode($item['emp_id_pk'],4) ?>"><img width="25" src="<?= $config['base_url'];?>themes/default/image/send.png" alt="Edit"/></a>
<? } else{ ?>
