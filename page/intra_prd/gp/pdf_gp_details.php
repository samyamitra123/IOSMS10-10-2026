...
$db=new database();
$data=$db->fetch_table("select gp_id_pk,gp_code,gp_name,block_id_fk,flag from prd_location_master_gp where gp_id_pk='".$_SESSION['location']['gp_id']."'");
...
$mpdf->WriteHTML('<div class="segment">
				...
				<tr>
					...
					<td style="text-transform:uppercase;">'.$pradhan_name.'</td>
...
$mpdf->Output('GP PROFILE OF '.$_SESSION['location']['gp_name'].'.pdf','D');								
?>