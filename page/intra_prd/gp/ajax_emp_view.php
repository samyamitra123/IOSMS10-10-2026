...
if($_SESSION['location']['gp_id']!=''){
$emp_data=$db->fetch_table("select * from prd_employee_master where emp_id_pk='".$cryptoGraph->decode($_REQUEST['id'],4)."' AND gp_id_fk='".$_SESSION['location']['gp_id']."'");
}else{
$emp_data=$db->fetch_table("select * from prd_employee_master where emp_id_pk='".$cryptoGraph->decode($_REQUEST['id'],4)."' AND block_id='".$_SESSION['location']['block_id']."'");
}
...
?>
<!--<div class="downpdf" align="right"><a href="<?= $config['base_url']?>page/intra_prd/gp/pdf_employe_details.php?id=<?php //echo $_GET['id'] ?>"><img src="<?= $config['base_url'] ?>themes/default/image/pdf_download.png"/></a></div>-->
<div id="accordion">
       <h3 id="att" onclick=""> Primary Profile </h3>
        ...
        <table border="0" width="100%">
                ...
                <tr>
					...
					<td colspan="3"><?php echo  $emp_data[0]['emp_first_name'].' '.$emp_data[0]['emp_second_name'].' '.$emp_data[0]['emp_last_name'] ; ?></td>
				</tr>
				<tr>
                ...
                <tr>
					...
					<td><?php
					echo strtoupper($emp_data[0]['emp_voter_id']);
					 ?></td>
        ...
        <table border="0" width="100%">
				<tr>
					...
					<td colspan="3" style="text-transform:uppercase;"><?php echo fun_common( $emp_data[0]['emp_desig'],$code_data); ?></td>
				</tr>
				<tr>
                ...
                <?php if($emp_data[0]['emp_desig']!='1120' && $emp_data[0]['emp_desig']!='1124'){ ?> 
                <tr>
 ...
 ?>
        ...
        <table border="0" width="100%">
                ...
                <tr>
					...
					<td><?php echo fun_common($emp_data[0]['emp_spouse_job_status'],$code_data);?></td>
					<td class="text_r">Details of employment :</td>
