...
//-------------------------------------------------------QUERY-----------------------------------------------------------------
	...
	$tch= $db->fetch_table("SELECT 
       ...
       sal.hill_allowance, sal.gpf, sal.cpf_deduct, sal.gross_salary, sal.is_saved, sal.conv_allow,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,sal.hbl_loan,festival_loan,sal.ropa_level,
...
<table width="200" border="1">
  <tr>
  <th colspan="25" style="text-align:center;"><br /><br />DETAILED SALARY BILL OF Grant-in-aid Employees UNDER <?= $_SESSION['location']['gp_name']?> GP FOR THE MONTH OF <?= GetMonthString(date('m')).", ".date(Y) ?><br /><br /></th>
  </tr>
 <tr>
...
<tr>
<th colspan="24" style="text-align:right; border:none;"><br /><br /><br />Gram Pradhan OF <?= $_SESSION['location']['gp_name']?> GP</th>
</tr>
</table>
