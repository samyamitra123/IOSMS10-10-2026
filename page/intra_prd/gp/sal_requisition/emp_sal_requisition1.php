...
//-----------------------------Business Logic----------------------------------------------------------------------------------
	...
	/*$tch_emp= $db->fetch_table("
								select 
                                    count(CASE WHEN emp_status='1' and emp_desig<>'1120' THEN 1 ELSE null END) as total_emp,
                                    count(CASE WHEN emp_status='1' and emp_desig<>'1120' and interim_relief>0 or interim_relief!=NULL THEN 1 ELSE null END) as total_ir_emp
                                    from 
									prd_employee_master WHERE gp_id_fk = '".$_SESSION['location']['gp_id']."'
...
<?php require_once 'requisition_form1.php'; 
