...
<input type="hidden" name="desig" value="<?= $emp_desig ?>" />
 ...
 <input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
  ...
  <?php if($emp_desig!='1120' && $emp_desig!='1124' ) 
   {
   ...
   <?php } else if ($sname[0] != "" && $emp_spouse_pay=="")
	   { ?>
       <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-3 control-label" id="spouse_employee_label" style="display:none">Whether Spouse is Employed<span class="star_color">*</span></label>
    <div class="col-sm-3" id="spouse_employee_field" style="display:none">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-3" id="spouse_hra_div" style="display:none">
     ...
     <div class="row mb-3">
     <label for="inputPassword3" class="col-sm-3 control-label" id="spouse_medical_tr">Spouse Opted for enrolment in WB Health Scheme / Employee Opted for enrolment in Swasthya Sathi:<span class="star_color">*</span></label>
    <div class="col-sm-3" id="spouse_medical_div">
       <select name="spouse_medical_allowance" class="form-control">
