...
<? } ?>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control"  name="increment_date" id="increment_date"  placeholder="DD-MM-YYYY" autocomplete="off"  value="<?=$emp_next_increment_date=='0001-01-01' || $emp_next_increment_date=='01-01-1970'  ? '' : dateshow($emp_next_increment_date);?>" readonly="readonly" style="background-color:#FFF;cursor:pointer;">
    </div>
  </div>
  <div class="row mb-3">
