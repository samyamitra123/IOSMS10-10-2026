...
WHERE salary_monthyear='".$monthno."' AND status_flag IN ('3', '4') AND emp_id_fk='".$crypto->decode($_REQUEST['id'],4)."' AND ropa_status='".$ropa_status."'");
...
$key= $db->fetch_table(" select
   ...
   FROM prd_employee_salary_save as sal INNER JOIN prd_employee_master as tch ON sal.emp_id_fk = tch.emp_id_pk 
    ...
    WHERE
										tch.emp_id_pk='".$crypto->decode($_REQUEST['id'],4)."'
