...
<?
$db=new database();
$arr=$db->fetch_table("select emp_id_const,emp_first_name,emp_second_name,emp_last_name,emp_desig,emp_status,emp_id_pk,emp_system_code,gp_id_fk from prd_employee_master where emp_status in('1','9') AND gp_id_fk='".$cryptoGraph->decode($_REQUEST['id'],4)."' order by emp_id_const");
