...
header('Content-Disposition: attachment; filename=Salary_Requisition_Excel.xls');
...
//-------------------------------------------------------QUERY-----------------------------------------------------------------
	...
	$tch= $db->fetch_table("SELECT 
       ...
       sal.category_id, sal.block_code, sal.emp_id_fk, sal.pay_payband, sal.tch_grade_pay,sal.ropa_level ,
       sal.hill_allowance, sal.gpf, sal.cpf_deduct, sal.gross_salary, sal.is_saved, sal.conv_allow, 
       sal.overdrawn, sal.salary_type, sal.cause, sal.gp_code,sal.part_day,sal.gsli,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,sal.hbl_loan,festival_loan,sal.interim_relief,
										gp.gp_name,
										emp.emp_first_name,
										emp.emp_second_name,
										emp.emp_last_name,
...
if(count($tch)==0)
{
	...
	$tch= $db->fetch_table("SELECT 
       ...
       sal.block_code, sal.emp_id_fk, sal.pay_payband, sal.tch_grade_pay, sal.ropa_level ,
...
<table width="200" border="1">
  <tr>
  <th colspan="24" style="text-align:center;"><br /><br />SALARY REQUISITION EXCEL FOR THE EMPLOYEES UNDER <?= $_SESSION['location']['block_name']?> BLOCK FOR THE MONTH OF <?= GetMonthString($_REQUEST['mo']).", ".$_REQUEST['ye'] ?><br /><br /></th>
  </tr>
 <tr>
...
<th colspan="5" style="text-align:right; border:none;"><br />Actual Gross pay amount in Bill Summary is inclusive of overdrawn amount and Festival Advance Recovery .</th>
