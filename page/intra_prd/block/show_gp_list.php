...
$arr=$db->fetch_table("
						...
						LEFT JOIN prd_employee_master as em2 on em2.gp_id_fk=gp.gp_id_pk and em2.emp_status in('1','2','9') and em2.emp_form_status='5'
...
<td><?= $item['gp_code']?></td>
<td><?= $item['emp_finz']?></td>
<td class="view"><a href="<?= $config['base_url'] ?>page/intra_prd/block/show_employee_list.php?id=<?= $cryptoGraph->encode($item['gp_id_pk'],4);?>"><img src="<?= $config['base_url'] ?>themes/default/image/view_icon.png" width="25" alt="view" /></a></td>
</tr>
<? $cnt+=1; } ?>
<tr>
