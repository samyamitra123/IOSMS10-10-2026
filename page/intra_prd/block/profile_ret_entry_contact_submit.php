...
if($sec_time_token!=$enc_session)
{
	...
	include 'profile_ret_entry_contact_form.php';
	exit;
}
else{
	//echo "dfadfdfd";exit;
...
header('Location:employee_retirement_edit_details.php');
exit(0);
//echo "Hello";
}
else{
header('Location:profile_ret_entry_contact.php?emp_id_pk='.$cryptoGraph->encode($emp_id_pk,4).'&confirm=false');
exit(0);
}
}
?>