...
function generate_excel(k,l)
{
	...
	if(year!=0 )
	{
		$.post('<?= $config['base_url'] ?>page/intra_prd/block/show_retired_employee_list.php?year='+year,function(data){
		//alert(year);
		$("#emplist").html(data);
	});
	...
	if(l==3)
		{
			//window.location.href= "salary_requisition_excel.php?month="+month+"&year="+year;
				window.location.href= "retired_employee_report_excel.php?year="+year;
     ...
     <div class="container">
        <div class="row">
            <div class="col-xs-11  ">
				...
				<h1 class="heading">&nbsp; Retired Employee List</h1>
