...
<div class="content">
    ...
    <div class="row" id="cont">
        <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
            <div class="col-sm-12">
                <h1 class="heading">Download Bill &amp; Annexture </h1>
                ...
                <form class="form-horizontal" id="bill_annex" name="bill_annex" method="post" action="download_treasury_bill.php" onsubmit="return valid_code();">
                                ...
                                <div class="table-responsive">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $config['base_url'] ?>page/intra_prd/block/ptax_deduction_pdf.php?report_month=<?php echo $cryptograph->encode($monthno, 4); ?>&report_year=<?php echo $cryptograph->encode($year, 4);?>&bill_no=<?php echo $cryptograph->encode($data[0]['bill_no'], 4);?>&bill_date=<?php echo $cryptograph->encode($data[0]['bill_entry_time'], 4);?>" class="btn btn-success btn-sm"><i class="fa fa-cloud-download fa-lg"></i> Download</a></td>
                                        </tr>
                                        <!--<tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $config['base_url'] ?>page/intra_prd/block/tr_form_31_pdf.php?report_month=<?php echo $cryptograph->encode($monthno, 4); ?>&report_year=<?php echo $cryptograph->encode($year, 4);?>&bill_no=<?php echo $cryptograph->encode($data[0]['bill_no'], 4);?>&bill_date=<?php echo $cryptograph->encode($data[0]['bill_entry_time'], 4);?>" class="btn btn-success btn-sm"><i class="fa fa-cloud-download fa-lg"></i> Download</a></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
