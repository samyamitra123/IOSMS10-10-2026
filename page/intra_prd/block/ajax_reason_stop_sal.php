...
//   ======================
	$('#stop_sal_employee').click(function(e) {
		...
		var link1=$(this).val();
		$.post('<?= $config['base_url'] ?>page/intra_prd/block/stop_start_suspend_submit.php?id='+link1+'&flag=stop',$(this).closest("form").serialize(), function(data){
...
<th>Employee Code</th>
<th>Reason</th>
<th id="trs_lvl" style="display:none;">Transfer Level</th>
...
<td id="td_date_header"><input type="text" name="reason_date" id="reason_date" class="form-control col-md-2" style="width: auto;" /></td>
<td>
