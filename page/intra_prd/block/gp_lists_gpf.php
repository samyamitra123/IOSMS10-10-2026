...
<td class="view"><a href="<?= $config['base_url'] ?>page/intra_prd/block/edit_emp/edit_employee_list_gpf.php?id=<?= $cryptoGraph->encode($item['gp_id_pk'],4);?>"><img src="<?= $config['base_url'] ?>themes/default/image/view_icon.png" width="25" alt="view" /></a></td>
</tr>
<? $cnt+=1; } ?>
<? } else { ?>
<tr>
