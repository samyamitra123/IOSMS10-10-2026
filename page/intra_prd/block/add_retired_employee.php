...
<? require '../../../page/common_back_btns.php'; ?>
   ...
   <div class="welcome_msg">
                      ...
                      //echo "<pre>";print_r($_SESSION['user_info']);exit;
...
<form class="form-horizontal" id="loginForm" method="post" action="add_retired_employee_submit.php" onsubmit="return valid_code();">
...
<input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
    ...
    <div class="col-sm-3">
      ...
      <option value="2">Transferred Employee</option>
       ...
       <option value="99">Add Retired Employee</option>
