			  ...
			  $("#year,#month").change(function () {
			    ...
			    if(
			    	...
			    	$("#year option:selected").val() != "" 
						...
						$.get("<?=$config['base_url']?>page/intra_prd/block/salary_excel_ropa_2019.php?mo="+mo+"&ye="+ye,function(data,status){
							//alert(data);
						if(data==0)
						{
					  ...
					  //alert("Data: " + data + "\nStatus: " + status);
						...
						{
						//alert(2);
							$('#show_box').html('<a class="btn btn-warning btn-sm" href="<?= $config['base_url']?>page/intra_prd/block/download_excel_for_salary_requisition_ropa_2019.php?mo='+mo+'&ye='+ye+'" style="margin-left:43%"><i class="fa fa-cloud-download fa-lg"></i> Download</a>');
					  //alert("Data: " + data + "\nStatus: " + status);
						}
					});
				}
...
<h1 class="heading">Download EXCEL FOR SALARY REQUISITION FOR ROPA 2019</h1>
