...
echo "fdaffdfdfd";exit;


?>		  

<div class="downpdf" align="right"><a href="<?= $config['base_url']?>page/intra_prd/block/pdf_employe_details.php?id=<?php echo $_GET['id'] ?>"><img src="<?= $config['base_url'] ?>themes/default/image/pdf_download.png"/></a></div>
<div id="accordion">
       ...
       <h3 id="att" onclick=""> Primary Profile</h3>
        ...
        <table border="0" width="100%">
				<tr>
					...
					<td colspan="3"><?php echo fun_common( $emp_data[0]['emp_desig'],$code_data); ?></td>
				</tr>
				<tr>
 ...
 ?>
                ...
                <tr>
					...
					<td><?php echo $emp_data[0]['gpf_acc_no']?></td>
				</tr>
                <tr>
