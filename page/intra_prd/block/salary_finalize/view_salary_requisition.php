...
$tch= $db->fetch_table("SELECT sal.gp_id_fk, sal.empcd, 
       ...
       sal.overdrawn, sal.salary_type, sal.cause, sal.gp_code, sal.part_day, sal.gsli,sal.consolidated_pay,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.advance_amount,
										tch.emp_first_name,
										tch.emp_second_name,
										tch.emp_last_name,
									...
									INNER JOIN 
										...
										WHERE
												 (tch.emp_status='1' OR tch.emp_status='9') AND
												  sal.gp_id_fk = '".$crypto->decode($_REQUEST['gp_code'],4)."'
											AND sal.net != '0' AND sal.delete_status=1
											AND (sal.status_flag = 1 OR sal.status_flag = 2 OR sal.status_flag = 3 
											OR sal.status_flag = 4) AND sal.delete_status='1' AND sal.ropa_status='2'
											AND salary_monthyear='".date('Ym')."' AND is_saved='1' AND sal.requisition_type='".$requisition_type."'
			...
			<br>
				...
				<table width="100%">
                    ...
                    <tr>
                        ...
                        <!--<th>HILL<br>ALLOW</th>
						<th>CPF</th>-->
                        <th>HILL AllOWANCE<span  style="font-size:9px;">(min 15%)</span></th>
