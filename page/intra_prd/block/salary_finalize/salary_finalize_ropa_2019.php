...
<?php if($item['status_flag']=='2'){ ?>
  <a class="btn btn-success" id="unlock_active" href="<?php echo $config['base_url'] ?>page/intra_prd/block/salary_finalize/unlock_gp_ropa_2019.php?gp_code=<?php echo $cryptoGraph->encode($item['gp_code'],4); ?>">Unlock</a>
