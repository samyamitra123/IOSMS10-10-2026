...
$arr=$db->fetch_table("
						...
						WHERE CAST(b.block_code AS text) like '".$_SESSION['location']['block_code']."%' AND sal.requisition_type='".$requisition_type."' AND sal.ropa_status='2' GROUP BY gp_name,gp_id_pk,gp.gp_code,status_flag order by gp_name
