...
$db=new database();
$data=$db->fetch_table("Select block_status from prd_location_master_block where block_code='".$_SESSION['location']['block_code']."'");
					...
					<table>
						<tr>
							...
							<td class="he2" style="text-align: center;width: 480px;">
								...
								<h3 class="school" style="color: #008200;font-size: 24px;">'. $_SESSION['location']['block_name'] .'</h3>
							</td>
...
$mpdf->WriteHTML('<div class="segment">
				...
				<tr>
					...
					<td colspan="3" style="font-weight:bold">'.$_SESSION['location']['block_name'].'</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="text-transform:uppercase;">'.$bdo_name.'</td>
				...
				<tr>
					...
					<td style="text-transform:uppercase;">'.$tan.'</td>
				</tr>
				</table>',2);	
...
$mpdf->Output('BLOCK PROFILE OF '.$_SESSION['location']['block_name'].'.pdf','D');								
?>