...
else 
{
	...
	$payment_failure_details=$db->fetch_table(" SELECT count(*) as total_count_fail
												...
												AND fail.response_from='10' AND fail.active_status='1'");
...
//{
    ...
    $total_benf = $db->fetch_table("SELECT count(distinct(emp.emp_id_pk)) as total_benf
									...
									ON (sal.emp_id_fk=emp.emp_id_pk and CAST(block.block_code as character varying)=sal.block_code)
									WHERE 
                        ...
                        <div class="school">
                            ...
                            <tr>
                                ...
                                <td width="20%">
                                    <div>
                                        ...
                                        { 
                                        ?>
                                        	<span id="edit_action_first_row2" onClick="sftp_edit('<?php echo $crypto->encode($sftp_details_fetch[0]['sftp_benf_id_pk'],4); ?>','<?php echo $monthyear; ?>');"><img style="padding-bottom: 10px;" width="25" src="<?= $config['base_url']; ?>themes/default/image/edit_icon.png" alt="Edit"/></span>
                                        <?php 
                                        }
                                        else
                                        {?>
                            ...
                            <tr style="background-color: #DCEDC8;">
                                ...
                                <td width="20%" style="background-color: #DCEDC8;">
                                    <div class="btn btn-default" style=" float:center; cursor:default; color:#1A237E;width:105px;"> 
                                        &nbsp;<a href="<?= $config['base_url']?>page/all_moduls/payment_details_view/payment_details.php?monthyear=<?php echo $crypto->encode($monthyear,4);?>&requisition_type=<?php echo $crypto->encode($requisition_type,4); ?>"><i class="fa fa-money fa-2x reason_view" aria-hidden="true" style="color:#33691E;cursor:pointer;" ></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">
                                            <div class="link_p2">
                                                ...
                                                {
                                                ?>
                                                    <a onClick="value_pass('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>');" > <img id="send_bill_sum_id" src="<?php echo $config['base_url']; ?>themes/default/image/send_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer" /></a>
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%">
                                                <div class="link_p2">
                                                    ...
                                                    ?>
                                                        <img id="upload_image" src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; opacity:0.5;">
                                                        <a id="send_benf"  style="display:none;"  onClick="value_pass_sftp('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>');"><img src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer;"></a>
                                                    <?php
                                                    } 
                                                   else if (count($sftp_details_fetch) == '0' || ($sftp_details_fetch[0]['sftp_benf_response_status']=='6' || $sftp_details_fetch[0]['active_status']=='2'))  
								{
                                                    ?>
                                                        <img id="upload_image" src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; opacity:0.5; display:none;">
                                                        <a id="send_benf"  onClick="value_pass_sftp('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>');"><img src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer"></a>
                                                    <?php
                                                    } 
                                                    else 
                                                    {
                                    ...
                                    <tr style="background-color: #DCEDC8;">
                                        ...
                                        <td width="20%" style="background-color: #DCEDC8;">
                                            <div class="btn btn-default" style=" float:center; cursor:default; color:#1A237E;width:105px;"> &nbsp;<a href="<?= $config['base_url']?>page/api/ifms/gp/download_excel_for_payment_status.php"><i class="fa fa-money fa-2x reason_view" aria-hidden="true" style="color:#33691E;cursor:pointer;" ></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a style="cursor:pointer;"><i class="fa fa-street-view fa-2x eason_view" aria-hidden="true" style="color:#33691E;"></i></a>
                                            </div>
                                        </td>
                                        <td width="20%" style="background-color: #DCEDC8;color: #FF3D00;" id="status_payment"></td>
                                        <td width="20%" style="background-color: #DCEDC8;">
                                            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%" style="background-color: #E0E0E0;">6. </td>
                                    </tr>
                                </table>-->
                                    <div id="emplist"></div>
                                </div>
...
//**************************************************************
	...
	function value_pass(encode_requsition, drn_number,monthyear)
	{
		...
		$.post('<?= $config['base_url'] ?>page/intra_prd/block/text_file_ifms/xml_file.php?bill_type=' + requsition + '&drn_no=' + drn_no+'&monthyear='+monthyear, function (data) {
		//alert(data);
		});
		
		$.post('<?= $config['base_url'] ?>page/api/ifms/gp/index.php?bill_type=' + requsition + '&drn_no=' + drn_no+'&monthyear='+monthyear, function (data) {
		    //alert(data);
			//return false;
	...
	function value_pass_sftp(encode_requsition, drn_number,monthyear)
	{
		...
		var requsition = encode_requsition;
		var drn_no = drn_number;
		$.post('<?= $config['base_url'] ?>page/api/ifms/gp/sftp_index.php?bill_type=' + requsition + '&drn_no=' + drn_no+'&monthyear='+monthyear, function (data) {
		   // alert(data);
			//alert(data);
			$('#page-load').delay(500).fadeOut();
			if (data.trim() == '2')
	...
	function sftp_edit(benf_id,monthyear)
	{
		$('#page-load').show();
		$('#page-load').delay(500).fadeOut();
		$('#myModal').modal('show');
		
		$.post('<?= $config['base_url'] ?>page/api/ifms/gp/sftp_wrong_data_edit.php?benf_id=' + benf_id+'&monthyear='+monthyear, function (data) {
			$("#mbody").html(data);
			$("#empshow").html(data);
			$("#success").hide();
			$("#failed").hide();
	...
	function payment_edit(benf_id)
	{
		...
		$('#page-load').delay(500).fadeOut();
		$('#myModal').modal('show');
		$.post('<?= $config['base_url'] ?>page/api/ifms/gp/epayment_wrong_data_edit.php?benf_id=' + benf_id, function (data) {
			$("#mbody").html(data);
			$("#empshow").html(data);
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >
            ...
            <div class="modal-body" style="background-color:#e0decb;"> 
                <div class="empshow" style="height:300px;"></div>
            </div>
            <div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>  
            </div>
