...
<script>
    	$(document).ready(function(){
		  ...
		  $.post('<?= $config['base_url'] ?>page/intra_prd/district/ajax_bank_view.php?id='+link, function(data){
		  $(".empshow").html(data);
		  });
		  });
		});
...
<?php if($item['bank_upd_status']=='0'){ ?>
                    ...
                    <td align="center" class="text-warning">Waiting For Approval</td>
                    <?php }
					else if($item['bank_upd_status']=='3'){ ?>
                    <td style="color:green" align="center">Approved</td>
                    <?php } 
