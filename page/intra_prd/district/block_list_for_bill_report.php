...
<script>
		...
		{
			var bill_id=k;
			var block_name=$('#block_name'+k).text().trim();
			...
			$('#bill_details_div').html('<div class="school"><div class="table-responsive"><table width="100%"><tr><th>BLOCK NAME</th><th>BILL NUMBER.</th><th>BILL DATE</th></tr><tr style="background-color:#DDF7FF;"><td>'+block_name+'</td><td>'+bill_no+'</td><td>'+bill_date+'</td></tr></div></div>');
		}
...
$bill_report_fetch=$db->fetch_table("
										...
										WHERE block.district_id_fk=".$district_id_pk[0]['district_id_pk']."
										GROUP BY 
    ...
    <div class="row" id="cont">
    	<div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
            <div class="col-sm-12">
                ...
                <div class="emplist">
                    <div class="school">
                        <div class="downpdf" style="margin-left:90%"><a href="<?= $config['base_url']?>page/intra_prd/district/excel_block_bill_details.php?district_id=<?php echo $district_id_pk[0]['district_id_pk']; ?>&rep_month=<?php echo $_POST['rep_month'];?>&rep_year=<?php echo $_POST['rep_year'];?>"><img src="<?= $config['base_url'] ?>themes/default/image/excel_download.png"/></a></div>
                        <br>
