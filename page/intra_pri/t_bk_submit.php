    ...
    header('Location:intre_pri_intra_district_transfer.php');
    }
    else
    {
    //echo 222; die;
    ...
    $first_join_date = $_POST['first_join_date'];
    ...
    //echo $tran_gp_code=$crypto->decode($_POST['gp_code'],4); die;
    ...
    if($form_flage=="partA")
	 {
			...
			$insert_file=$db->insert(" INSERT INTO intra_pri_file_upload
			(application_id, flag, file_name,status,emp_id_const)
			values ('".$application_id."','".$file_flag."','".$rand.$_FILES['file_tran']['name']."','1','".$emp_id_const."' ) ");	
			...
			{
			$_SESSION["msg"]='<div class="alert alert-success" style="text-align:center;"><strong> Profile Submitted failed...</strong></div>';
			header('Location:intre_pri_intra_district_transfer.php');
			}
}
