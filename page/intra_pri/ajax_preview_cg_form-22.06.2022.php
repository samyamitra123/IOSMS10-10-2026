   ...
   // $enc_token=md5('369'.$time_token);
	...
	{
		$statement="emp_id_const='".$_SESSION['emp_id_const']."'";
	}
    $data=$db->fetch_table("
    SELECT 
    emp_id_const,
   ...
   $present_address_state=$data[0]['present_address_state'];
    ...
    ?>
    <select class="form-control" name="vice_desig" id="vice_desig" disabled="disabled" onchange="showAcadmic(this.value)">
  ...
  <div class="row mb-3">
   ...
   <?php }?>
    ...
    SELECT family_name,family_age,family_quali,
	family_relation
    ...
    <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-3 control-label">Whether application has been submitted in Prescribed Proforma in terms of 251-Emp dated 03.12.2013 (Yes/No)<span class="star_color">*</span></label>
    <div class="col-sm-3">
    ...
    <h3 class="heading"> APPLICANT ADDRESS</h3>
    <div class="border"></div>
    </br>
    ...
    <label for="inputPassword3" class="col-sm-3 control-label">Any Other Payment(in RS)<span class="star_color">*</span></label>
    <div class="col-sm-3">
    ...
    <div class="col-sm-2">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_2[0]['flag']?>"><?php echo substr($arr_file_2[0]['file_name'],6); ?></a>
    </div>
    ...
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_3[0]['flag']?>"><?php echo substr($arr_file_3[0]['file_name'],6); ?></a>
    </div>
     <?php
    $db=new database();
    ...
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_4[0]['flag']?>"><?php echo substr($arr_file_4[0]['file_name'],6); ?></a>
    </div>
    </div>
    ...
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_5[0]['flag']?>"><?php echo substr($arr_file_5[0]['file_name'],6); ?></a>
    </div>
    <?php
    $db=new database();
    ...
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_6[0]['flag']?>"><?php echo substr($arr_file_6[0]['file_name'],6); ?></a>
    </div>
    </div>
    ...
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_7[0]['flag']?>"><?php echo substr($arr_file_7[0]['file_name'],6); ?></a>
    </div>
    <?php
    $db=new database();
    ...
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_8[0]['flag']?>"><?php echo substr($arr_file_8[0]['file_name'],6); ?></a>
    </div>
    </div>
    ...
    $db=new database();
        ...
        <?php ?>
    <label for="inputPassword3" class="col-sm-3 control-label">PPO Order<span class="star_color">*</span></label>
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_11[0]['flag']?>"><?php echo substr($arr_file_11[0]['file_name'],6); ?></a>
    </div>
    <?php
    $db=new database();
        ...
        <?php ?>
    <label for="inputPassword3" class="col-sm-3 control-label">Cast Certificate <span class="star_color">*</span></label>
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_16[0]['flag']?>"><?php echo substr($arr_file_16[0]['file_name'],6); ?></a>
    </div>
    </div>
    ...
    <div class="col-sm-3">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_17[0]['flag']?>"><?php echo substr($arr_file_17[0]['file_name'],6); ?></a>
    </div>
    ...
    <div class="col-sm-2">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_9[0]['flag']?>"><?php echo substr($arr_file_9[0]['file_name'],6); ?></a>
    </div>
    ...
    <div class="col-sm-2">
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_10[0]['flag']?>"><?php echo substr($arr_file_10[0]['file_name'],6); ?></a>
    </div>
  ...
  <div class="row mb-3">
    ...
    <input type="file" class="form-control upper_case" autocomplete="off" name="dprdo_dcoument"  id="dprdo_dcoument"  onchange="return file_upload(this.id,'<?php echo $crypto->encode("13",4); ?>','<?php echo $crypto->encode($application_id,4); ?>','<?php echo $crypto->encode($emp_id_const,4); ?>');" >
      ...
      <?php  }else{?>
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_13[0]['flag']?>"><?php echo substr($arr_file_13[0]['file_name'],6); ?></a>
    <?php  }?>
...
<?php }?>
  ...
  <div class="row mb-3">
    ...
    <input type="file" class="form-control upper_case" autocomplete="off" name="dprdo_dcoument"  id="dprdo_dcoument"  onchange="return file_upload(this.id,'<?php echo $crypto->encode("14",4); ?>','<?php echo $crypto->encode($application_id,4); ?>','<?php echo $crypto->encode($emp_id_const,4); ?>');" >
      ...
      <?php  }else{?>
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_14[0]['flag']?>"><?php echo substr($arr_file_14[0]['file_name'],6); ?></a>
    <?php  }?>
     
    </div>
    <!--<div class="col-sm-1"><a id="del"  onclick="del('<?php echo $crypto->encode("14",4); ?>','<?php echo $crypto->encode("delete",4); ?>');" name='del' class='del' style="color:red">Remove File</a></div>-->
  ...
  <div class="row mb-3">
    ...
    <input type="file" class="form-control upper_case" autocomplete="off" name="dprdo_dcoument"  id="dprdo_dcoument"  onchange="return file_upload(this.id,'<?php echo $crypto->encode("15",4); ?>','<?php echo $crypto->encode($application_id,4); ?>','<?php echo $crypto->encode($emp_id_const,4); ?>');" >
      ...
      <?php  }else{?>
    <a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $application_id?>&flag=<?=$arr_file_15[0]['flag']?>"><?php echo substr($arr_file_15[0]['file_name'],6); ?></a>
    <?php  }?>
     
    </div>
    <!--<div class="col-sm-1"><a id="del"  onclick="del('<?php echo $crypto->encode("15",4); ?>','<?php echo $crypto->encode("delete",4); ?>');" name='del' class='del' style="color:red">Remove File</a></div>-->
...
<?php }?>
    ...
    <a type="button" id="submit6" name="submit6"  class="btn btn-success" onclick="final_save('<?php echo $crypto->encode($application_id,4); ?>','<?= $crypto->encode("final",4); ?>');">FINAL SUBMIT</a>
   <!--<class="btn btn-success" data-bs-toggle="modal"> SUBMIT & PREVIEW </a>-->
    ...
    <div class="row mb-3" id="for" >
		<label for="inputPassword3" class="col-sm-6 col-form-label" style='margin-left: -20%;' >Forwarded To: </label>
		<div class="col-mb-3" >
		...
		<input type="hidden" id="for_app_rej_status" name="for_app_rej_status" value="" >
		  ...
		  <select class="form-control" id="forwarding" name="forwarding" style='margin-left: -25%;'>
			<option value="" >-- Please Select --</option>
			<?php	
		...
		<div class="row mb-3" style="display:none;     width: -webkit-fill-available;" id="remarks_div" > 
			<label for="inputPassword3" class="col-sm-2 col-form-label" >Reason: </label>
			<div class="col-sm-6">
				<textarea type="text" class="form-control" name="remarks_res" id="remarks_res" placeholder="Reason" rows="5" cols="40" ></textarea>
