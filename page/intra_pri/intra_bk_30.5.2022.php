   ...
   $present_address_state=$data[0]['present_address_state'];
    ...
    <form class="form-horizontal" id="first_form" method="post" action="intra_pri_cg_profile_submit.php" onsubmit="return valid_code();">
    ...
    <div class="col-sm-1">
    <input type="checkbox" id="iosms_registered" name="iosms_registered" onClick="return search();" >
    ...
    <div class="col-sm-2">
    <input type="text" class="form-control upper_case" id="search1"  name="search1" placeholder="EMPLOYEE ID"  onkeyup="return empplyee_details_fetch(this.value,'<?php echo $crypto->encode(1,4); ?>')" value="" style="display:none">
    </div>
    ...
    ?>
    <select class="form-control" name="vice_desig" id="vice_desig" readonly="readonly" onchange="showAcadmic(this.value)">
    ...
    <?php }else{?>
    <input type="text" class="form-control upper_case" id="nomine_details"readonly="readonly"  name="nomine_details" placeholder="NOMINE DETAILS" autocomplete="off" value="<?php echo $nomine_details;?>">
    <?php }?>
    </div>
    </div>
  ...
  <div class="row mb-3">
   ...
   <div class="row mb-3">
    ...
    <div class="col-sm-3">
    <input type="text" class="form-control" name="premature_date" id="premature_date" placeholder="DD-MM-YYYY" autocomplete="off" value="<?=$death_date=='0001-01-01' ? '' : dateshow($death_date);?>">
    </div>
   ...
   <?php }?>
    ...
    <h3 class="heading"> FAMiLY DETAILS </h3>
    <div class="border"></div>
    </br>
   ...
   <!-- <td><img onclick="return add_row(this.id)" style="cursor:pointer;" id="add_row0" class="add_row0" title="Click To Add" src="../../themes/default/image/add_row_image.png" width="20"></td>-->
    ...
    <?php if($data[0]['part_a_from_status']=='1' || $data[0]['part_b_from_status']=='1'){?>  
    ...
    <form class="form-horizontal" id="second_form" method="post" action="intra_pri_cg_profile_submit.php" onsubmit="return valid_code();">
    ...
    <?php if(($data[0]['part_a_from_status']=='1') && ($data[0]['part_b_from_status']=='0')){?>
    ...
    <?php if(  $data[0]['part_b_from_status']=='1'){?> 
    ...
    <form class="form-horizontal" id="third_form" method="post" action="intra_pri_cg_profile_submit.php" onsubmit="return valid_code();">
    <input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
    ...
    <?php if(($data[0]['part_b_from_status']=='1') && ($data[0]['part_c_from_status']=='0')){?>
   ...
   <div class="row mb-3" style="margin-left: 43%; margin-top: 4%;">
    ...
    <!------------------------------------------------ PART B closed ------------------------------------------- --> 
      <!------------------------------------------------ PART C START ------------------------------------------- --> 
    <?php if( $data[0]['part_c_from_status']=='1'){?>    
    ...
    <div class="border"></div>
     ...
     <!------------------------------------------------ PART C CLOSED ------------------------------------------- --> 
          <!------------------------------------------------ PART D START ------------------------------------------- --> 
    <form class="form-horizontal" id="fourth_form" method="post" action="intra_pri_cg_profile_submit.php" onsubmit="return valid_code();">
    <input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
    
    <input type="hidden" name="form_flage" id="form_flage" value="<?= $crypto->encode("partD",4); ?>" /> 
    <div class="row mb-3">
    
    <label for="inputPassword3" class="col-sm-3 control-label">First Name Of Officer<span class="star_color">*</span></label>
    <div class="col-sm-3">
    ...
    <label for="inputPassword3" class="col-sm-3 control-label">Second Name Of Officer<span class="star_color">*</span></label>
    <div class="col-sm-3">
    ...
    <label for="inputPassword3" class="col-sm-3 control-label">Third Name Of Officer<span class="star_color">*</span></label>
    <div class="col-sm-3">
    ...
    <label for="inputPassword3" class="col-sm-3 control-label" id="check_age" >Education & Qualification</label>
    ...
    <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-3 control-label">Whether a clear Vacancy is available as per 100 pointer Roster vide Notification No. 50-EMP dated 01.03.2011<span class="star_color">*</span></label>
    <div class="col-sm-3">
    ...
    <label for="inputPassword3" class="col-sm-3 control-label">BRIF NOTE<span class="star_color">*</span></label>
    <div class="col-sm-3">
...
<?php  }?>
    ...
    <label for="inputPassword3" class="col-sm-3 control-label">Noc in form Of Applicant<span class="star_color">*</span></label>
    <div class="col-sm-2">
    ...
    <label for="inputPassword3" class="col-sm-3 control-label">Education & Qualification(Highest)<span class="star_color">*</span></label>
    <div class="col-sm-2">
 ...
 <?php }?>
    ...
    <div class="col-sm-offset-5 col-sm-7" style='padding-left: 10%;'>
 ...
 // alert(result[15]);
	...
	$("#proposal").val("PROPOSAL FOR COMPASSIONATE GROUND APPLICATION IN RESPECT OF i.r.o "+result[0]+" "+result[1]+" "+result[2]);
