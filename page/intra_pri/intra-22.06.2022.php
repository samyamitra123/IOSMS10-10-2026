   ...
   $present_address_state=$data[0]['present_address_state'];
    ...
    <div class="col-sm-2">
    <input type="text" class="form-control upper_case" id="search1"  name="search1" placeholder="EMPLOYEE ID"  onkeyup="return empplyee_details_fetch(this.value,'<?php echo $crypto->encode(1,4); ?>')" value=""  maxlength="12" style="display:none">
    </div>
    ...
    <?
    $db = new database();
    $arr = $db->fetch_table("select code,description from prd_dise_code_master where code in('1114','1115','1116','1117','1118','1119','1120','1122','1123','9001','9002','9003','9004','9005','9006','9007','9008','9009','9010','9011') order by code");
	
	//$arr1 = $db->fetch_table("select designation_id,designation_name from zpemp_emp_desig_master order by designation_name");
    ?>
