...
<?php require 'common_back_btns_intra_pri.php'; ?>
   <div class="welcome_msg">
		...
		$Query = " SELECT forw.*, role.description as role_desc, forw.status as status, forw.for_app_rej as for_app_rej,
											...
											WHERE (forw.status = 2) AND forw.delete=0 AND forw.from_officer_id_const = '".$_SESSION['user_info']['officer_id_const']."' order by forwarding_id_pk asc"; 
...
<ul class="menu">
	...
	<li><a href="javascript:void(0);" class="btn btn-sm btn-primary active">Ongoing</a></li>
