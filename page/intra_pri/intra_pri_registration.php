...
<form class="form-horizontal" id="first_form" method="post" action="intra_pri_registration_profile_submit.php" onsubmit="return valid_code();">
	...
	<div class="row mb-3" id="block_div" style='display:none;'>
		<div class="col-sm-2"></div>
			...
			<?php
			$db = new database();
			if($_SESSION['user_info']['district_id_fk'] == '7'){
			$arr=$db->fetch_table("select block_code,block_name,block_id_pk from prd_location_master_block WHERE district_id_fk IN (7,20) order by block_name");
			}
			else{
