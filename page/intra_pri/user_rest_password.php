...
<div class="row" id="cont">
      <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
        <div class="col-sm-12">
<h1 class="heading">RESET PASSWOARD PASSWORD </h1>
...
<?php 
    ...
    <form class="form-horizontal" method="post" name="login_form" action="user_rest_password_submit.php" >
    ...
    <div class="col-sm-3">
      ...
      <input type="text" class="form-control" name="officer_name"  readonly="readonly" id="officer_name" placeholder="OFFICER Name" value="<?=$officer_name[0]['officer_name']?>"/ >
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" name="officer_id"  readonly="readonly" id="officer_id" placeholder="OFFICER ID"  value="<?=$officer_name[0]['officer_id_const']?>" />
    </div>
    <div class="col-sm-3"><div id="pass-info" class="float_l col"></div></div>
    </div>
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" name="e_mobile" readonly id="e_mobile" placeholder="OFFICER MOBILE NO" value="<?=$officer_name[0]['mobile_no']?>" />
    </div>
    <div class="col-sm-3">
      </div>
    </div>
	...
	?>
      <input type="text" class="form-control" name="d_pin" readonly id="d_pin"  value="<?=$password?>"placeholder="DEFAULT PASSWORD" />
    </div>
    <div class="col-sm-3">
      </div>
    </div>
