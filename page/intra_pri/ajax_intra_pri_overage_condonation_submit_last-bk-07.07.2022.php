...
<tr class="warning">
	...
	<td style="text-transform:uppercase;"><?php echo $insert_pk[0]['emp_first_name']." ". $insert_pk[0]['emp_middle_name']." ". $insert_pk[0]['emp_last_name']; ?></td>
</tr>
<tr class="success">
	<td><strong>DATE OF BIRTH :</strong></td>
	<td><?php echo date("d-m-Y",strtotime($insert_pk[0]['emp_dob'])); ?></td>
	<td><strong>SEX :</strong></td>
	<td style="text-transform:uppercase;"><?php if(isset($insert_pk[0]['emp_sex']) == 91){ echo "Male"; }
			else if(isset($insert_pk[0]['emp_sex']) == 92){ echo "Female"; }
			else if(isset($insert_pk[0]['emp_sex']) == 93){ echo "Others"; } ?></td>
</tr>
<tr class="warning">
...
<tr class="success">
	...
	<td><?php 
		...
		<a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $insert_pk[0]['application_id']?>&flag=<?=$arr_file[0]['flag']?>"><?php echo substr($arr_file[0]['file_name'],6); ?></a>
	</td>	
	...
	<td><?php 
		...
		<a style="text-decoration:none" href="<?= $config['base_url']?>page/intra_pri/doc_download.php?application_id=<?= $insert_pk[0]['application_id']?>&flag=<?=$arr_file[0]['flag']?>"><?php echo substr($arr_file[0]['file_name'],6); ?></a></td>
</tr>
<tr class="success">
	<td><strong>PROOF OF DEATH OF BIRTH :</strong></td>
	<td><?php 
