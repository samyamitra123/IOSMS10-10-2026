                                ...
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        ...
                                        <div class="form-group text-center" >
                                           <a href='<?php echo $config['base_url'] ?>page/intra_pri/general_transfer.php?dis=<?php echo $crypto->encode("ID",4);?>'  id="type3" name="type3" class="btn btn-info">TRANSFER WITHIN DISTRICT</a>
