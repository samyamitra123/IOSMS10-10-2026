...
<div class="border"></div>
	 ...
	 $cryptography=new cryptography(); 
        ...
        <form class="form-horizontal" action="<?= $config['base_url'] ?>page/intra_pri/changepassword_intra_pri_update_user.php" name="login_form" id="form_emp_contact" method="post" enctype="multipart/form-data" onsubmit="return validForm();">
