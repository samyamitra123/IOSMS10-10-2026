                            ...
                            <div class="col-xs-11  ">
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        <h1 class="heading">FESTIVAL ADVANCE BILL ACTION</h1>
                                        ...
                                        <form class="form-horizontal" id="loginForm" method="post" action="ul_fad_bill_action_submit.php" onsubmit="return valid_code();">
                                        <input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
                                        <div class="form-group text-center" >
                                            <button type="submit" value="<?=$cryptoGraph->encode(2,4);?>" id="type2" name="type2" class="btn btn-info">Festival Advance Lock</button>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <!--<button type="submit"  value="<?=$cryptoGraph->encode(1,4);?>"  id="type" name="type" class="btn btn-info">Festival Advance Bill View</button>-->
                                            
                                            <?php if($logged_user!='zpacc')
											{?>
                                            <a href='<?php echo $config['base_url'] ?>page/all_moduls/ifms_ajax_links_all/ajax_links_ifms_upload_details.php'  id="type3" name="type3" class="btn btn-info">Festival Advance Bill View</a>
											<?php }?>
                                        </div>
