...
if($logged_user=='GP')
{
	$bonus_lock_status=$db->fetch_table(" SELECT bonus_type.bonus_type_id_pk
										...
										AND bonus_type.employee_total_number=0
                            ...
                            <div class="col-xs-11  ">
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        <h1 class="heading">FESTIVAL ADVANCE BILL SELECTION</h1>
                                        ...
                                        <form class="form-horizontal" id="loginForm" method="post" action="ll_fad_bill_selection_submit.php" >
                                        <input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
                                        <div class="form-group text-center" >
                                            <button type="submit" value="<?=$cryptoGraph->encode(2,4);?>" id="type2" name="type2" class="btn btn-info bt">Festival Advance Entry </button>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <!--<button type="submit"  value=""  id="type" name="type" class="btn btn-info bt">Festival Advance View</button>-->
