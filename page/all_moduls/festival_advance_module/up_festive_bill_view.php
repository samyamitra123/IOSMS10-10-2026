...
{
	$bonus_status=$db->fetch_table(" SELECT count (festival_advance_status), festival_advance_status
										FROM  prd_festival_advance_employee_details
										WHERE festival_advance_status='4'
										AND zp_id_fk='".$_SESSION['location']['district_id']."' group by festival_advance_status ");
                            ...
                            <div class="col-xs-11  ">
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        ...
                                        <?php 
										//var_dump($bonus_status[0]['count']); die;
                                        if($bonus_status[0]['count']!= NULL)
                                        {?>
											<a href='fad_text_file.php'id="type2" name="type2" class="btn btn-info">Festival Advance Bill Generation</a>
                                          <?php } ?> 
											<a href='<?php echo $config['base_url'] ?>page/all_moduls/ifms_ajax_links_all/ajax_links_ifms_upload_details.php'  id="type" name="type" class="btn btn-info">Festival Advance Bill View</a>
                                        <?php 
											//var_dump($bonus_status[0]['bonus_status']); die;
										if($bonus_status[0]['festival_advance_status']== '4')
										{?>
											<a href='<?php echo $config['base_url'] ?>page/all_moduls/festival_advance_module/bg_fed_view.php'id="type3" name="type3" class="btn btn-info">Festival Advance Unlock</a>
										<?php } ?>
