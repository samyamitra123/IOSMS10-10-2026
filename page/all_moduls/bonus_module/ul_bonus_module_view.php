                                ...
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        ...
                                        <div class="form-group text-center" >
                                            <!--<button type="submit" value="<?//=$cryptoGraph->encode(2,4);?>" id="type2" name="type2" class="btn btn-info bt">Previous Bonus Bill View</button>-->	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button type="submit"  value="<?=$cryptoGraph->encode(1,4);?>"  id="type" name="type" class="btn btn-info bt">Bonus Lock</button> &nbsp;&nbsp;
                                            
                                            <button type="submit"  value="<?=$cryptoGraph->encode(2,4);?>"  id="type" name="type" class="btn btn-info bt">Bonus View</button>
											<a href='<?php echo $config['base_url'] ?>page/all_moduls/ifms_ajax_links_all/ajax_links_ifms_upload_details.php'  id="type3" name="type3" class="btn btn-info">Bonus Bill View</a>
                                        </div>
