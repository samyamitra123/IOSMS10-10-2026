...
{ 
	...
	if($stake_level=='ZP')
	{
		...
		$employee_list_bonus = $db->fetch_table("SELECT 
												...
												AND emp_id_pk in 
(SELECT emp_id_pk FROM prd_employee_master WHERE ".$bonus_type." AND zp_id_fk = '".$stake_id."' AND (emp_status = '1'  or (emp_retirement_date>='2019-09-30' and  emp_retirement_date<='2020-03-31')) 
EXCEPT
SELECT emp_id_fk FROM prd_employee_bonus_details WHERE delete_status=1 AND bonus_status not in (1,2,3) AND monthyear='".$prev_yrr.$current_year."' AND zp_id_fk = '".$stake_id."') 	
										");
...
SELECT emp_id_fk FROM prd_employee_bonus_details WHERE delete_status=1 AND bonus_status not in (1,2,3) AND monthyear='".$prev_yrr.$current_year."' AND ps_id_fk = '".$stake_id."') 	
	...
	else if($stake_level=='GP')
	{
		...
		$employee_list_bonus = $db->fetch_table("SELECT 
										...
										AND (emp_status = '1'  or (emp_retirement_date>='2019-09-30' and  emp_retirement_date<='2020-03-31'))
										AND emp_id_pk in 
(SELECT emp_id_pk FROM prd_employee_master WHERE ".$bonus_type." AND gp_id_fk = '".$stake_id."' AND (emp_status = '1'  or (emp_retirement_date>='2019-09-30' and  emp_retirement_date<='2020-03-31')) 
EXCEPT
SELECT emp_id_fk FROM prd_employee_bonus_details WHERE delete_status=1 AND bonus_status not in (1,2,3) AND monthyear='".$prev_yrr.$current_year."' AND gp_id_fk = '".$stake_id."') 	
										");
