...
echo ("SELECT 
												...
												WHERE
										           ...
										           emp_religion != '0'
													...
													AND emp_pay_in_payband <= '34250'
													AND ((emp_status = '1' and emp_first_join_date<'2020-10-02' )or (emp_retirement_date>='2020-09-30' and emp_retirement_date<='2021-10-31' )) 
												AND emp_id_pk in 
(SELECT emp_id_pk FROM prd_employee_master WHERE emp_religion != '0' AND zp_id_fk = '".$stake_id."' AND ((emp_status = '1' and emp_first_join_date<'2020-10-02' ) or (emp_retirement_date>='2020-09-30' and emp_retirement_date<='2021-10-31' )) 
EXCEPT
		...
		$employee_list_bonus = $db->fetch_table("SELECT 
												...
												WHERE
										          emp_religion!='0'
													AND emp_pay_in_payband <= '34250'
													AND zp_id_fk = '".$stake_id."'
													AND ((emp_status = '1' and emp_first_join_date<'2019-10-02' )or (emp_retirement_date>='2019-09-30' and emp_retirement_date<='2020-10-31' )) 
												AND emp_id_pk in 
(SELECT emp_id_pk FROM prd_employee_master WHERE ".$bonus_type." AND zp_id_fk = '".$stake_id."' AND ((emp_status = '1' and emp_first_join_date<'2019-10-02' ) or (emp_retirement_date>='2019-09-30' and emp_retirement_date<='2020-10-31' )) 
EXCEPT
SELECT emp_id_fk FROM prd_employee_bonus_details WHERE delete_status=1 AND bonus_status not in (1,2,3,4) AND monthyear='".$prev_yrr.$current_year."' AND zp_id_fk = '".$stake_id."') 	
										");*/
...
SELECT emp_id_fk FROM prd_employee_bonus_details WHERE delete_status=1 AND bonus_status not in (1,2,3) AND monthyear='".$prev_yrr.$current_year."' AND ps_id_fk = '".$stake_id."') 	
		...
		$employee_list_bonus = $db->fetch_table("SELECT 
										...
										AND ((emp_status = '1' and emp_first_join_date<'2019-10-02' )or (emp_retirement_date>='2019-09-30' and emp_retirement_date<='2020-10-31' )) 
										AND emp_id_pk in 
(SELECT emp_id_pk FROM prd_employee_master WHERE ".$bonus_type." AND ps_id_fk = '".$stake_id."' AND ((emp_status = '1' and emp_first_join_date<'2019-10-02' )or (emp_retirement_date>='2019-09-30' and emp_retirement_date<='2020-10-31' )) 
EXCEPT
SELECT emp_id_fk FROM prd_employee_bonus_details WHERE delete_status=1 AND bonus_status not in (1,2,3,4) AND monthyear='".$prev_yrr.$current_year."' AND ps_id_fk = '".$stake_id."') 	
	...
	else if($stake_level=='GP')
	{
		...
		$employee_list_bonus = $db->fetch_table("SELECT 
										...
										AND ((emp_status = '1' and emp_first_join_date<'2019-10-02' )or (emp_retirement_date>='2019-09-30' and emp_retirement_date<='2020-10-31' )) 
										AND emp_id_pk in 
(SELECT emp_id_pk FROM prd_employee_master WHERE ".$bonus_type." AND gp_id_fk = '".$stake_id."' AND ((emp_status = '1' and emp_first_join_date<'2019-10-02' )or (emp_retirement_date>='2019-09-30' and emp_retirement_date<='2020-10-31' )) 
EXCEPT
...
//var_dump($fin_yr_match); die;
//if(date("Ym") >= $fin_yr_match && date("Ym") <= $fin_yr_end)
if(date("Ym") >= '202103' && date("Ym") <= $fin_yr_end)        // static month 202103 putted for testing.
{ 
...
{	
	...
	//print_r($emp_list_for_bonus_not_select); die;
	//var_dump(implode(",",$emp_list_for_bonus_not_select[0])); die;
...
$emp_list_for_bonus_not_select_list_pk =  trim($str2,',');  
	...
	$short_employee_from_not_select =$db->fetch_table(" SELECT 
										...
										INNER JOIN prd_employee_salary_save as save ON emp.emp_id_pk = save.emp_id_fk
										WHERE save.emp_id_fk IN (".$emp_list_for_bonus_not_select_list_pk.")
										AND save.salary_monthyear in ('202009','202010') AND net <= '34250'	");
	
	//var_dump($short_employee_from_not_select); die;
	//var_dump($emp_list_for_bonus); die;
...
//var_dump($emp_list_for_bonus[0]['emp_id_pk']); die;
