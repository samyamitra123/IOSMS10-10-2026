										...
										foreach ($emp_list_for_bonus as $key) 
										{
											...
											{*/
												...
												//$full_amount_for_bonus = $emp_basic_pay + $emp_da;
												 ...
												 if($emp_retirement_date>='2019-09-30' and $emp_retirement_date<='2019-12-31')
												 {
													// echo 11;
														$emp_grade_pay = fun_grade_pay($key['emp_grade_pay']); 
														$emp_pay_band = $key['emp_pay_in_payband'];
														$emp_basic_pay = $emp_grade_pay + $emp_pay_band;
														//echo $emp_da = ($emp_basic_pay * $da_per)/100;
														$emp_da = round(($emp_basic_pay * $da_per)/100);
														//$full_amount_for_bonus = $emp_basic_pay + $emp_da;
														$emp_emolument=$emp_basic_pay + $emp_da;
												 }
												 else
												...
												else
												{
													...
													$emp_emolument=$emp_emolument;
													  ...
													  //  comented new $emp_emolument=$emp_basic_pay + $emp_da;
												}
												...
												{
													//echo $emp_emolument.'---'.$bonus_upper_limit;
													
														$sal_archive_fetch_first=$db->fetch_table(" SELECT pay_payband,tch_grade_pay,da 
													...
													/* comented new $arc_payband_first=$sal_archive_fetch_first[0]['pay_payband'];
													$arc_grade_pay_first=$sal_archive_fetch_first[0]['tch_grade_pay'];
													$arc_basic_first=$arc_payband_first+$arc_grade_pay_first;
													...
													//$arc_da_first=$sal_archive_fetch_first[0]['da'];
													   $arc_emolument_first=$arc_basic_first;
											...
											AND delete_status='1' AND monthyear='".$mnth_year."'");
												...
												//$actual_emolument=$actual_emolument; 
												 //$actual_emolument;							
