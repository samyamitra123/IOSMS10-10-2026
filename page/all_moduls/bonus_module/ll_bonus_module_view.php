...
if($logged_user=='GP')
{
	$bonus_lock_status=$db->fetch_table(" SELECT bonus_type.bonus_type_id_pk
										...
										ON bonus_type.bonus_type_id_pk=bonus_emp.bonus_type_id_fk  
										WHERE bonus_type.active_status='1' AND bonus_emp.bonus_status='4' AND bonus_emp.delete_status='1'
										AND bonus_emp.gp_id_fk='".$_SESSION['location']['gp_id']."' AND bonus_type.employee_total_number=0 AND bonus_emp.monthyear='".$prev_yrr.$current_year."'
...
else if($logged_user=='DA')
{
	$bonus_lock_status=$db->fetch_table(" SELECT bonus_type.bonus_type_id_pk
										...
										ON bonus_type.bonus_type_id_pk=bonus_emp.bonus_type_id_fk 
										WHERE bonus_type.active_status='1' AND bonus_emp.bonus_status='4' AND bonus_emp.delete_status='1'
										AND bonus_emp.ps_id_fk='".$_SESSION['location']['ps_id']."' AND bonus_type.employee_total_number=0 AND bonus_emp.monthyear='".$prev_yrr.$current_year."'
										GROUP BY bonus_emp.bonus_status,bonus_type.bonus_type_id_pk ");
}
else if($logged_user=='zpdaa')
{
	$bonus_lock_status=$db->fetch_table(" SELECT bonus_type.bonus_type_id_pk
										...
										ON bonus_type.bonus_type_id_pk=bonus_emp.bonus_type_id_fk 
										WHERE bonus_type.active_status='1' AND bonus_emp.bonus_status='4' AND bonus_emp.delete_status='1'
										AND bonus_emp.zp_id_fk='".$_SESSION['location']['district_id']."' AND bonus_type.employee_total_number=0 AND bonus_emp.monthyear='".$prev_yrr.$current_year."'
										GROUP BY bonus_emp.bonus_status,bonus_type.bonus_type_id_pk ");
}
...
else if($logged_user=='DA')
{
	$bonus_lock_status=$db->fetch_table(" SELECT bonus_type.bonus_type_id_pk
										FROM  prd_employee_bonus_details bonus_emp
										INNER JOIN  prd_bonus_type_details bonus_type
										ON bonus_type.bonus_type_id_pk=bonus_emp.bonus_type_id_fk AND bonus_type.ps_id_fk=bonus_emp.ps_id_fk 
										WHERE bonus_type.active_status='1' AND bonus_emp.bonus_status='4' AND bonus_emp.delete_status='1'
...
/*if($logged_user=='GP')
{
	...
	$bonus_lock_status=$db->fetch_table(" SELECT bonus_type.bonus_type_id_pk
										...
										ON bonus_type.bonus_type_id_pk=bonus_emp.bonus_type_id_fk 
										WHERE bonus_type.active_status='1' AND bonus_emp.bonus_status='4' AND bonus_emp.delete_status='1'
										 AND bonus_type.gp_id_fk='".$_SESSION['location']['gp_id']."'
										GROUP BY bonus_emp.bonus_status,bonus_type.bonus_type_id_pk ");
}
else if($logged_user=='DA')
{
	...
	$bonus_lock_status=$db->fetch_table(" SELECT bonus_type.bonus_type_id_pk
										...
										ON bonus_type.bonus_type_id_pk=bonus_emp.bonus_type_id_fk 
										WHERE bonus_type.active_status='1' AND bonus_emp.bonus_status='4' AND bonus_emp.delete_status='1'
										 AND bonus_type.ps_id_fk='".$_SESSION['location']['ps_id']."'
										GROUP BY bonus_emp.bonus_status,bonus_type.bonus_type_id_pk ");
}
else if($logged_user=='zpdaa')
{
	$bonus_lock_status=$db->fetch_table(" SELECT bonus_type.bonus_type_id_pk
										...
										ON bonus_type.bonus_type_id_pk=bonus_emp.bonus_type_id_fk 
										WHERE bonus_type.active_status='1' AND bonus_emp.bonus_status='4' AND bonus_emp.delete_status='1'
										  AND bonus_type.zp_id_fk='".$_SESSION['location']['district_id']."'
										GROUP BY bonus_emp.bonus_status,bonus_type.bonus_type_id_pk ");
}
*/

if(isset($bonus_lock_status))
{
	echo "bonus";exit;
	$bonus_locked="TRUE";
}
                            ...
                            <div class="col-xs-11  ">
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        <h1 class="heading">BONUS BILL SELECTION</h1>
                                        ...
                                        <form class="form-horizontal" id="loginForm" method="post" action="ll_bonus_bill_selection_submit.php" >
                                        <input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
                                        <div class="form-group text-center" >
                                            <button type="submit" value="<?=$cryptoGraph->encode(2,4);?>" id="type2" name="type2" class="btn btn-info bt">Bonus Entry</button>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button type="submit"  value="<?=$cryptoGraph->encode(1,4);?>"  id="type" name="type" class="btn btn-info bt">Bonus View</button>
                                        </div>
...
$('.bt').click(function() {
			...
			if(menu_id=='type2' && k=='TRUE')
			{
				...
				window.location.href= "ll_bonus_module_view.php"
				return false;
			}
...
<script>
	$('#type2').click(function(){
		$('#page-load').show();
        $('#page-load').delay(5000000).fadeOut();
