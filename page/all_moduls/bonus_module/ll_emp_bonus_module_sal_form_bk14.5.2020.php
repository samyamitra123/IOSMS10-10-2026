		...
		$employee_list_bonus = $db->fetch_table("SELECT 
												...
												WHERE
										           ...
										           ".$bonus_type."
													...
													AND emp_status = '1'	
												AND emp_id_pk in 
(SELECT emp_id_pk FROM prd_employee_master WHERE ".$bonus_type." AND zp_id_fk = '".$stake_id."' AND emp_status = '1' 
EXCEPT
										...
										foreach ($emp_list_for_bonus as $key) 
										{
											...
											{*/
												...
												if($emp_emolument>$bonus_upper_limit)
												{
													...
													if($arc_emolument_first>$bonus_upper_limit)
													{							
													...
													FROM prd_monthly_salary_archive_final
													WHERE emp_id_fk='".$one_emp_id."' AND 
													salary_monthyear='".$financial_year."12' AND 
													delete_status='1' AND status_flag in (3,4)");
