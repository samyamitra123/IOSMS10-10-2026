...
<div class="col-sm-12">
    <div class="emplist">
        <div class="school">
            <center><h1 class="heading">BONUS FOR THE RELIGIONS <?php echo fun_common($bonus_category,$code_data); ?></h1></center>
            <div class="border"></div>
            </br>
            <form class="form-horizontal bonus_design" id="loginForm" method="post" action="ll_individual_employee_bonus_submit.php" onsubmit="return valid_code();">
