...
$(document).ready(function() {
	...
	$('#year,#bonus_category').change(function(){
			...
			if(year!=""  && cat!="")
			{
				$.post('<?= $config['base_url'] ?>page/all_moduls/bonus_module/ll_ajax_bonus_table_show.php?year='+year+'&bon_cat='+cat, function(data){
        ...
        <div class="row">
            <div class="col-xs-11  ">
                <div class="offer offer-success">
                    ...
                    <h1 class="heading">Bonus Details View</h1>
			...
			<div class="row mb-3">
                    ...
                    <label  class="col-sm-3 col-md-offset-3 control-label" for="inputPassword3">Select Financial Year<span class="star_color">*</span>:</label>
                   ...
                   <!-- <div class="col-sm-3" >-->
                    <label for="inputPassword3" class=" col-sm-3 col-md-offset-3 control-label">Bonus Category <span class="star_color">*</span></label>
                ...
                <div class="row mb-3" style="padding-top: 30px;">
                        <label class="col-sm-3 col-md-offset-3 control-label" for="inputPassword3" id="bonus_name_div" style="display:none;">Bonus Name <span class="star_color">*</span></label>
                        <div class="col-sm-3" >
                      ...
                      <div class="col-sm-12" style="margin-top:15px">
                         <div class="col-sm-5"></div>
                            <div  align="center" id="bonus_table">
                         </div>
                       </div>
			    </div> 
		     </div>
