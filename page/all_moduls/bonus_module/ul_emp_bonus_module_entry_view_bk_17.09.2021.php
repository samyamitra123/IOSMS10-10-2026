				...
				if($bonus_status!="" && $bonus_status!=4 && $logged_user!='BDO')
							{?> 
                                <div class="entry_bonus" align="right">
                                    ...
                                    <a class="btn btn-danger " data-bs-toggle="modal" onClick="bonus_unlock('<?= $cryptoGraph->encode($_SESSION['location']['ps_id'],4);?>','<?=$cryptoGraph->encode("EO",4);?>');"><i class="fa fa-unlock" aria-hidden="true">&nbsp;</i>Unlock</a>
                                    <?php }?>
                                   <?php if($logged_user=='zpacc'){?>
                                    <a class="btn btn-danger " data-bs-toggle="modal" onClick="bonus_unlock('<?= $cryptoGraph->encode($_SESSION['location']['district_id'],4);?>','<?=$cryptoGraph->encode("ZP",4);?>');"><i class="fa fa-unlock" aria-hidden="true">&nbsp;</i>Unlock</a>
                               <?php }?>
                                </div>
                           	<?php }    
