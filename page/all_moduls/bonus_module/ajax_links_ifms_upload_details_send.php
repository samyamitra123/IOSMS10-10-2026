                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <div class="link_p2">
											...
											{
                                            ?>
                                                <a onClick="value_pass('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>','<?php echo $encode_emp_type; ?>','<?php echo $monthyear; ?>','<?php echo $encode_bill_serial_no; ?>');" > <img id="send_bill_sum_id" src="<?php echo $config['base_url']; ?>themes/default/image/send_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer" /></a>
                                        ...
                                        <td width="20%">
                                            <div class="link_p2">
                                                ...
                                                ?>
                                                    ...
                                                    <a id="send_benf"  style="display:none;"  onClick="value_pass_sftp('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>','<?php echo $encode_emp_type; ?>','<?php echo $monthyear; ?>' ,'<?php echo $encode_bill_serial_no; ?>');"><img src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer;"></a>
                                                <?php
                                                } 
                                                ...
                                                ?>
                                                    ...
                                                    <a id="send_benf"  onClick="value_pass_sftp('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>','<?php echo $encode_emp_type; ?>','<?php echo $monthyear; ?>','<?php echo $encode_bill_serial_no; ?>');"><img src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer"></a>
                                                <?php
                                                } 
                                                else 
                                                {
...
//**************************************************************
	...
	function value_pass(encode_requsition, drn_number, emp_type,monthyear,bill_serial_no)
	{
		//alert(11);
		...
		if(user1=='FC&CAO')
		{
			$.post('<?= $config['base_url'] ?>page/intra_zp/salary_fcncao/text_file/xml_file.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type +'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no, function (data) {
			//alert(data);
			});
			
			$.post('<?= $config['base_url'] ?>page/api/ifms/zp/index.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no, function (data) {
			//alert(data);
			//return false;
		...
		{
			$.post('<?= $config['base_url'] ?>page/intra_ps/eo/text_file/xml_file.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type +'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no, function (data) {
			//alert(data);false;  
			});
			
			$.post('<?= $config['base_url'] ?>page/api/ifms/ps/index.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no, function (data) {
			//alert(data);
			//return false;
			$('#page-load').delay(100).fadeOut();
			if (data.trim() == 'Success')
		...
		{
			$.post('<?= $config['base_url'] ?>page/intra_prd/block/text_file_ifms/xml_file.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type +'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no, function (data) {
			//alert(data);false;  
			});
			
			$.post('<?= $config['base_url'] ?>page/api/ifms/gp/index.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no, function (data) {
			//alert(data);
			//return false;
			$('#page-load').delay(100).fadeOut();
			if (data.trim() == 'Success')
	...
	function value_pass_sftp(encode_requsition, drn_number, emp_type,monthyear,bill_serial_no)
	{
		//$('#page-load').show();
		var requsition = encode_requsition;
		var drn_no = drn_number;
		...
		{
		$.post('<?= $config['base_url'] ?>page/api/ifms/zp/sftp_index.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear+ '&bill_serial_no=' + bill_serial_no, function (data) {
			//alert(data);
			$("#status1").html(data);
		...
		else if(user1=='EO')
		{
			...
			$.post('<?= $config['base_url'] ?>page/api/ifms/ps/sftp_index.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear+ '&bill_serial_no=' + bill_serial_no, function (data) {
			//alert(data);
			$("#status1").html(data);
			$('#page-load').delay(500).fadeOut();
			if (data.trim() == '2')
		...
		{
		$.post('<?= $config['base_url'] ?>page/api/ifms/gp/sftp_index.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear+ '&bill_serial_no=' + bill_serial_no, function (data) {
			alert(data);
			$("#status1").html(data);
			$('#page-load').delay(500).fadeOut();
			if (data.trim() == '2')
