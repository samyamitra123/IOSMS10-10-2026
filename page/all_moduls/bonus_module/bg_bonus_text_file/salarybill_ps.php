...
$db = new database();	
	...
	$sql_query=$db->fetch_table("SELECT 
									...
									WHERE bill.ps_id_fk='".$_SESSION['location']['ps_id']."' and bill.bill_no='".$bill_no."' and bill.salary_monthyear= '".$month_year."' AND bill.requisition_type='".$requisition_type."' AND bill.status='1'");
...
//	 $sql_salarymonth=$db->fetch_table("
//select DISTINCT(sal.salary_monthyear), ad.lead_bank, ad.lead_branch, ad.treasury_block_code 
