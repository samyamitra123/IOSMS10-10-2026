                            ...
                            <div class="col-xs-11  ">
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        <h1 class="heading">BONUS BILL ACTION</h1>
                                        ...
                                        <form class="form-horizontal" id="loginForm" method="post" action="bg_bonus_bill_action_submit.php" onsubmit="return valid_code();">
                                        <input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
                                        <div class="form-group text-center" >
                                            <button type="submit" value="<?=$cryptoGraph->encode(2,4);?>" id="type2" name="type2" class="btn btn-info">New Bill Generate</button>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button type="submit"  value="<?=$cryptoGraph->encode(1,4);?>"  id="type" name="type" class="btn btn-info">Previous Bill View</button>
                                        </div>
