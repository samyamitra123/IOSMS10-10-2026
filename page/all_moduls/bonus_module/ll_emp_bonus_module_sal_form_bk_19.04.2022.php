...
{ 
	...
	if($stake_level=='ZP')
	{
		...
		$employee_list_bonus = $db->fetch_table("SELECT 
												...
												AND emp_id_pk in 
(SELECT emp_id_pk FROM prd_employee_master WHERE ".$bonus_type." AND zp_id_fk = '".$stake_id."' AND ((emp_status = '1' and emp_first_join_date<'2020-10-02' ) or (emp_termination_date>='2020-09-30' and emp_termination_date<='2021-10-31' )) 
EXCEPT
