...
<script>
  ...
  if(document.getElementById('pass_chk').value!='yes'){
	...
	if(document.getElementById('new_password').value!=''){	
	//alert(1);						
		var pass = CryptoJS.SHA256(document.login_form.new_password.value);
		//alert(pass);
	...
	if(document.getElementById('confirm_password').value!=''){
		var pass_nw = CryptoJS.SHA256(document.getElementById('confirm_password').value);
...
<input type="hidden" name="sec_tok" id="sec_tok" value="<?=$enc_token?>" />
    <form class="form-horizontal" method="post" name="login_form" action="<?= $config['base_url']?>page/all_moduls/changepassword/reset_password_insert_update.php" onsubmit="return validContact();">
    <div class="row mb-3">
