...
<!-- <script type="text/javascript" src="themes/default/jquery-ui/js/jquery-ui-1.9.2.custom.min.js"></script> -->
   ...
   <?php if($_SESSION['user_info']['stake_level'] == 66){ ?>
...
<div class="border"></div>
	 ...
	 $cryptography=new cryptography(); 
        ...
        <form class="form-horizontal" action="<?= $config['base_url'] ?>page/all_moduls/changepassword/changepassword_update.php" name="login_form" id="form_emp_contact" method="post" enctype="multipart/form-data" onsubmit="return validForm();">
