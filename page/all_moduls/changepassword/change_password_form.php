...
<!-- <script type="text/javascript" src="themes/default/jquery-ui/js/jquery-ui-1.9.2.custom.min.js"></script> -->
    <!--		<script>
          ...
          <?php require '../../common_back_btns.php'; 
           if($_SESSION['user_info']['stake_level']=='62'){?>
		  ...
		  <? } else{ ?>
           <div class="welcome_msg">
					...
					else if(!empty($_SESSION['location']['district_name'])){
...
<div class="border"></div>
	 ...
	 $cryptography=new cryptography(); 
        ...
        <form class="form-horizontal" action="<?= $config['base_url'] ?>page/all_moduls/changepassword/changepassword_insert_submit.php" name="login_form" id="form_emp_contact" method="post" enctype="multipart/form-data" onsubmit="return validForm();">
...
?>
     ...
     <div class="row mb-3">
      ...
      <div class="col-sm-4">
      		<input  type="password" maxlength="20" autocomplete="off " name="new_pass" id="new_pass" class="form-control"  >
      ...
      <div class="col-sm-4">
      		<input  type="password" maxlength="20" autocomplete="off " name="conf_pass"  id="conf_pass" class="form-control"  >
  	  </div>
  	  <div class="col-sm-3"></div>
  	  </div>
      <!--<div class="form-group">
