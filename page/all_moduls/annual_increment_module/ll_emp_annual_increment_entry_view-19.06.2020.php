                            ...
                            <div class="table-responsive">
                               <!-- <table class="table-responsive" style="width:100%;">-->
								...
								$ropa_table='ropa_2019_ll';
												...
												//$basic=$pay_in_pay_band+$grade_pay; 
									...
									$level_data = $fetch_level[0]['level'];
									
									//$prv_level_data=$level_data-1;
									
									 //echo (" SELECT level FROM ropa_2019_ll ORDER BY level ASC OFFSET 10 ROWS FETCH NEXT 1 ROWS only ");
								...
								/********************************************************** END *************************************************/
										...
										if(($increment_amount== NULL ||$increment_amount=='0') && $pay_in_pay_band<='200999' )
												{
									...
									else if (($increment_amount== NULL ||$increment_amount=='0') && $pay_in_pay_band>='201000')
												{
