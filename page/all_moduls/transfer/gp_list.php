...
$arr=$db->fetch_table("
						...
						count(distinct(em2.emp_id_pk)) as emp_finz  from prd_location_master_gp gp
						...
						LEFT JOIN prd_employee_master as em2 on em2.gp_id_fk=gp.gp_id_pk and em2.emp_status in('1') and em2.emp_form_status='5'
...
<td><?= $item['gp_code']?></td>
<td><?= $item['emp_finz']?></td>
<td class="view"><a href="<?= $config['base_url'] ?>page/all_moduls/transfer/employee_list.php?gp_id_fk=<?= $cryptoGraph->encode($item['gp_id_pk'],4);?>"><img src="<?= $config['base_url'] ?>themes/default/image/view_icon.png" width="25" alt="view" /></a></td>
</tr>
<? $cnt+=1; } ?>
<tr>
