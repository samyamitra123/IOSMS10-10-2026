        ...
        <div id="attraction">
            ...
            <div align="center">
				...
				<? if($approval_status=='3' )
				 {?> 
                		<a class="btn btn-success" data-bs-toggle="modal"  data-bs-target="#approve_k">APPROVE</a>
                <? }?>
				<? if( $approval_status=='2' ||$approval_status=='3') {?> 
                         <a class="btn btn-danger" data-bs-toggle="modal"  data-bs-target="#reject_k">REJECT</a>
                <? }?>
			</div>
        </div>
