                                ...
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        ...
                                        <div class="form-group text-center" >
                                            	...
                                            	<a class="btn btn-info" href="view_zp_sal_requsition_2009.php?emp_type=<?php echo $cryptoGraph->encode(366,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Government Employee Salary View</a>
											
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           
                                            	<a class="btn btn-info" href="view_zp_sal_requsition_2009.php?emp_type=<?php echo $cryptoGraph->encode(367,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Grant-in-Aid Employee Salary View</a>
                                        ...
                                        <div class="form-group text-center" >
                                            	...
                                            	<a class="btn btn-info" href="text_file_salary_2009.php?emp_type=<?php echo $cryptoGraph->encode(366,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Government Employee Salary Bill</a>
											
                                            	
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           
                                            	<a class="btn btn-info" href="text_file_salary_2009.php?emp_type=<?php echo $cryptoGraph->encode(367,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Grant-in-Aid Employee Salary Bill</a>
