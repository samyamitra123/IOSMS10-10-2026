...
<div class="row mb-3">
    ...
    <div class="col-sm-3">
      ...
      <span>PNRDIOSMS</span><input type="text" class="form-control-iosms upper_case" name="bill" id="bill" placeholder="Salary Bill Number" autocomplete="off" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz0123456789/');" value="<?= $bill_no;?>"   >
      </div>
    </div>
    <div class="col-sm-3"></div>
    </div>
