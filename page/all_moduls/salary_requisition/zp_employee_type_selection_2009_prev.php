                            ...
                            <div class="col-xs-11  ">
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        <h1 class="heading"><?php if($requisition_type=='1003'){echo "Supplementary ";} ?>Salary BILL SELECTION FOR ROPA 2009</h1>
                                        ...
                                        <div class="form-group text-center" >
                                            	...
                                            	<a class="btn btn-info" href="view_zp_sal_requsition_2009_prev.php?emp_type=<?php echo $cryptoGraph->encode(366,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Government Employee Salary View</a>
											
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           
                                            	<a class="btn btn-info" href="view_zp_sal_requsition_2009_prev.php?emp_type=<?php echo $cryptoGraph->encode(367,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Grant-in-Aid Employee Salary View</a>
                                        ...
                                        <div class="form-group text-center" >
                                            	...
                                            	<a class="btn btn-info" href="text_file_salary_2009_prev.php?emp_type=<?php echo $cryptoGraph->encode(366,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Government Employee Salary Bill</a>
											
                                            	
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           
                                            	<a class="btn btn-info" href="text_file_salary_2009_prev.php?emp_type=<?php echo $cryptoGraph->encode(367,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Grant-in-Aid Employee Salary Bill</a>
