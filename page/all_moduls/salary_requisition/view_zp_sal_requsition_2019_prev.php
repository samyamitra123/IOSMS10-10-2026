...
$tch= $db->fetch_table("SELECT sal.ps_id_fk,tch.emp_status, sal.empcd, 
       ...
       sal.overdrawn, sal.salary_type, sal.cause, sal.part_day, sal.total_loan_deduction,sal.gsli,sal.consolidated_pay,
	   sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.hra_deduction,
		tch.emp_first_name, tch.emp_second_name, tch.emp_last_name, tch.emp_pay_in_payband, tch.emp_id_pk, sal.ropa_status, sal.ropa_level
									FROM
									...
									INNER JOIN 
										...
										WHERE
											...
											AND sal.status_flag in('3','4') AND is_saved='1' AND sal.delete_status='1' AND salary_monthyear='".date("Y").date("m", strtotime("-1 months"))."'  AND requisition_type='".$requisition_type."' 
											AND sal.ropa_status='".$ropa_status."' order by tch.emp_first_name ;
								");
...
<!--                         <th>Less Drawal</th>-->
					...
					<tr style="text-align: right;">
						...
						<td><?php echo $key['ropa_basic_pay'] ?></td>
