...
<div class="col-sm-12">
<h1 class="heading">Salary Bill Generation ROPA 2019</h1>
...
<div id="form_show" style=" margin-left: 11%;"> 
<?
...
<div class="row mb-3">
    ...
    <label for="inputPassword3" class="col-sm-3 col-form-label">Bill For The Month</label>
     <label for="inputPassword3" class="col-sm-3 col-form-label" style="color:#2873A3; font-weight:bold; text-align:left; font-size:16px;"><?php echo $month.", ".$year ?></label>
 </div>
...
<?php if($logged_user=='FC&CAO' || $logged_user=='EO' || $logged_user=='BDO')
	...
	if( $logged_user=='FC&CAO')
		...
		//var_dump($get_bill_serial_no); die;
...
<div class="row mb-3">
    <div class="col-sm-2"></div>
    <label for="inputPassword3" class="col-sm-3 col-form-label">Bill Serial No.<span class="star_color">*</span></label>
    <div class="col-sm-3">
...
<div class="row mb-3">
    <div class="col-sm-2"></div>
    <label for="inputPassword3" class="col-sm-3 col-form-label">Salary Bill No.<span class="star_color">*</span></label>
    <div class="col-sm-3">
    	<div class="iosms-bill">
      <span>PNRDIOSMS</span><input type="text" class="form-control-iosms upper_case billiosms" name="bill" id="bill" placeholder="Salary Bill Number" autocomplete="off" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz0123456789/');" value="<?= str_replace('PNRDIOSMS','',$bill_no);?>"   >
      </div>
    </div>
    <div class="col-sm-3"></div>
    </div>
    ...
    <div class="row mb-3">
    <div class="col-sm-2"></div>
    <label for="inputPassword3" class="col-sm-3 col-form-label">Enter Bill Date<span class="star_color">*</span></label>
    <div class="col-sm-3">
...
<div class="row mb-3" style="margin-left: 41%;">
 ...
 {?>
	...
	?>
	<div  style="width: 100%; text-align: center;">  <a href='<?php echo $config['base_url'] ?>page/all_moduls/ifms_ajax_links_all/ajax_links_ifms_upload_details.php?ropa_status=<?php echo $crypto->encode($ropa_status,4);?>' class="btn btn-success">IFMS UPLOAD</a></div>
	<?php } ?>
    </div>
  </div>
</form>
<?php 
	if(count($find_bill)=='1')
		{ ?>
			<div class="alert alert-success"  id="send_bill" style="width: 50%;margin-left: 17%;text-align: center;"><strong>Bill Number Inserted</strong></div><br /> 
		<?php 
		}
...
<style type="text/css">
    ...
    .iosms-bill{border: 1px solid #ced4da;}
    .iosms-bill span{width: 45%; margin-left: 10px;font-weight: 600;}
</style>
