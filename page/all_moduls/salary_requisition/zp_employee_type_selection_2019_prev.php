...
$employee_type_fetch=$db->fetch_table(" SELECT COUNT(CASE WHEN (emp.zp_emp_type='366') THEN 1 ELSE NULL END) AS total_govt,
										...
										WHERE emp_status in (1) AND emp.zp_id_fk='".$_SESSION['location']['district_id']."' 
										AND sal.salary_monthyear='".date("Y").date("m", strtotime("-1 months"))."' AND status_flag='4'
                            ...
                            <div class="col-xs-11  ">
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        <h1 class="heading"><?php if($requisition_type=='1003'){echo "Supplementary ";} ?>Salary BILL SELECTION FOR ROPA 2019</h1>
										...
										<?php //var_dump($employee_type_fetch[0]['total_govt']); die; ?>
										
										
                                        <div class="form-group text-center" >
                                        	
                                            	<a class="btn btn-info" href="view_zp_sal_requsition_2019_prev.php?emp_type=<?php echo $cryptoGraph->encode(366,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Government Employee Salary View</a>
												
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           
                                            	<a class="btn btn-info" href="view_zp_sal_requsition_2019_prev.php?emp_type=<?php echo $cryptoGraph->encode(367,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Grant-in-Aid Employee Salary View</a>
                                        ...
                                        <div class="form-group text-center" >
                                            	...
                                            	<a class="btn btn-info" href="text_file_salary_2019_prev.php?emp_type=<?php echo $cryptoGraph->encode(366,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Government Employee Salary Bill</a>
											
                                            	
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           
                                            	<a class="btn btn-info" href="text_file_salary_2019_prev.php?emp_type=<?php echo $cryptoGraph->encode(367,4);?>&requisition_type=<?php echo $_GET['requisition_type']; ?>">Grant-in-Aid Employee Salary Bill</a>
