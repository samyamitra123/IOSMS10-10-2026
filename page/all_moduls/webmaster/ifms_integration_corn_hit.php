			...
			color: #006666;
                        ...
                        <div class=" col-sm-offset-3 col-sm-12">
                          <div class="col-sm-5">      
                           ...
                           <a class="btn btn-success" href="<?= $config['base_url'] ?>page/api/ifms/sftp_cron/dot_done_ifms_cron_job.php"  style="text-align:center">.done hit</a>
                            <a class="btn btn-warning" href="<?= $config['base_url'] ?>page/api/ifms/sftp_cron/prd_ifms_cron_job.php" style="text-align:center">Corn hit</a>
                                  </div>
                                 </div>  
                                </div>
                               </div>
                          ...
                          <div class="col-sm-5">      
                            <div class="panel panel-default"  style="border-left:4px solid; border-left-color:#0A6E8C; margin-top: 3%;">
                               <div class="page_title">
                                  <div class="panel-body" style="background-color:#F0F3F4; ">
                             <a class="btn btn-info" href="<?= $config['base_url'] ?>page/api/ifms/sftp_cron/sftp_con_test.php?user=gp"style="text-align:center"> SFTP Conection GP</a>
                                    <br/>
