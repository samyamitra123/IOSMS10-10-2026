                                        ...
                                        <div class="page_title">
                                            <div id="accordion">     
                                                ...
                                                <div class="form-group">
                                                	<a class="btn btn-success" href="file_list.php?user=gp&folder=6" style="text-align:center">Beneficiary File List</a>
													<a class="btn btn-warning" href="file_list.php?user=gp&folder=2" style="text-align:center">.done List</a>
                                                    <a class="btn btn-info" href="file_list.php?user=gp&folder=3" style="text-align:center">Wrong List</a>
                                                    <a class="btn btn-warning" href="file_list.php?user=gp&folder=2" style="text-align:center">Acknowledgement List</a>
                                                    <a class="btn btn-success" href="file_list.php?user=gp&folder=5" style="text-align:center">Payment File List</a>
                                                </div>
                                                
                                                <h2>PANCHAYAT SAMITI</h2>
                                                <div class="form-group">
                                                	<a class="btn btn-success" href="file_list.php?user=ps&folder=6" style="text-align:center">Beneficiary File List</a>
													<a class="btn btn-warning" href="file_list.php?user=ps&folder=2" style="text-align:center">.done List</a>
                                                    <a class="btn btn-info" href="file_list.php?user=ps&folder=3" style="text-align:center">Wrong List</a>
                                                    <a class="btn btn-warning" href="file_list.php?user=ps&folder=2" style="text-align:center">Acknowledgement List</a>
                                                    <a class="btn btn-success" href="file_list.php?user=ps&folder=5" style="text-align:center">Payment File List</a>
                                                </div>
                                                
                                                <h2>ZILLA PARISHAD</h2>
                                                <div class="form-group">
                                                	<a class="btn btn-success" href="file_list.php?user=zp&folder=6" style="text-align:center">Beneficiary File List</a>
													<a class="btn btn-warning" href="file_list.php?user=zp&folder=2" style="text-align:center">.done List</a>
                                                    <a class="btn btn-info" href="file_list.php?user=zp&folder=3" style="text-align:center">Wrong List</a>
                                                    <a class="btn btn-warning" href="file_list.php?user=zp&folder=2" style="text-align:center">Acknowledgement List</a>
                                                    <a class="btn btn-success" href="file_list.php?user=zp&folder=5" style="text-align:center">Payment File List</a>
                                                </div>
                                            </div>  
                                        </div>
                                    </div>
