...
<div class="container pb-4">
	<div class="row">
		<h2>Gram panchayat PF Legacy Subscription Data</h2>
		<div class="col-md-4">
...
<script type="text/javascript">
	$('#district').on('change', function(){
		...
		$.post('ajaxngipf-block.php', { districtId: districtId,action:'getblock'})
		  .done(function( data ) {
		  	//console.log(data);
		    $('#block').html(data);
	...
	$('#year').on('change', function(){
		...
		$('.result').html(data);
		$.post('ajaxngipf-block.php', { psId: psId,year:year,action:'getdrnDetails'})
		  .done(function( data ) {
            $('.result').html(data);
