...
<div class="container pb-4">
	<div class="row">
		<h2>Zilla Parishad PF Legacy Subscription Data</h2>
		<div class="col-md-6">
			<label for="district" class="form-label">Select Zilla Parishad</label>
			<select name="district" id="district" class="form-control" required>
				<option>Select Zilla Parishad</option>
...
<script type="text/javascript">
	...
	$('#year').on('change', function(){
		...
		if(zpId > 0)
		{
			$.post('ajaxngipf-district.php', { zpId: zpId,year:year,action:'getdrnDetails'})
			  .done(function( data ) {
	            $('.result').html(data);
