...
$log_user_gp=$_SESSION['user_info']['stake_user'];
...
WHERE CAST(b.block_code AS text) like '".$log_user_gp."'  GROUP BY gp_id_pk ");
/*
$gp_id_pk_array= array_column($gp,'gp_id_pk');
$trimmed_str= implode(",\n",$gp_id_pk_array);
print_r($trimmed_str); die;*/
...
//$deb[] = $ar['gp_id_pk'];
 ...
 $log_user_gp_id =  trim($str,',');


if(($_SESSION['user_info']['stake_abbr'])=='BDO')
{
	 $log_user= "gp_id_fk in(".$log_user_gp_id.")"; 
...
{
	$log_user="zp_id_fk=0";
	//or (mas.zp_id_fk!='0' and mas.zp_emp_type='367')
...
WHERE SUBSTRING(cast(mas.emp_retirement_date as text),1,7)>='2020-01'  and SUBSTRING(cast(mas.emp_retirement_date as text),1,7)<='2022-03'
AND mas.emp_status in('1')  AND mas.gp_id_fk NOT IN('3380','3383','3400','3401','3402','3403') AND mas.ps_id_fk NOT IN ('342','343')
...
from prd_employee_master mas  WHERE 
 mas.emp_status in('2') and mas.ropa_status='1' AND mas.gp_id_fk NOT IN('3380','3383','3400','3401','3402','3403')
  AND(mas.zp_id_fk is null or mas.zp_id_fk not in('21') )
  and (mas.".$log_user." )
...
where date = max_my_date and reason='1993' AND (SUBSTRING(cast(date as text),1,7)>='2020-01') and SUBSTRING(cast(date as text),1,7)<='2021-05') as stop ON mas1.emp_id_pk=stop.emp_id_fk )");
...
from prd_employee_master mas WHERE  mas.emp_id_pk='".$mas_data['emp_id_pk']."' and SUBSTRING(cast(mas.emp_retirement_date as text),1,7)>='2020-01'  and SUBSTRING(cast(mas.emp_retirement_date as text),1,7)<='2022-03'
AND mas.emp_status in('1') and mas.ropa_status='1' AND mas.gp_id_fk NOT IN('3380','3383','3400','3401','3402','3403') 
AND (mas.zp_id_fk is null or mas.zp_id_fk not in('21'))
...
AND mas.emp_status in('2') and mas.ropa_status='1' AND mas.gp_id_fk NOT IN('3380','3383','3400','3401','3402','3403') 
AND (mas.zp_id_fk is null or mas.zp_id_fk not in('21'))
and (mas.ps_id_fk!='0' or mas.gp_id_fk!='0' or (mas.zp_id_fk!='0' and mas.zp_emp_type='367'))
 AND mas.ps_id_fk NOT IN ('342','343') AND mas.emp_id_const!='0'
 AND mas.emp_desig NOT IN('1120','1124','9012','9013','9014','9015','9016','9017','1'))mas1
...
from prd_stop_sal_reason)A where date = max_my_date and reason='1993' AND (SUBSTRING(cast(date as text),1,7)>='2020-01') and SUBSTRING(cast(date as text),1,7)<='2021-05') as stop ON mas1.emp_id_pk=stop.emp_id_fk ))b");										
		...
		if($sql_pension_employee_data_insert==1)
		{
					...
					AND emp_desig NOT IN('1120','1124','9012','9013','9014','9015','9016','9017','1')" );	
...
from prd_stop_sal_reason)A where date = max_my_date and reason='1993') as stop ON pen.emp_id_fk=stop.emp_id_fk 
 ...
 and 
 SUBSTRING(cast(emp.emp_termination_date as text),1,7)>='2020-01'  and SUBSTRING(cast(emp.emp_termination_date as text),1,7)<='2022-03'
 
  AND emp.gp_id_fk NOT IN('3380','3383','3400','3401','3402','3403') 
 AND (emp.zp_id_fk is null or emp.zp_id_fk not in('21'))
 and (emp.".$log_user." )
  AND emp.ps_id_fk NOT IN ('342','343') AND emp.emp_id_const!='0' 
 AND emp.emp_desig NOT IN('1120','1124','9012','9013','9014','9015','9016','9017','1')");
			...
			$update_penstion_data=$db->update("UPDATE prd_pension_employee SET
				...
				else if($sql_pension_data[0]['flag']=='N')
				{
					$update_penstion_data=$db->update("UPDATE prd_pension_employee SET
													...
													ps_id_fk='".$ps_id_fk."',
													zp_id_fk='".$zp_id_fk."'
													WHERE emp_id_fk='".$mas_data_up['emp_id_pk']."' AND emp_desig NOT IN('1120','1124','9012','9013','9014','9015','9016','9017','1')");
				}
...
header("Location: show_retired_employee_list.php");
