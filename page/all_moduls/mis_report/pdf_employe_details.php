...
function fun_common1($tcode, $desig_data)
	{
		foreach ($desig_data as $key) 
		{
...
function fun_desig($val){
		$db = new database();
		$data = @$db->fetch_table("SELECT designation_name FROM zpemp_emp_desig_master where designation_id='".$val."';");
...
function date_frmt($original_date){
  ...
  $Employee_ID_val=$emp_data[0]['emp_id_const']; 
	...
	{
		$emp_desig_first_app='GP&nbsp;'.fun_common1($emp_data[0]['emp_desig_first_app'],$desig_data);
	}
	else
	{
		$emp_desig_first_app=fun_common1($emp_data[0]['emp_desig_first_app'],$desig_data);
	}
...
$mpdf->WriteHTML('<div class="segment">
				...
				<tr>
		          ...
		          <td class="col1" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;">Voter ID :</td>
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['emp_edu_quali'],$code_data).'</td>
				</tr>
				</table>',2);
...
$mpdf->WriteHTML('<div class="segment">
				...
				<tr>
					...
					<td  class="col1" style="color: #1F6377;font-weight: bold;width:25%;font-family: "Arial Narrow";font-style: italic;" >Designation :</td>',2);
					
					 if($emp_data[0]['zp_id_fk']!='0' && $emp_data[0]['zp_id_fk']!=''){
						 
						 
					$mpdf->WriteHTML('<td colspan="3" style="width:25%;">'.fun_desig( $emp_data[0]['emp_desig']).'</td>',2);
					 }else{
						 $mpdf->WriteHTML('<td colspan="3" style="width:25%;">'.fun_common( $emp_data[0]['emp_desig'],$code_data).'</td>',2);
					 }
				$mpdf->WriteHTML('</tr>
				<tr>
					...
					<td style="width:25%;">'.date_frmt($emp_data[0]['emp_first_join_date']).'</td>
				...
				<tr>
					...
					<td style="width:25%;">'.date_frmt($emp_data[0]['emp_conf_join_date']).'</td>
					...
					<td style="width:25%;">'.date_frmt($emp_data[0]['emp_join_prsnt_post_date']).'</td>
				</tr>
                <tr>
					...
					<td style="width:25%;">'. date_frmt($emp_data[0]['emp_join_prsnt_office_date']).'</td>
					...
					<td style="width:25%;">'.date_frmt($emp_data[0]['emp_retirement_date']).'</td>
				</tr>',2);
				if($emp_data[0]['emp_desig']!='9012' && $emp_data[0]['emp_desig']!='9013' && $emp_data[0]['emp_desig']!='9014' && $emp_data[0]['emp_desig']!='9015' && $emp_data[0]['emp_desig']!='9016' && $emp_data[0]['emp_desig']!='9017'){  
                $mpdf->WriteHTML('<tr>
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['emp_status_deputation'],$code_data).'</td>
					<td class="col3" style="color: #1F6377;font-weight: bold;width:25%;font-family: "Arial Narrow";font-style: italic;">Employee Group:</td>
					<td style="width:25%;">'.fun_common($emp_data[0]['emp_group'],$code_data).'</td>
				</tr>',2);
				}
                $mpdf->WriteHTML('<tr>
					...
					<td style="width:25%;">'.date_frmt($emp_data[0]['emp_next_increment_date']).'</td>
				</tr>
                <tr>
...
$mpdf->WriteHTML('<div class="segment">
               ...
               $mpdf->WriteHTML(' <tr>
				...
				$mpdf->WriteHTML('
				<tr>
					<td class="col3" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;"> Basic :</td>
					<td style="width:25%;">'.$emp_data[0]['emp_pay_in_payband'].'</td>
					<td class="col1" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;">Level :</td>
					<td style="width:25%;">'.$emp_data[0]['ropa_level'].'</td>
				</tr>',2);
                }
                $mpdf->WriteHTML('<tr>
                ...
                <tr>
					...
					<td style="width:25%;">'.$emp_data[0]['emp_branch_code'].'</td>
...
$mpdf->WriteHTML('<div class="segment">
               ...
               $mpdf->WriteHTML(' <tr>
                ...
                <tr>
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['emp_spouse_job_status'],$code_data).'</td>
				...
				<tr>
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['spouse_medical_allowance'],$code_data).'</td>
				</tr>
				<tr>
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['emp_spouse_res'],$code_data).'</td>
                ...
                $mpdf->WriteHTML(
				   '<tr>
					<td class="col1" style="color: #1F6377;font-weight: bold;width:25%;font-family: "Arial Narrow";font-style: italic;">PAN No :</td>
					<td style="width:25%;">'.$emp_data[0]['emp_pan_no'].'</td>
				
					<td class="col3" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;">Blood Group :</td>
					<td style="width:25%;">'.fun_common($emp_data[0]['emp_blood_grp'],$code_data).'</td>
				</tr>',2);
                $mpdf->WriteHTML('<tr>
                ...
                $mpdf->WriteHTML('<tr>
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['emp_diff_able'],$code_data).'</td>',2);
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['conv_allow_status'],$code_data).'</td>',2);
                    } 
				$mpdf->WriteHTML('</tr>
				</table>',2);
...
$mpdf->WriteHTML('<div class="segment">
						...
						<table border="0" width="100%" style="font-size: 11px;vertical-align: bottom;">
							<tr>
								...
								<td style="width:25%;">'.fun_state($emp_data[0]['pre_state']).'</td>
							...
							<tr>
								...
								<td style="width:25%;">'.fun_dist($emp_data[0]['emp_pre_dist']).'</td>
						...
						<table border="0" width="100%" style="font-size: 11px;vertical-align: bottom;">
							<tr>
								<td class="col1" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;">State :</td>
								<td style="width:25%;">'.fun_state($emp_data[0]['per_state']).'</td>
							...
							<tr>
								...
								<td class="col3" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;">District :</td>
								<td style="width:25%;">'.fun_dist($emp_data[0]['emp_per_dist']).'</td>
...
{
	$mpdf->WriteHTML('<span style="color:green;font-weight:bold">PROFILE FINALIZED</span>');		
}
