...
//print_r($code);
 foreach (explode(",",$emp_error_code) as $val) {
		...
		$code_data=$db->fetch_table("SELECT description FROM prd_pension_error_code_master where error_code='".$val."'");

   echo '<span class="contacts-title" style="color:#0E3670;"><li><span class="contacts-title" style=" color:#730A0A;"><strong>'.$code_data[0]['description'].'</strong></span></li></span>'.'</br>';
