...
?>
<div class="downpdf" align="right"><a href="<?= $config['base_url']?>page/all_moduls/mis_report/pdf_employe_details.php?id=<?php echo $_GET['id'] ?>"><img src="<?= $config['base_url'] ?>themes/default/image/pdf_download.png"/></a></div>
<div id="accordion">
       <h3 id="att" onclick=""> Primary Profile </h3>
        ...
        <table border="0" width="100%">
				<tr>
                    ...
                    <?php if($emp_data[0]['zp_id_fk']!='0' && $emp_data[0]['zp_id_fk']!=''){?>
					<td style="text-transform:uppercase;" width="25%"><?php echo fun_desig( $emp_data[0]['emp_desig']); ?></td>
                ...
                <tr>
					<td class="text_r" width="25%">Stake:</td>
					<td width="25%"><?php
 ...
 ?>
                ...
                <tr>
					...
					if($emp_data[0]['emp_desig_first_app']=='1114' ||$emp_data[0]['emp_desig_first_app']=='1115'|| $emp_data[0]['emp_desig_first_app']=='1118')
						{
						echo 'GP&nbsp;'. fun_common1($emp_data[0]['emp_desig_first_app'],$desig_data); 
						}
						else
						{
						echo fun_common1($emp_data[0]['emp_desig_first_app'],$desig_data);
						}
					 ?></td>
                ...
                <tr>
					...
					<td width="25%"><?php echo $emp_data[0]['emp_next_increment_amount'];?></td><td class="text_r" width="25%"></td><td width="25%">&nbsp;</td>
				</tr>
				</table>
        ...
        <table border="0" width="100%">
                ...
                <tr>
					...
					<td class="text_r" width="25%">Housing Scheme :</td>
