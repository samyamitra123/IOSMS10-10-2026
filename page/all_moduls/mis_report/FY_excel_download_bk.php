	...
	if($sec_time_token!=$enc_session)
{
	...
	$emp_name = $db->fetch_table("
		...
		else if($emp_name[0]['zp_id_fk']!='0')
		{
			...
			/*$tch_fetch=$db->fetch_table("SELECT sal.salary_monthyear,sal.basic,sal.da,sal.ma,sal.hra,sal.gross_salary,sal.gsli,sal.gpf,sal.p_tax,sal.i_tax,sal.net,sal.festival_loan,sal.overdrawn,sal.conv_allow,sal.hill_allowance,sal.consolidated_pay
			...
			$tch_fetch=$db->fetch_table("SELECT salary_monthyear,basic,da,ma,hra,gross_salary,gsli,gpf,p_tax,i_tax,net,festival_loan,overdrawn,conv_allow,hill_allowance,allowance,consolidated_pay
		  ...
		  AND CAST(bill.salary_monthyear as integer)= $finn_year_month  
			...
			WHERE aer.emp_id_const='".$_SESSION['user_info']['stake_user']."'  and aer.bill_id_fk!='0' and aer.delete_status='1'
		  AND CAST(bill.salary_monthyear as integer)= $finn_year_month  
			order by bill.salary_monthyear");
...
?>
 ...
 $t_total_com=$c_total_basic+$c_total_da+$c_total_ma+$c_total_hra+$c_total_gsli+$c_total_ptax+$c_total_itax+$c_total_gross+$c_total_gpf+$c_total_net+$c_total_bonus+$c_total_festival+$c_total_over+$c_total_conv+$c_total_hill+$c_total_special;
  ...
  $mpdf->WriteHTML('<table width="100">
    <tr>
    <th colspan="15" style="text-align:center;"><br />STATEMENT OF SALARY INCOME OF '. $emp_name[0]['emp_first_name'].' '.$emp_name[0]['emp_second_name'].' '.$emp_name[0]['emp_last_name'].'<br /></th>
    </tr>
    <tr>
    <th colspan="3"><br />F.Y:'.$finn_year[0].'-'.$finn_year[1].'<br /></th>
    <th colspan="6"><br />DESIGNATION:'.$designation.'<br /></th>
...
?>
   ...
   $mpdf->WriteHTML('<tr style="outline: thin solid">
		<th scope="col">CONSOLITED PAY</th>
		<td>RS</td>
		<td>'.$tch[0][0]['consolidated_pay'].'</td>
		<td>'.$tch[1][0]['consolidated_pay'].'</td>
		<td>'.$tch[2][0]['consolidated_pay'].'</td>
		<td>'.$tch[3][0]['consolidated_pay'].'</td>
		<td>'.$tch[4][0]['consolidated_pay'].'</td>
		<td>'.$tch[5][0]['consolidated_pay'].'</td>
		<td>'.$tch[6][0]['consolidated_pay'].'</td>
		<td>'.$tch[7][0]['consolidated_pay'].'</td>
		<td>'.$tch[8][0]['consolidated_pay'].'</td>
		<td>'.$tch[9][0]['consolidated_pay'].'</td>
		<td>'. $tch[10][0]['consolidated_pay'].'</td>
		<td>'.$tch[11][0]['consolidated_pay'].'</td>
		<td><b>'.$c_total_conso.'</b></td>
   ...
   $mpdf->WriteHTML('<tr style="outline: thin solid">
		...
		<td>'.$tch[8][0]['basic'].'</td>
		<td>'.$tch[9][0]['basic'].'</td>
		<td>'.$tch[10][0]['basic'].'</td>
		<td>'.$tch[11][0]['basic'].'</td>
		<td><b>'.$c_total_basic.'</b></td>
		<!--<td></td>
		<td></td>-->
  ...
  <tr style="outline: thin solid">
   ...
   <tr style="outline: thin solid">
		...
		<th scope="col">CONVEYANCE ALLOWANCE</th>
			<td>RS</td>
			<td>'.$tch[0][0]['conv_allow'].'</td>
			<td>'.$tch[1][0]['conv_allow'].'</td>
			<td>'.$tch[2][0]['conv_allow'].'</td>
			<td>'.$tch[3][0]['conv_allow'].'</td>
			<td>'.$tch[4][0]['conv_allow'].'</td>
			<td>'.$tch[5][0]['conv_allow'].'</td>
			<td>'.$tch[6][0]['conv_allow'].'</td>
			<td>'.$tch[7][0]['conv_allow'].'</td>
			<td>'.$tch[8][0]['conv_allow'].'</td>
			<td>'.$tch[9][0]['conv_allow'].'</td>
			<td>'.$tch[10][0]['conv_allow'].'</td>
			<td>'.$tch[11][0]['conv_allow'].'</td>
			<td><b>'. $c_total_conv.'</b></td>
			<!--<td></td>
			<td></td>-->
        </tr>
		...
		<th scope="col">HILL ALLOWANCE</th>
			<td>RS</td>
			<td>'.$tch[0][0]['hill_allowance'].'</td>
			<td>'.$tch[1][0]['hill_allowance'].'</td>
			<td>'.$tch[2][0]['hill_allowance'].'</td>
			<td>'.$tch[3][0]['hill_allowance'].'</td>
			<td>'.$tch[4][0]['hill_allowance'].'</td>
			<td>'.$tch[5][0]['hill_allowance'].'</td>
			<td>'.$tch[6][0]['hill_allowance'].'</td>
			<td>'.$tch[7][0]['hill_allowance'].'</td>
			<td>'.$tch[8][0]['hill_allowance'].'</td>
			<td>'.$tch[9][0]['hill_allowance'].'</td>
			<td>'.$tch[10][0]['hill_allowance'].'</td>
			<td>'.$tch[11][0]['hill_allowance'].'</td>
			<td><b>'. $c_total_hill.'</b></td>
			<!--<td></td>
			<td></td>-->
        </tr>
		<tr style="outline: thin solid">
		<th scope="col">SPECIAL ALLOWANCE</th>
			<td>RS</td>
			<td>'.$tch[0][0]['allowance'].'</td>
			<td>'.$tch[1][0]['allowance'].'</td>
			<td>'.$tch[2][0]['allowance'].'</td>
			<td>'.$tch[3][0]['allowance'].'</td>
			<td>'.$tch[4][0]['allowance'].'</td>
			<td>'.$tch[5][0]['allowance'].'</td>
			<td>'.$tch[6][0]['allowance'].'</td>
			<td>'.$tch[7][0]['allowance'].'</td>
			<td>'.$tch[8][0]['allowance'].'</td>
			<td>'.$tch[9][0]['allowance'].'</td>
			<td>'.$tch[10][0]['allowance'].'</td>
			<td>'.$tch[11][0]['allowance'].'</td>
			<td><b>'.$c_total_special.'</b></td>
			<!--<td></td>
			<td></td>-->
        </tr>',2);
 ...
 $mpdf->WriteHTML('<tr style="outline: thin solid">
		<th scope="col">GROSS</th>
			<td>RS</td>
			<td>'.$tch[0][0]['gross_salary'].'</td>
			<td>'.$tch[1][0]['gross_salary'].'</td>
			<td>'.$tch[2][0]['gross_salary'].'</td>
			<td>'.$tch[3][0]['gross_salary'].'</td>
			<td>'.$tch[4][0]['gross_salary'].'</td>
			<td>'.$tch[5][0]['gross_salary'].'</td>
			<td>'.$tch[6][0]['gross_salary'].'</td>
			<td>'.$tch[7][0]['gross_salary'].'</td>
			<td>'.$tch[8][0]['gross_salary'].'</td>
			<td>'.$tch[9][0]['gross_salary'].'</td>
			<td>'.$tch[10][0]['gross_salary'].'</td>
			<td>'.$tch[11][0]['gross_salary'].'</td>
			<td><b>'.$c_total_gross.'</b></td>
			<!--<td></td>
			<td></td>-->
        </tr>
 ...
 <th scope="col">IT</th>
			...
			<td>'.$tch[8][0]['i_tax'].'</td>
			<td>'.$tch[9][0]['i_tax'].'</td>
			<td>'.$tch[10][0]['i_tax'].'</td>
			<td>'.$tch[11][0]['i_tax'].'</td>
			<td><b>'.$c_total_itax.'</b></td>
			<!--<td></td>
			<td></td>-->
        </tr>
 ...
 <th scope="col">PT</th>
			...
			<td>'.$tch[8][0]['p_tax'].'</td>
			<td>'.$tch[9][0]['p_tax'].'</td>
			<td>'.$tch[10][0]['p_tax'].'</td>
			<td>'.$tch[11][0]['p_tax'].'</td>
			<td><b>'.$c_total_ptax.'</b></td>
			<!--<td></td>
			<td></td>-->
        </tr>
 ...
 <th scope="col">OVERDRAWN</th>
			<td>RS</td>
			<td>'.$tch[0][0]['overdrawn'].'</td>
			<td>'.$tch[1][0]['overdrawn'].'</td>
			<td>'.$tch[2][0]['overdrawn'].'</td>
			<td>'.$tch[3][0]['overdrawn'].'</td>
			<td>'.$tch[4][0]['overdrawn'].'</td>
			<td>'.$tch[5][0]['overdrawn'].'</td>
			<td>'.$tch[6][0]['overdrawn'].'</td>
			<td>'.$tch[7][0]['overdrawn'].'</td>
			<td>'.$tch[8][0]['overdrawn'].'</td>
			<td>'.$tch[9][0]['overdrawn'].'</td>
			<td>'.$tch[10][0]['overdrawn'].'</td>
			<td>'.$tch[11][0]['overdrawn'].'</td>
			<td><b>'.$c_total_over.'</b></td>
			<!--<td></td>
			<td></td>-->
        </tr>
 ...
 <th scope="col">FESTIVAL</th>
			<td>RS</td>
			<td>'.$tch[0][0]['festival_loan'].'</td>
			<td>'.$tch[1][0]['festival_loan'].'</td>
			<td>'.$tch[2][0]['festival_loan'].'</td>
			<td>'.$tch[3][0]['festival_loan'].'</td>
			<td>'.$tch[4][0]['festival_loan'].'</td>
			<td>'.$tch[5][0]['festival_loan'].'</td>
			<td>'.$tch[6][0]['festival_loan'].'</td>
			<td>'.$tch[7][0]['festival_loan'].'</td>
			<td>'.$tch[8][0]['festival_loan'].'</td>
			<td>'.$tch[9][0]['festival_loan'].'</td>
			<td>'.$tch[10][0]['festival_loan'].'</td>
			<td>'.$tch[11][0]['festival_loan'].'</td>
			<td><b>'.$c_total_festival.'</b></td>
			<!--<td></td>
			<td></td>-->
        </tr>
 ...
 <tr style="outline: thin solid">
	 ...
	 <td>RS</td>
      <td>'.$tch_arrear[0][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[1][0]['gross_salary'].'</td>
     <td>'. $tch_arrear[2][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[3][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[4][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[5][0]['gross_salary'].'</td>
     <td>'. $tch_arrear[6][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[7][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[8][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[9][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[10][0]['gross_salary'].'</td>
     <td>'.$tch_arrear[11][0]['gross_salary'].'</td>
     <td><b>'.$c_total_arrear.'</b></td>
  </tr>
  
  <tr style="outline: thin solid">
     <th scope="col">BONUS</th>
	 <td>RS</td>
      <td>'.$tch_bonus[0][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[1][0]['bonus_amount'].'</td>
     <td>'. $tch_bonus[2][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[3][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[4][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[5][0]['bonus_amount'].'</td>
     <td>'. $tch_bonus[6][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[7][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[8][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[9][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[10][0]['bonus_amount'].'</td>
     <td>'.$tch_bonus[11][0]['bonus_amount'].'</td>
     <td><b>'.$c_total_bonus.'</b></td>
  </tr>
  
 
 <!-- <tr>
     <th scope="col"><b>TOTAL:</b>
     <td>RS</td>
      <td><b><?php //echo $t_total_march;?></b></td>
      <td><b><?php //echo $t_total_april;?></b></td>
      <td><b><?php //echo $t_total_may;?></b></td>
      <td><b><?php //echo $t_total_june;?></b></td>
      <td><b><?php //echo $t_total_july;?></b></td>
      <td><b><?php //echo $t_total_aug;?></b></td>
      <td><b><?php //echo $t_total_sep;?></b></td>
      <td><b><?php //echo $t_total_oct;?></b></td>
      <td><b><?php //echo $t_total_nov;?></b></td>
      <td><b><?php //echo $t_total_dec;?></b></td>
      <td><b><?php //echo $t_total_janu;?></b></td>
      <td><b><?php //echo $t_total_feb;?></b></td>
     <td><b><?php //echo $t_total_com;?></b></td>
       <!-- <td></td>-->
...
<tr></tr>
<tr></tr>
<th colspan="9" style="text-align:right; border:none;"><br /><br /><br />Generated On:'.$date.'</th>
</tr>
</table>',2);
$mpdf->Output($emp_name[0]['emp_first_name'].' '.$emp_name[0]['emp_second_name'].' '.$emp_name[0]['emp_last_name'].'.pdf','D');
?>
