...
$arr_emp_name=$db->fetch_table("SELECT 
										...
										WHERE emp.ps_id_fk = '".$_SESSION['location']['ps_id']."' AND emp.emp_status in('1','9')
										ORDER BY 
										emp_first_name
										) as main
										LEFT JOIN
...
<script>
	...
	function add_row(id)
	{
		...
		$("#tbl1").each(function(){
			...
			if('tr'+id==$('#tbl1 tr:last').attr('id'))
			{
				...
				tds+='<td><input type="hidden" name="basic[]" id="basic'+r+'" value=""/><input maxlength="5"  type="text" name="pay_in_band[]" id="pay_in_band'+r+'" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" /></td>';
				tds+='<td><input maxlength="5"  type="text" name="grade_pay[]" id="grade_pay'+r+'" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5"/></td>';
				...
				tds+='<td><input maxlength="5"  type="text" name="interim_relief[]" id="interim_relief'+r+'" value="0" size="5" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				...
				tds+='<td><input maxlength="5" type="text"  name="gpf[]" id="gpf'+r+'" value="0" size="4" onkeypress="return key_restrict(event);" autocomplete="off" /></td>';
					
				tds+=' <td><input maxlength="5" type="text"  name="p_tax[]" id="p_tax'+r+'"  value="0" size="5" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input maxlength="5" type="text"   name="i_tax[]" id="i_tax'+r+'" value="0" size="5" onkeypress="return key_restrict(event);" autocomplete="off" /></td>';
	...
	function cons_pay_validation(k)
	{
		...
		$.post('<?= $config['base_url'] ?>page/all_moduls/arrear/get_employee_desig.php?emp_id='+emp_id, function(data){
			...
			if(data.trim()=='9012' || data.trim()=='9013' || data.trim()=='9014' || data.trim()=='9015' || data.trim()=='9016' || data.trim()=='9017')
			{
...
<form id="form_arrear" method="post" action="ajax_arrear_submit.php" enctype="multipart/form-data" > 
	...
	<input type="hidden" name="ropa_status" id="ropa_status" value="<?php echo '0'; ?>" />
    <div class="school">
		<div class="table-responsive">
            <table width="140%" id="tbl1">
                <tr id="top_header">
                    ...
                    <th colspan="3" align="center"><strong>DEDUCTION</strong></th>
                    <th>&nbsp;</th>
                    <th>&nbsp;</th>
                </tr>
                ...
                <tr style="background-color: rgb(221, 247, 255);" id="tr2">
                    ...
                    <td> 
                        <input maxlength="5" type="text" name="consolidated_pay[]" id="consolidated_pay2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" />
                    </td>
                    <td>
                        <input type="hidden" name="sec_tok[]" id="sec_tok2" value="<?=$enc_token?>" />
                        <input type="hidden" name="basic[]" id="basic2" value="<?php echo $basic; ?>" />
                        <input maxlength="5" type="text" name="pay_in_band[]" id="pay_in_band2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" />
                    </td>
                    <td>
                    ...
                    <td>
                        <input maxlength="5"  type="text" name="da[]" id="da2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5"  />
                    </td>
                    <td>
                        <input maxlength="5" type="text" name="hra[]" id="hra2"  value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" />
                    </td>
                    <td>
                        <input maxlength="5"  type="text" name="ma[]" id="ma2"  value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" />
                    </td>
                    <td>
                        <input maxlength="5"  type="text" name="conv_allow[]" id="conv_allow2"  value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" />
                    </td>
                    <td>
                        <input maxlength="5"  type="text" name="hill_allow[]" id="hill_allow2"  value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" />
                    </td>
                    <td>
                        <input maxlength="5" type="text" name="interim_relief[]" id="interim_relief2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5"  />
                    </td>
                    <td>
                        <input  maxlength="5" type="text"  name="gross[]" id="gross2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" />
                    </td>
                    
                    <td>
                        <input maxlength="5"  type="text" name="gpf[]" id="gpf2"  value="0"size="4" onkeypress="return key_restrict(event);" autocomplete="off" />
                    </td> 
                   <!-- <td>
                        <input maxlength="5"  type="text" name="pf_loan[]" id="pf_loan2" value="0" size="5"  onkeypress="return key_restrict(event);" autocomplete="off"/>
                    </td>-->
                    <td>
