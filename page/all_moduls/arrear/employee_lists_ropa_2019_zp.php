...
$total_deduction=$item['gpf_sum']+$item['pfl_sum']+$item['ptax_sum']+$item['itax_sum']+$item['ov_sum'];
...
<tr>
   ...
   <?php }
	...
	<td><input type="hidden" id="tot_ded<?=$item['emp_id_fk']?>" value="<?php echo $item['gpf_sum']."&".$item['pfl_sum']."&".$item['ptax_sum']."&".$item['itax_sum']."&".$item['ov_sum'] ?>" /><?php echo $total_deduction; ?></td>
