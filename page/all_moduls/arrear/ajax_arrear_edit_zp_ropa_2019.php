...
$arr_emp_name=$db->fetch_table("SELECT 
										...
										AND (emp.ropa_status = '1' OR emp.emp_cosolidated_pay!='0')
										ORDER BY 
										emp_first_name
										) as main
										LEFT JOIN
...
if($emp_type == '367'){ $get_column=$db->fetch_table("SELECT * from ropa_2019"); }
else if($emp_type == '366'){ $get_column=$db->fetch_table("SELECT * from ropa_2019_ll"); }
	...
	function add_row(id)
	{
		...
		$("#tbl1").each(function(){
			...
			if('tr'+id==$('#tbl1 tr:last').attr('id'))
			{
				...
				tds+='<td><input maxlength="6"  type="text" name="allow[]" id="allow'+r+'"  value="0" size="6" onkeypress="return key_restrict(event);" readonly /></td>';
				...
				tds+='<td><input maxlength="6"  type="text" name="interim_relief[]" id="interim_relief'+r+'" value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off" readonly /></td>';
...
/***************************************** END **************************************/	
	...
	function cons_pay_validation(k)
	{
		...
		$.post('<?= $config['base_url'] ?>page/all_moduls/arrear/get_employee_desig.php?emp_id='+emp_id, function(data){
			//alert(data);
			if(data.trim()=='9012' || data.trim()=='9013' || data.trim()=='9014' || data.trim()=='9015' || data.trim()=='9016' || data.trim()=='9017' || data.trim()=='1'|| data.trim()=='1124' || data.trim()=='1120' || data.trim()=='1125')
			{
				...
				$('#allow'+row_id).prop('readonly',true);
				$('#allow'+row_id).css('background-color','#EEE');
				$('#allow'+row_id).val(0);
			...
			else if(data.trim()=='31' || data.trim()=='32'){
				...
				$('#allow'+row_id).prop('readonly',false);
				$('#allow'+row_id).css('background-color','#FFF');
    ...
    <div class="school">
		<div class="table-responsive">
            <table width="140%" id="tbl1">
                <tr id="top_header">
                    <th colspan="4">&nbsp;</th>
                    <th colspan="10" align="center"><strong>PAY & ALLOWANCE</strong></th>
               ...
               <th>ADMINISTRATIVE<br>ALLOWANCE</th> 
                ...
                <tr style="background-color: rgb(221, 247, 255);" id="tr2">
                    ...
                    <!--<td>
                        <input maxlength="5"  type="text" name="grade_pay[]" id="grade_pay2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" />
                    </td>-->
                    <td>
					...
					<td>
                        <input maxlength="6"  type="text" name="allow[]" id="allow2"  value="0" onkeypress="return key_restrict(event);" size="6" readonly />
                    </td>
                    ...
                    <td>
                        <input maxlength="6" type="text" name="interim_relief[]" id="interim_relief2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6"  disabled />
                    </td>
                    <td>
