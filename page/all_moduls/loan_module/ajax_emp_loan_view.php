...
<form class="form-horizontal" id="loginForm" method="post" action="emp_loan_module_submit.php" onsubmit="return confirm_send();">
...
$(document).ready(function(){
  ...
  <div class="form-group">
    ...
    <?php
	$chk_status = $db->fetch_table("SELECT loan_id_pk FROM prd_loan_deduction WHERE emp_id_fk = '".$emp_id_pk."' AND status in(1) AND approval_status in(1)");
	if(count($chk_status)>0)
	{
	?>
    <input type="submit" class="btn btn-info" name="loan_deductions_submit" value="SEND TO ACCOUNTANT" />
    <?php
	}
	?>
    </div>
...
<div class="modal fade bs-example-modal-sm" id="send_ddo" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
     <div class="modal-header">
      ...
      <p class="alert alert-warning"><strong><i class="fa fa-exclamation-triangle"></i> Do You Want To Send This Employee Loan Details For Approval?</strong></p>
      </div>
      <div class="modal-footer">
      <div class="btn-group">
        
<a class="btn btn-success" id="ir_conform" href="javascript:void(0);" onclick="return final_confirm_send();">YES</a>
