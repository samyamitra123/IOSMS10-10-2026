...
if($security==TRUE )
{
	if($stake_level=="BDO")
	{
	$_SESSION["msg"]='<div class="alert alert-success" style="text-align:center;"><strong>Employee Pay Fixation Approved Successfully...</strong></div>';
...
else 
{
	if($stake_level=="BDO")
	{
		...
		$_SESSION["msg"]='<div class="alert alert-danger" style="text-align:center;"><strong>Employee Pay Fixation Failed. Please try again... </strong></div>';
