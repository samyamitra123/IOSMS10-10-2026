...
{ 
	$find_bill = $db->fetch_table("
									...
									AND salary_monthyear ='".$yemo."' AND status='1' AND requisition_type='".$requisition_type."' AND ropa_status='1' ORDER BY oid DESC
...
<div id="form_show" style="margin-left: 14%;"> 
<?
