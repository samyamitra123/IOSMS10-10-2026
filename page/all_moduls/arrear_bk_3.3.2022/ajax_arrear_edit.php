...
<script>
	...
	function add_row(id)
	{
		...
		if('tr'+id==$('#tbl1 tr:last').attr('id'))
		{
			...
			tds+='<td><input maxlength="5"  type="text" name="grade_pay[]" id="grade_pay'+r+'" value="0" size="5" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
        ...
        <div class="table-responsive">
            <table width="140%" id="tbl1">
                ...
                <tr style="background-color: rgb(221, 247, 255);" id="tr2">
                    ...
                    <td>
                    	<input maxlength="5" type="text" name="interim_relief[]" id="interim_relief2" onkeypress="return key_restrict(event);" value="0" size="5" autocomplete="off" />
					</td>
                    <td>
