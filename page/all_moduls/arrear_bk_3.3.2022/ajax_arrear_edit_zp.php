...
$emp_type1=$_GET['emp_type'];
$emp_type=$cryp->decode($_GET['emp_type'],4);
$time_token=time();
...
$arr_emp_name=$db->fetch_table("SELECT 
										...
										WHERE emp.zp_id_fk = '".$_SESSION['location']['district_id']."' AND emp.emp_status in('1','9') AND emp.zp_emp_type='".$emp_type."'
										ORDER BY 
										emp_first_name
										) as main
										LEFT JOIN
...
<script>
	...
	function add_row(id)
	{
		...
		$("#tbl1").each(function(){
			...
			if('tr'+id==$('#tbl1 tr:last').attr('id'))
			{
				...
				tds+='<td><SELECT class="form-control upper_case emp_class" name="emp_name[]" id="emp_name'+r+'" onChange="show_datepicker(this.id,2),show_arrear('+r+',0);cons_pay_validation(this.id);"><option value="">--Please Select--</option><?php foreach($arr_emp_name as $key){$emp_full_name=$key['emp_first_name']." ".$key['emp_second_name']." ".$key['emp_last_name'];?> <option value="<?=$key['emp_id_pk'] ?>" ><?=$emp_full_name; ?></option><?php } ?></SELECT></td>';
				...
				tds+='<td><input maxlength="6"  type="text" name="consolidated_pay[]" id="consolidated_pay'+r+'" value="0"  size="6" onChange="show_arrear('+r+',0);" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input type="hidden" name="basic[]" id="basic'+r+'" value=""/><input maxlength="6"  type="text" name="pay_in_band[]" id="pay_in_band'+r+'" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" /></td>';
				tds+='<td><input maxlength="6"  type="text" name="grade_pay[]" id="grade_pay'+r+'" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6"/></td>';
				tds+='<td><input maxlength="6"  type="text" name="da[]" id="da'+r+'" value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input maxlength="6"  type="text" name="hra[]" id="hra'+r+'"  value="0"size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input maxlength="6"  type="text" name="ma[]" id="ma'+r+'"  value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input maxlength="6"  type="text" name="conv_allow[]" id="conv_allow'+r+'"  value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input maxlength="6"  type="text" name="hill_allow[]" id="hill_allow'+r+'" value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input maxlength="6"  type="text" name="interim_relief[]" id="interim_relief'+r+'" value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input  maxlength="6" type="text"  name="gross[]" id="gross'+r+'" value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input maxlength="6" type="text"  name="gpf[]" id="gpf'+r+'" value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off" /></td>';
				tds+=' <td><input maxlength="6" type="text"  name="p_tax[]" id="p_tax'+r+'"  value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
				tds+='<td><input maxlength="6" type="text"   name="i_tax[]" id="i_tax'+r+'" value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off" /></td>';
				...
				tds+='<td><input maxlength="6" type="text"  name="net[]" id="net'+r+'" value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off"/></td>';
	...
	//function calculate_net(k,l)
	//{
	//	
	//	if(l==0)
	//	{
	//		var gross=$('#gross'+k).val();
	//	
	//		var gpf=$('#gpf'+k).val();
	//		var pf_loan=$('#pf_loan'+k).val();
	//		var ptax=$('#p_tax'+k).val();
	//		var itax=$('#i_tax'+k).val();
	//		var ovd=$('#overdrawn'+k).val();
	//		
	//		var h=k;
	//	}
	//	else 
	...
	//		if(l==3)
	//		{
	//			var row_id=k.substr(3,length);
	//		}
	//		else if(l==7)
	//		{
	//			var row_id=k.substr(7,length);
	//		}
	//		else if(l==5)
	//		{
	//			var row_id=k.substr(5,length);
	//		}
	//		else if(l==9)
	//		{
	//			var row_id=k.substr(9,length);
	//		}
	//				
	//		var gross=$('#gross'+row_id).val();
	//
	//		
	//		var gpf=$('#gpf'+row_id).val();
	//		var pf_loan=$('#pf_loan'+row_id).val();
	//		var ptax=$('#p_tax'+row_id).val();
	//		var itax=$('#i_tax'+row_id).val();
	//		var ovd=$('#overdrawn'+row_id).val();
	//	
	//		var h=row_id;
	//	}
	//	
	...
	function cons_pay_validation(k)
	{
		...
		$.post('<?= $config['base_url'] ?>page/all_moduls/arrear/get_employee_desig.php?emp_id='+emp_id, function(data){
			...
			if(data.trim()=='9012' || data.trim()=='9013' || data.trim()=='9014' || data.trim()=='9015' || data.trim()=='9016' || data.trim()=='9017' || data.trim()=='1')
			{
				$('#pay_in_band'+row_id).prop('readonly',true);
				$('#pay_in_band'+row_id).css('background-color','#EEE');
				$('#grade_pay'+row_id).prop('readonly',true);
			...
			else
			{
				...
				$('#grade_pay'+row_id).prop('readonly',false);
	...
	<?php /*?><?php if($tch[0]['emp_desig']=='1120'){?>
...
<form id="form_arrear" method="post" action="ajax_arrear_submit.php" enctype="multipart/form-data" >
		...
		<div class="table-responsive">
            <table width="140%" id="tbl1">
                ...
                <tr style="background-color: rgb(221, 247, 255);" id="tr2">
                    ...
                    <td> 
                        <input maxlength="6" type="text" name="consolidated_pay[]" id="consolidated_pay2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" />
                    </td>
                    <td>
                        <input type="hidden" name="sec_tok[]" id="sec_tok2" value="<?=$enc_token?>" />
                        <input type="hidden" name="basic[]" id="basic2" value="<?php echo $basic; ?>" />
                        <input maxlength="6" type="text" name="pay_in_band[]" id="pay_in_band2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" />
                    </td>
                    <td>
                        <input maxlength="6"  type="text" name="grade_pay[]" id="grade_pay2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" />
                    </td>
                    <td>
                        <input maxlength="6"  type="text" name="da[]" id="da2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6"  />
                    </td>
                    <td>
                        <input maxlength="6" type="text" name="hra[]" id="hra2"  value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" />
                    </td>
                    <td>
                        <input maxlength="6"  type="text" name="ma[]" id="ma2"  value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" />
                    </td>
                    <td>
                        <input maxlength="6"  type="text" name="conv_allow[]" id="conv_allow2"  value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" />
                    </td>
                    <td>
                        <input maxlength="6"  type="text" name="hill_allow[]" id="hill_allow2"  value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" />
                    </td>
                    <td>
                        <input maxlength="6" type="text" name="interim_relief[]" id="interim_relief2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6"  />
                    </td>
                    <td>
                        <input  maxlength="6" type="text"  name="gross[]" id="gross2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="6" />
                    </td>
                    
                    <td>
                        <input maxlength="6"  type="text" name="gpf[]" id="gpf2"  value="0"size="6" onkeypress="return key_restrict(event);" autocomplete="off" />
						<!--<input maxlength="5"  type="hidden" name="pf_loan[]" id="pf_loan2" value="0" size="5"  onkeypress="return key_restrict(event);" autocomplete="off"/>-->
                    </td> 
                    <td>
                        <input maxlength="6"  type="text" name="p_tax[]" id="p_tax2" autocomplete="off"  value="0" size="6" onkeypress="return key_restrict(event);" autocomplete="off" />
                    </td>
                    <td>
                        <input maxlength="6"  type="text" name="i_tax[]" id="i_tax2" autocomplete="off" value="0" size="6"  onkeypress="return key_restrict(event);" autocomplete="off" />
                    </td>
					<td>
                        <input maxlength="4"  type="text" name="gsli[]" id="gsli2" autocomplete="off" value="0" size="4"  onkeypress="return key_restrict(event);" autocomplete="off" />
                    </td>
                     <!--<td>
                    ...
                    <td>
                        <input maxlength="6" type="text"  name="net[]" id="net2" value="0"size="6" onkeypress="return key_restrict(event);" autocomplete="off"/>
                    </td>
                    <td> 
    ...
    <!--<center><input type="button" class="btn btn-info" id="submit_arrear" value="Submit" onClick='check();'  ></center>-->
		...
		$('#form_arrear').submit(function(event) 
		{
			...
			$('#tbl1 tr').each(function() 
			{
				if($(this).attr('id')!='top_header' && $(this).attr('id')!='base_header')
				{
					...
					var consolidated_pay = $('#consolidated_pay'+new_id).val();
					var pay_in_band = $('#pay_in_band'+new_id).val();
					var grade_pay = $('#grade_pay'+new_id).val();
					var da = $('#da'+new_id).val();
					var hra = $('#hra'+new_id).val();
					var ma = $('#ma'+new_id).val();
					var conv_allow = $('#conv_allow'+new_id).val();
					var hill_allow = $('#hill_allow'+new_id).val();
					var interim_relief = $('#interim_relief'+new_id).val();
					var gpf = $('#gpf'+new_id).val();
					var p_tax = $('#p_tax'+new_id).val();
					var i_tax = $('#i_tax'+new_id).val();
					var gsli = $('#gsli'+new_id).val();
					var gross = $('#gross'+new_id).val();
					var net = $('#net'+new_id).val();
					
					if(consolidated_pay.indexOf('0') == 0 && consolidated_pay.length >1){
					 alert('Please enter proper CONSOLIDATED PAY');
					  $('#consolidated_pay'+new_id).focus();
					  event.preventDefault();
					  return false();
				   }
				   else if(pay_in_band.indexOf('0') == 0 && pay_in_band.length >1){
					 alert('Please enter proper PAY BAND AMOUNT');
					  $('#pay_in_band'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(grade_pay.indexOf('0') == 0 && grade_pay.length >1){
					 alert('Please enter proper GRADE PAY');
					  $('#grade_pay'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(da.indexOf('0') == 0 && da.length >1){
					 alert('Please enter proper DA');
					  $('#da'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(hra.indexOf('0') == 0 && hra.length >1){
					 alert('Please enter proper HRA');
					  $('#hra'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(ma.indexOf('0') == 0 && ma.length >1){
					 alert('Please enter proper MA');
					  $('#ma'+new_id).focus();
					 event.preventDefault();
						return false;
				   }
				   else if(conv_allow.indexOf('0') == 0 && conv_allow.length >1){
					 alert('Please enter proper CONV AMOUNT');
					  $('#conv_allow'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(hill_allow.indexOf('0') == 0 && hill_allow.length >1){
					 alert('Please enter proper HILL AMOUNT');
					  $('#hill_allow'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(interim_relief.indexOf('0') == 0 && interim_relief.length >1){
					 alert('Please enter proper IR');
					  $('#interim_relief'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(gpf.indexOf('0') == 0 && gpf.length >1){
					 alert('Please enter proper GPF');
					  $('#gpf'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(p_tax.indexOf('0') == 0 && p_tax.length >1){
					 alert('Please enter proper P TAX');
					  $('#p_tax'+new_id).focus();
					  event.preventDefault();
						return false;
				   }
				   else if(i_tax.indexOf('0') == 0 && i_tax.length >1){
					 alert('Please enter proper I TAX');
					  $('#i_tax'+new_id).focus();
					 event.preventDefault();
						return false;
				   }
				   else if(gross.indexOf('0') == 0 && gross.length >1){
					 alert('Please enter proper GROSS AMOUNT');
					  $('#gross'+new_id).focus();
					 event.preventDefault();
						return false;
				   }
				   else if(net.indexOf('0') == 0 && net.length >1){
					 alert('Please enter proper NET AMOUNT');
					  $('#net'+new_id).focus();
					 event.preventDefault();
						return false;
				   }
