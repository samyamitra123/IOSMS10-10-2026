...
$arr_emp_name=$db->fetch_table("SELECT 
										...
										WHERE emp.ps_id_fk = '".$_SESSION['location']['ps_id']."' AND emp.emp_status in('1','9') AND (emp.ropa_status = '1' OR emp.emp_cosolidated_pay!='0')
										ORDER BY 
										emp_first_name
										) as main
										LEFT JOIN
		...
		<div class="table-responsive">
            <table width="140%" id="tbl1">
                ...
                <tr style="background-color: rgb(221, 247, 255);" id="tr2">
                    ...
                    <td>
                        <input maxlength="5" type="text" name="interim_relief[]" id="interim_relief2" value="0" onkeypress="return key_restrict(event);" autocomplete="off" size="5" disabled />
                    </td>
                    <td>
