...
?>
<form class="form-horizontal" id="gp_form" name="gp_form" action="" method="post" style="margin-left: 15%;">
...
<div class="row mb-3">
    ...
    <label for="inputPassword3" class="col-sm-3 col-form-label">Bill For The Month.<span class="star_color">*</span></label>
    <div class="col-sm-3">
...
<div class="row mb-3">
    <div class="col-sm-2"></div>
    <label for="inputPassword3" class="col-sm-3 col-form-label">Bill For The Year.<span class="star_color">*</span></label>
    <div class="col-sm-3">
...
<div class="row mb-3">
    <div class="col-sm-2"></div>
    <label for="inputPassword3" class="col-sm-3 col-form-label">Bill Serial Number<span class="star_color">*</span></label>
    <div class="col-sm-3">
...
<div class="row mb-3">
    <div class="col-sm-2"></div>
    <label for="inputPassword3" class="col-sm-3 col-form-label"> Bill No.<span class="star_color">*</span></label>
    <div class="col-sm-3">
      <input type="text" readonly="readonly" style="background-color:#d3d3d3;" class="form-control upper_case" name="bill" id="bill" placeholder=" Salary Bill Number" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz0123456789/');" value=""  >
    </div>
    <div class="col-sm-3"></div>
    </div>
    ...
    <div class="row mb-3" style="margin-left: 35%; margin-top: 5%; ">
