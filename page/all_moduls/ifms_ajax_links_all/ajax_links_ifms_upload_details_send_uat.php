...
/*echo $status='<span style="color:RED;font-weight:bold">*** ENTIRE WBIFMS PORTAL INCLUDING GRIPS PROTAL SHALL NOT BE AVAILABE FROM 06.06.2020 (12.00 AM) TO 08.06.2020 (12.00 PM) FOR URGENT MAINTENANCE WORK OF WBIFMS SERVER. INCONVENIENCE IS REGRETTED.</span>'; die;*/
//---------------------------- LIBRARY INCLUDE ----------------------------
...
//**************************************************************
	...
	function value_pass(encode_requsition, drn_number, emp_type,monthyear,bill_serial_no,ropa_status_new)
	{
		...
		if(user1=='FC&CAO')
		{
			...
			$.post('<?= $config['base_url'] ?>page/api/ifms/zp/index_uat.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no+ '&ropa_status_new='+ropa_status_new, function (data) {
			//alert(data);
			//return false;
		...
		
		{
			...
			$.post('<?= $config['base_url'] ?>page/api/ifms/ps/index_uat.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no+ '&ropa_status_new='+ropa_status_new, function (data) {
			//alert(data);
			//return false;
			$('#page-load').delay(100).fadeOut();
			if (data.trim() == 'Success')
		...
		
		{
			...
			$.post('<?= $config['base_url'] ?>page/api/ifms/gp/index_uat.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear + '&bill_serial_no=' + bill_serial_no+ '&ropa_status_new='+ropa_status_new, function (data) {
			//alert(data);
			//return false;
			$('#page-load').delay(100).fadeOut();
			if (data.trim() == 'Success')
	...
	function value_pass_sftp(encode_requsition, drn_number, emp_type,monthyear,bill_serial_no,ropa_status_new)
	{
		...
		{
		$.post('<?= $config['base_url'] ?>page/api/ifms/zp/sftp_index_uat.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear+ '&bill_serial_no=' + bill_serial_no + '&ropa_status_new='+ropa_status_new, function (data) {
			//alert(data);
			$("#status1").html(data);
		...
		else if(user1=='EO')
		{
			...
			$.post('<?= $config['base_url'] ?>page/api/ifms/ps/sftp_index_uat.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear+ '&bill_serial_no=' + bill_serial_no + '&ropa_status_new='+ropa_status_new, function (data) {
			//alert(data);
			$("#status1").html(data);
			$('#page-load').delay(500).fadeOut();
			if (data.trim() == '2')
		...
		{
		$.post('<?= $config['base_url'] ?>page/api/ifms/gp/sftp_index_uat.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear+ '&bill_serial_no=' + bill_serial_no + '&ropa_status_new='+ropa_status_new, function (data) {
			//alert(data);
			$("#status1").html(data);
			$('#page-load').delay(500).fadeOut();
			if (data.trim() == '2')
	...
	function value_pass_view(encode_requsition, drn_number,monthyear)
	{
		...
		{
		$.post('<?= $config['base_url'] ?>page/api/ifms/zp/bill_status_check_uat.php?bill_type=' + requsition + '&drn_no=' + drn_no+'&monthyear='+monthyear, function (data) {
			$('#page-load').delay(500).fadeOut();
			if (data)
			{
		...
		{
			$.post('<?= $config['base_url'] ?>page/api/ifms/ps/bill_status_check_uat.php?bill_type='+requsition+'&drn_no='+drn_no+'&monthyear='+monthyear,function(data){
			$('#page-load').delay(500).fadeOut();
			if (data)
			{
		...
		{
		$.post('<?= $config['base_url'] ?>page/api/ifms/gp/bill_status_check_uat.php?bill_type=' + requsition + '&drn_no=' + drn_no+'&monthyear='+monthyear, function (data) {
			$('#page-load').delay(500).fadeOut();
			if (data)
			{
	...
	function benf_status_check(sftp_benf_file_name,drn_number,monthyear)
	{
		...
		$.post('<?= $config['base_url'] ?>page/api/ifms/sftp_cron/prd_ifms_cron_job_uat.php?user='+user+'&sftp_benf_file_name='+sftp_benf_file_name+'&drn_number='+drn_number+'&monthyear='+monthyear, function (data) {
			alert(data);
			//$('#page-load').delay(500).fadeOut();
			//$('#status1').html(data); 
			//location.reload();
