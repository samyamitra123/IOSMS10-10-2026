...
{
	$mpdf->WriteHTML('<p style="color: #8a6d3b;font-weight: bold;font-family: "Arial Narrow";font-style: italic;text-align:center">STATUS : Waiting For Approval From Secretary</p>');		
}
...
{
	$mpdf->WriteHTML('<p style="color: #a94442;font-weight: bold;font-family: "Arial Narrow";font-style: italic;text-align:center">STATUS : Unlock Request Sent To Secretary</p>');		
}
