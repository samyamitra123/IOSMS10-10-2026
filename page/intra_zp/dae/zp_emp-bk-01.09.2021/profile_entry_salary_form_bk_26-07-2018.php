        ...
        <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
            <div class="col-sm-12">
                ...
                <form class="form-horizontal" id="loginForm" method="post" action="profile_entry_salary_insert.php" onsubmit="return valid_code();">
					...
					{ ?>
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">GPF Account No <span class="star_color">*</span></label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="gpf_account" name="gpf_account" placeholder="GPF ACCOUNT NUMBER" autocomplete="off" value="<?=$emp_gpf_acc_no ?>" onKeyPress="return keyRestrict(event,'0123456789');">
