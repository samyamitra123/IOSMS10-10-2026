...
else
{
	...
	$pan_check=$db->fetch_table("select emp_id_pk,emp_pan_no from prd_employee_master where emp_pan_no !=
									(select emp_pan_no from prd_employee_master where emp_id_pk='$emp_id_pk' and 
									zp_id_fk='".$_SESSION['location']['district_id']."')");
