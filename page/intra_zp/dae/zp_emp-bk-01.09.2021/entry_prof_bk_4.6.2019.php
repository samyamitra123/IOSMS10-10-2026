            ...
            <div class="col-sm-12">
                ...
                <div id="form_show" class="dashcontenr invisible"> 
                    <form class="form-horizontal" name="teacher_info" id="teacher_info" method="post" action="profile_entry_prof_insert.php" onsubmit="return validateCode();">
                        ...
                        <div class="form-group" >
                            <label for="inputPassword3" class="col-sm-3 control-label"> Present Joining Memo no:<span class="star_color">*</span></label>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                            <input type="text" class="form-control" id="p_tch_date" name="p_tch_date"   value="<?php if(count($arr)==0){echo  $present_momo_date="";}else { echo $fun_store->date_frmt($present_momo_date);}?>" placeholder="DD-MM-YY" readonly style="background-color:#FFF;cursor:pointer;" />
                            </div>
                    </div>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-sm-3">
                    <input type="text" class="form-control" id="tch_date" name="tch_date"   value="<?php if(count($arr)==0){echo  $wef_date="";}else { echo  $fun_store->date_frmt($wef_date);}?>" placeholder="DD-MM-YY" readonly style="background-color:#FFF;cursor:pointer;" />
                    </div>
                </div>
