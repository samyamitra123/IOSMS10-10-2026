            ...
            <div class="col-sm-12">
                ...
                <form class="form-horizontal" id="loginForm" method="post" action="profile_entry_personal_update.php" onsubmit="return valid_code();">
                    ...
                    { ?>
						...
						{ ?>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label" id="spouse_medical_tr" >Opted for enrolment in WB Health Scheme / Employee Opted for enrolment in Swasthya Sathi:<span class="star_color">*</span></label>
