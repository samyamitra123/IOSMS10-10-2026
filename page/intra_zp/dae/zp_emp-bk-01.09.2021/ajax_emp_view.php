...
$emp_data=$db->fetch_table("SELECT * FROM prd_employee_master 
							WHERE emp_id_pk='".$cryptoGraph->decode($_REQUEST['id'],4)."' AND zp_id_fk='".$_SESSION['location']['district_id']."'");
...
<div class="downpdf" align="right"><a href="<?= $config['base_url']?>page/intra_zp/dae/zp_emp/pdf_employe_details.php?id=<?php echo $_GET['id'] ?>"><img src="<?= $config['base_url'] ?>themes/default/image/pdf_download.png"/></a></div>
...
<div id="accordion">
    ...
    <div id="attraction">
        <table border="0" width="100%">
            ...
            <tr>
                ...
                <td <?php if($emp_data[0]['zp_emp_type']=='367'){ echo 'colspan="3"'; }?>>
					<?php echo  $fun_store->fun_emp_type($emp_data[0]['zp_emp_type']) ; ?>
                </td>
                <?php if($emp_data[0]['zp_emp_type']=='366' || $emp_data[0]['zp_emp_type']=='366')
				{ ?>
                	<td  class="text_r">Government ID :</td>
                	<td><?php echo $emp_data[0]['emp_govt_id']; ?></td>
				<?php } ?>
            </tr>
            <tr>
            ...
            <tr>
                <td class="text_r">Whether Aadhaar card exist :</td>
                <td><?php  if($emp_data[0]['emp_aadhar_no']==''){ echo 'NO';}else{echo 'YES';}  ?></td>
              <?php if( $emp_data[0]['emp_aadhar_no']!=''){?>
             ...
             <tr>
                ...
                <td><?php echo $emp_data[0]['emp_pan_no'];?></td>
                 <?php if($emp_data[0]['zp_emp_type']=='367')
				{ ?>
    ...
    <div id="attraction">
        <table border="0" width="100%">
            <tr>
                <td  class="text_r" >Notification number of the Appointment :</td>
            ...
            <td  class="text_r">Date of Confirmation in Service Applicable :</td>
                ...
                ?></td>
               <?php if($emp_data[0]['conf_dt_flag']=='1'){?>
 ...
 ?>
			...
			{ ?> 
                <tr>
                    ...
                    <td><?php echo $fun_store->fun_common($emp_data[0]['emp_group'],$code_data); ?></td>
                </tr>
            <?php } ?>
            <tr>
                ...
                <td><?php echo $emp_data[0]['emp_next_increment_amount'];?></td>
            </tr>
    ...
    <div id="attraction">
        <table border="0" width="100%">
            ...
            <?php 
			...
			else
			 {
				...
				<tr>
					...
					<td width="25%"><?php echo $fun_store->fun_payband($emp_data[0]['emp_pay_band']) ; ?></td>
                    <td class="text_r" width="25%">Pay Scale :</td>
					<td width="25%"><?= $fun_store->fun_payscale($emp_data[0]['emp_pay_scale']); ?></td>
				...
				<tr>
					...
					<td width="25%"><?php echo $fun_store->fun_grade_pay($emp_data[0]['emp_grade_pay']);?></td>
            ...
            <tr>
                ...
                <td style="text-transform:uppercase;"><? echo $emp_data[0]['emp_micr_no']=='0'?'':$emp_data[0]['emp_micr_no'];?></td>
            </tr>
            <tr>
			...
			{ ?>
            	<tr>
                	<td class="text_r">GPF Account No :</td>
                	<td><?php echo $emp_data[0]['emp_gpf_acc_no']; ?></td>
                    <td class="text_r"></td>
                	<td></td>
                </tr>
            <?php } ?>
        ...
        <table border="0" width="100%">
			...
			if($emp_data[0]['emp_desig']!='1')
			{
				...
				<tr>
                    ...
                    <?php if($emp_data[0]['zp_emp_type'] == 366 || $emp_data[0]['zp_emp_type'] == 367)
					{ ?>
                    <td class="text_r">Opted for enrolment in WB Health Scheme / Employee Opted for enrolment in Swasthya Sathi:</td>
                    <td><?php echo $fun_store->fun_common($emp_data[0]['spouse_medical_allowance'],$code_data); ?></td>
                    <?php } else { ?>
                    <td class="text_r"></td>
                    <td></td>
                    <?php }?>    
				...
				<tr>
                    ...
                    <?php if($emp_data[0]['emp_spouse_res']=='251'){ ?>
            ...
            { ?>
                <tr>
                    ...
                    <td style="text-transform:uppercase;"><?php echo $fun_store->fun_common($emp_data[0]['conv_allow_status'],$code_data); ?></td>
                </tr>
            <? } 
            else
            { ?>
