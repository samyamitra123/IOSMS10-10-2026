...
$emp_govt_id=$emp_data[0]['emp_govt_id'];
?>
                    ...
                    <form class="form-horizontal" id="first_form" method="post" action="profile_entry_basic_edit_insert.php" onsubmit="return valid_code();">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="emp_type" id="emp_type" onChange="emp_type_change(this.value);">
                                ...
                                <option value="<?= $key['code']; ?>" <? if($emp_type==$key['code']){ echo "selected";}?>><?= $key['description']; ?></option>
                                <? } ?>
                            </select>
                            </div> 
                            <label for="inputPassword3" class="col-sm-3 control-label" style="display:none;" id="govt_id_lvl">Government ID</label>
                            <div class="col-sm-3">
                            	<input type="text" class="form-control upper_case" style="display:none;"  name="govt_id" id="govt_id" placeholder="Government ID" value="<?=$emp_govt_id ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                            	...
                            	<input type="text" class="form-control" id="tch_dob" name="tch_dob" onChange="calculate_retireyear(this.value)" value="<?=$emp_dob=='0001-01-01' ? '' : $fun_store->date_frmt($emp_dob);?>" placeholder="DD-MM-YYYY" readonly style="background-color:#FFF;cursor:pointer;" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                            	<input type="text" class="form-control upper_case" id="pan_no"  name="pan_no" placeholder="PAN NO" autocomplete="off"  value="<?=$emp_pan_no ?>" maxlength="10">
                            </div>
...
<script>
	...
	function valid_code()
	{
		...
		var db_emp_first_name = '<?php echo $emp_first_name; ?>';
		var db_emp_second_name = '<?php echo $emp_second_name; ?>';
		var db_emp_last_name = '<?php echo $emp_last_name; ?>';
		var db_emp_dob = '<?php echo $fun_store->date_frmt($emp_dob); ?>';
		var db_emp_sex = '<?php echo $emp_sex; ?>';
		var db_emp_caste = '<?php echo $emp_caste; ?>';
		var db_emp_voter_id = '<?php echo $emp_voter_id; ?>';
		var db_emp_aadhar_no = '<?php echo $emp_aadhar_no; ?>';
		var db_emp_edu_quali = '<?php echo $emp_edu_quali; ?>';
		var db_emp_pan_no = '<?php echo $emp_pan_no; ?>';
		var db_emp_type = '<?php echo $emp_type; ?>';
		
		if((db_emp_first_name != $('#tch_fname').val()) ||
			(db_emp_second_name != $('#tch_mname').val()) ||
			(db_emp_last_name != $('#tch_lname').val()) ||
			(db_emp_dob != $('#tch_dob').val()) ||
			(db_emp_sex != $('#drpSex').val()) ||
			(db_emp_caste != $('#drpCast').val()) ||
			(db_emp_voter_id != $('#voter_id').val()) ||
			(db_emp_aadhar_no != $('#aadhaar_no').val()) ||	
			(db_emp_edu_quali != $('#emp_quali').val()) ||
			(db_emp_pan_no != $('#pan_no').val()) ||
			(db_emp_type != $('#emp_type').val())	
		)
		{
