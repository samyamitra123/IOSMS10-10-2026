...
$(document).ready(function(e) {
	...
	{
		alert('Please Enter LPC Number');
		$("#lpc_no").focus();
	}
	else{
	$.post('<?= $config['base_url'] ?>page/intra_zp/dae/zp_emp/ajax_transfer_emp.php?id='+link+'&lpc_no='+lpc_no,function(data){
		//alert(data);
		$("#transfer").html(data);
...
<div class="content">
      <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
        <div class="col-sm-12">
<h1 class="heading">TRANSFERRED EMPLOYEE </h1>
...
<form class="form-horizontal">
    ...
    <div class="form-group">
    <div class="col-sm-2"></div>
    <label for="inputEmail3" class="col-sm-3 control-label">LPC Number: <span class="star_color">*</span></label>
    <div class="col-sm-3"> 
      <input type="text" name="lpc_no" id="lpc_no" class="form-control upper_case" maxlength="6" placeholder="Enter LPC Number" value="" />
    </div>
    </div>
    <div class="form-group">
    <div class="col-sm-6"></div>
    <div class="col-sm-3">
    <a id="add_transfer" class="btn btn-md btn-info">ADD</a>
    </div>
    </div>
</form>
<div id="transfer"></div>
