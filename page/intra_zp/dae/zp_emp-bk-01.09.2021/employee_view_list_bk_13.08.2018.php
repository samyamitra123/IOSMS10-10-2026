									...
									if(count($arr))
									{
										foreach($arr as $item)
										{
											...
											<tr>
                                                ...
                                                <td class="view"><a href="" id="<?= $cryptoGraph->encode($item['emp_id_pk'],4);?>" data-toggle="modal" data-target="#myModal">
