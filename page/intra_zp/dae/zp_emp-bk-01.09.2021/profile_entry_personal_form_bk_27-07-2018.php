            ...
            <div class="col-sm-12">
                ...
                <form class="form-horizontal" id="loginForm" method="post" action="profile_entry_personal_update.php" onsubmit="return valid_code();">
                    ...
                    { ?>
						...
						{ ?>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label" id="spouse_medical_tr" style="display:none">Opted for enrolment in WB Health Scheme:<span class="star_color">*</span></label>
                                <div class="col-sm-3" id="spouse_medical_div">
                                    <select name="spouse_medical_allowance" id="spouse_medical_allowance" class="form-control" style="display:none">
                                    <option value="">Please Select</option>
...
function valid_code()
{
	...
	if($('#employed_not').checked==true)
	{
		...
		if(zp_emp_type == '367' && $('#spouse_medical_allowance').val()=='')
		{
	...
	if(db_zp_emp_type == 365 || db_zp_emp_type == 367)
	{
