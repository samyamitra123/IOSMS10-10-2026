...
$mpdf->WriteHTML('<div class="segment">
                ...
                <tr>
					...
					<tr>
					<td class="col1" style="color: #1F6377;font-weight: bold;width:25%;font-family: "Arial Narrow";font-style: italic;">First Joining Memo no :</td>
					<td style="width:25%;">'.$emp_data[0]['emp_first_memo_no'].'</td>
					<td class="col3" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;" >First Joining Memo Date :</td>
					<td style="width:25%;">'.$fun_store->date_frmt($emp_data[0]['emp_first_memo_date']).'</td>
				</tr>
					
					<tr>
					<td class="col1" style="color: #1F6377;font-weight: bold;width:25%;font-family: "Arial Narrow";font-style: italic;">Present Joining Memo no :</td>
					<td style="width:25%;">'.$emp_data[0]['emp_present_memo_no'].'</td>
					<td class="col3" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;" >Present Joining Memo Date :</td>
					<td style="width:25%;">'.$fun_store->date_frmt($emp_data[0]['emp_present_memo_date']).'</td>
				</tr>
...
$mpdf->WriteHTML('<div class="segment">
               ...
               $mpdf->WriteHTML(' <tr>
				...
				$mpdf->WriteHTML('
				<tr>
					<td class="col3" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;">Bsic Pay  :</td>
