                            ...
                            <div class="table-responsive">
								...
								if(count($arr))
								{
									foreach($arr as $item)
									{
										...
										{
											$status='<a value="'.$item['emp_id_pk'].'" id="show_rsn'.$cnt.'" onclick="show_reason('.$cnt.')" class="reason_view" data-bs-toggle="modal" data-bs-target="#reject_reason" style="cursor:pointer;"><span style="color:RED;font-weight:bold">PROFILE REJECTED BY SECRETARY</span></a>';
										}
										else if($item['emp_status']=='7')
										{
											$status='<a value="'.$item['emp_id_pk'].'" id="show_rsn'.$cnt.'" onclick="show_reason('.$cnt.')" class="reason_view" data-bs-toggle="modal" data-bs-target="#reject_reason" style="cursor:pointer;"><span style="color:RED;font-weight:bold">PROFILE REJECTED BY AEO</span></a>';
										}
