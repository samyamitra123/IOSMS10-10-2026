...
<td><?= $status; ?></td>
<td class="view">
<?php if(($item['emp_status']=='3' or $item['emp_status']=='1' ) and $item['emp_form_status']=='5'){ ?>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="btn-group">
        <a class="btn btn-warning finz_but" data-toggle="modal" data-target="#finalize">Approve</a>
