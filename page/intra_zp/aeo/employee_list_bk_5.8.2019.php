    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="btn-group">
                    <a class="btn btn-success finz_but" data-toggle="modal" data-target="#finalize">Approve</a>
                    <a class="btn btn-danger rej_but" data-toggle="modal" data-target="#reject">Reject</a>  
