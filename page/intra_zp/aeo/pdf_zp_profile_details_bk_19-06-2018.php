	...
	<h4 style="background-color: #3E9B96;color: #FFF;text-align: center;">PROFILE DETAILS:</h4>
				...
				<td  class="col1" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;"> </td>
				 ...
				 <tr>
					...
					<td>&nbsp;</td><td>&nbsp;
					<td class="col1" style="color: #1F6377;font-weight: bold;width:25%;font-family: "Arial Narrow";font-style: italic;">SECRETARY NAME :</td>
					
					<td style="text-transform:uppercase;">'.$secretary_name.'</td>
		
				</tr>
				
				 <tr>
				    <td class="col1" style="color: #1F6377;font-weight: bold;width: 25%;font-family: "Arial Narrow";font-style: italic;"> FC & CAO NAME :</td>
					<td style="text-transform:uppercase;">'.$fc_cao_name.'</td>
					<td>&nbsp;</td><td>&nbsp;
					<td class="col1" style="color: #1F6377;font-weight: bold;width:25%;font-family: "Arial Narrow";font-style: italic;">ACCOUNTANT NAME :</td>
					
					<td style="text-transform:uppercase;">'.$accountant_name.'</td>
...
{
	$mpdf->WriteHTML('<p style="color: #a94442;font-weight: bold;font-family: "Arial Narrow";font-style: italic;text-align:center">STATUS : Profile Rejected By AEO [ Reject Reason : '.$reject_reason.']</p>');		
}
...
{
	$mpdf->WriteHTML('<p style="color: #a94442;font-weight: bold;font-family: "Arial Narrow";font-style: italic;text-align:center">STATUS : Profile Not Forwaded By Secretary</p>');		
}
