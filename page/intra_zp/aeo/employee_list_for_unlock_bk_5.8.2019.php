...
<td class="view"><a href="" id="<?= $cryptoGraph->encode($item['emp_id_pk'],4);?>" data-toggle="modal" data-target="#myModal"><img src="<?= $config['base_url'] ?>themes/default/image/view_icon.png" width="25" alt="view" /></a></td>
<td><a class="btn btn-success"style="margin-left:10%" data-toggle="modal"  onClick="lock_sch();">UNLOCK</a>
<a class="btn btn-danger" data-toggle="modal" onClick="unlock_sch();">REJECT</a></td>
