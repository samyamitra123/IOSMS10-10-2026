...
$query=$db->fetch_table("SELECT  
	...
	$zp_unlock_status=$query[0]['zp_unlock_status'];
...
<div class="col-sm-6">
    ...
    {
        echo $status='<p class="text-danger" style="font-weight:bold; font-size: 18px;">STATUS : Profile Not Forwaded By Secretary</p>';
    }
	...
	<div class="col-sm-6 ">
        <div style="width:100px; margin-left:80%; border:rgb(60, 175, 187) 3px solid; text-align:center; padding-top:3px; box-shadow: 7px 7px 7px #888888; border-radius: 5px;">
        	...
        	if($zp_status=='1' && $zp_unlock_status=='2')
        	{ ?>
...
<div class="downpdf" style="margin-left:88%"><a href="<?= $config['base_url']?>page/intra_zp/aeo/pdf_zp_profile_details.php"><img src="<?= $config['base_url'] ?>themes/default/image/pdf_download.png"/></a></div>
...
<div class="row mb-3" style="padding-left: 43%; margin-top: 4%;">
...
<div class="modal fade bs-example-modal-sm" id="approve" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-modal-parent="#schprfModal">
 ...
 <div class="modal-body"> 
      <p class="alert alert-warning"><strong><i class="fa fa-exclamation-triangle"></i> Are You Sure To Approve The ZP Profile?</strong></p>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
	 ...
	 <h4 class="modal-title" id="myModalLabel">Confirmation</h4>
      ...
      <div class="modal-footer">
      <div class="btn-group">
        <a class="btn btn-success" href="<?php echo $config['base_url'] ?>page/intra_zp/aeo/unlock_zp_profile.php?action=<?php echo $accept ?>">Accept</a> &nbsp;
        <a class="btn btn-danger" href="<?php echo $config['base_url'] ?>page/intra_zp/aeo/unlock_zp_profile.php?action=<?php echo $reject ?>">Reject</a> 
      </div>
      </div>
    </div>
  </div>
