...
/////////////////////////////////////////////////////////////////////////////// SERVER SIDE VALIDATION  ///////////////////////////////////////////////////////////////////////////////////////////////
	...
	else
	{
		...
		if($query)
		{
			$_SESSION["msg"]='<div class="alert alert-success" style="text-align:center;"><strong>ZP profile updated Successfully...</strong></div>';
			header('Location:zp_profile_form.php');
		}
		else
		{
			$_SESSION["msg"]='<div class="alert alert-danger" style="text-align:center;"><strong>ZP profile updation failed...</strong></div>';
			header('Location:zp_profile_form.php');
		}
	}
}
