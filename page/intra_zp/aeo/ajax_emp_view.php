...
<?
if($emp_data[0]['emp_unlock_status']=='2' && $emp_data[0]['emp_status']=='1')
{

?>
    <!--<div class="unlock_forward " align="right" style="padding-right:25px;">
        <a  data-toggle="modal" href=""><i class="fa fa-unlock-alt fa-2x reason_view" aria-hidden="true" style="padding-right:5px;" onClick="unlock_action('unlock&<?php echo $cryptoGraph->encode($emp_data[0]['emp_id_pk'],4);?>');"><span class="tooltiptext">Unlock Request Accept</span></i></a>
