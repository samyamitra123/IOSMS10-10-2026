...
<?
$db=new database();
$arr=$db->fetch_table("select emp_first_name,emp_second_name,emp_last_name,emp_desig,emp_status,emp_unlock_status,emp_id_pk,emp_system_code,gp_id_fk,emp_id_const from prd_employee_master where emp_unlock_status in('2') AND zp_id_fk='".$_SESSION['location']['district_id']."' order by emp_first_name");
...
<td><a class="btn btn-success"style="margin-left:10%" data-bs-toggle="modal"  onClick="lock_sch('<?= $cryptoGraph->encode($item['emp_id_pk'],4);?>');">UNLOCK</a>
<a class="btn btn-danger" data-bs-toggle="modal" onClick="unlock_sch('<?= $cryptoGraph->encode($item['emp_id_pk'],4);?>');">REJECT</a></td>
...
<div class="modal fade bs-example-modal-sm" id="lock" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-modal-parent="#schprfModal">
  <div class="modal-dialog modal-sm">
    <div class="modal-content" style="width: max-content; margin-left: -25%;" >
     <div class="modal-header">
 ...
 <div class="modal-body"> 
	  ...
	  <input type="hidden" id="action_app" name="llock" />
      </div>
      <div class="modal-footer">
      <div class="btn-group">
...
<div class="modal fade bs-example-modal-sm" id="unlock" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-modal-parent="#schprfModal">
 ...
 <div class="modal-body"> 
      ...
      <input type="hidden" id="reject_new" name="reject"  />
