...
if($sal_action=='forward')
{
	...
	$unlocked_emp_check=$db->fetch_table("
										...
										AND emp.emp_unlock_status='4' AND sal.salary_monthyear='".date('Ym')."' AND sal.ropa_status='2'
									");
	...
	else
	{
		...
		$query_lock=$db->update("UPDATE prd_employee_salary_save SET status_flag='3'  
								...
								AND is_saved='1' AND requisition_type='".$requisition_type."' AND ropa_status='2' "); 
