...
$salary_details_fetch= $db->fetch_table("SELECT 
							...
							sal.hra_deduction, tch.emp_first_name, tch.emp_second_name,sal.allowance, 
							tch.emp_last_name, tch.emp_pay_in_payband ,sal.consolidated_pay,sal.other_loan_deduction, sal.ropa_status, sal.ropa_level
							FROM 
							...
							WHERE 
								...
								AND is_saved='1' AND requisition_type='".$requisition_type."' AND sal.ropa_status='1' 
                        ...
                        <div class="table-responsive">
                            ...
                            <table width="100%">
                                ...
                                if(count($salary_details_fetch))
								{
									...
									<tr style="text-align: right;">
									<th  colspan="21" style="text-align: right; padding:7px;">Total Amount</th>
...
<form name="salary_for_un" id="salary_for_un" action="zp_forward_unlock_salary_ropa_2019.php" method="post">
    	...
    	<div class="modal-dialog modal-sm">
        	<div class="modal-content" >
                ...
                <div class="modal-body"> 
                    <p class="alert alert-warning" id="forward_sal_msg" style="display:none;"><strong><i class="fa fa-exclamation-triangle"></i> Are You Sure To Forward Salary Requisition?</strong></p>
