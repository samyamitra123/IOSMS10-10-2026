...
$forward_val=$crypto->encode("forward",4);
...
$salary_details_fetch= $db->fetch_table("SELECT 
							...
							sal.hbl_loan,sal.total_loan_deduction,sal.hbl_loan,festival_loan,sal.interim_relief,
							sal.hra_deduction, tch.emp_first_name, tch.emp_second_name, 
							tch.emp_last_name, tch.emp_pay_in_payband ,sal.consolidated_pay,sal.other_loan_deduction
							FROM 
							...
							WHERE 
								...
								AND sal.status_flag in('2','3','4') AND salary_monthyear='".date('Ym')."' 
...
function confirm_mod(k)
{
	...
	if(k=='forward')
	{
		$('#forward_sal_msg').show();
		$('#unlock_sal_msg').hide();
		$('#sal_action').val('<?php echo $forward_val;?>');
	}
	else if(k=='unlock')
	{
		$('#unlock_sal_msg').show();
		$('#forward_sal_msg').hide();
...
<?php require '../../../common_back_btns.php'; ?>	
    ...
    <div class="row" id="cont">
        ...
        <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad">
            <div class="col-sm-12">
                <h1 class="heading">View Supplementary Salary Requisition</h1>
                ...
                <div class="emplist">
                    <div class="school">
                    <?php if(count($salary_details_fetch)>0 && $salary_details_fetch[0]['status_flag']=='2')
					{ ?>
                        <div class="button">
                            <a style="margin-left:55%; cursor:pointer" onClick="confirm_mod('unlock');" alt="Unlock" ><i class="fa fa-unlock fa-3x" aria-hidden="true" style="color:#b20f08;"></i></a>&nbsp;&nbsp;&nbsp;
                            <a onClick="confirm_mod('forward');" alt="Forward" style= "cursor:pointer" ><i class="fa fa-forward fa-3x" aria-hidden="true" style="color:#347d76;"></i></a>
...
<form name="salary_for_un" id="salary_for_un" action="zp_forward_unlock_salary.php" method="post">
    	...
    	<div class="modal-dialog modal-sm">
        	<div class="modal-content" >
                ...
                <div class="modal-body"> 
                    <p class="alert alert-warning" id="forward_sal_msg" style="display:none;"><strong><i class="fa fa-exclamation-triangle"></i> Are You Sure To Forward Supplementary Salary Requisition?</strong></p>
                    <p class="alert alert-warning" id="unlock_sal_msg" style="display:none;"><strong><i class="fa fa-exclamation-triangle"></i> Are You Sure To Unlock Supplementary Salary Requisition?</strong></p>
