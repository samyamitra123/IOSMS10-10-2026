        ...
        <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad">
            <div class="col-sm-12">
                ...
                <div class="emplist">
					...
					{ ?>
                        <div class="button">
                            <a style="margin-left:55%" onClick="confirm_mod('unlock');"><i class="fa fa-unlock fa-3x" aria-hidden="true" style="color:#b20f08;"></i></a>&nbsp;&nbsp;&nbsp;
                            <a onClick="confirm_mod('forward');"><i class="fa fa-forward fa-3x" aria-hidden="true" style="color:#347d76;"></i></a>
