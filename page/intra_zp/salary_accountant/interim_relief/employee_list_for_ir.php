...
$arr=$db->fetch_table("SELECT 
				...
				ON(mas.emp_id_pk=ir.emp_id_fk AND mas.zp_id_fk=ir.zp_id_fk)
				WHERE ir.ir_status in('3','4' ) AND ir.delete_status ='1' AND ir.zp_id_fk='".$_SESSION['location']['district_id']."' order by mas.emp_id_const");
?>
<style>
h1 {
display: block;
									...
									{ 
										foreach($arr as $item)
										{
											...
											<tr>
                                                ...
                                                <td id="emp_ir_td<?php echo $cnt;?>"><?php echo $item['interim_relief'];?></td>
                                                <td>
													<? if($item['ir_status']=='4' && $item['delete_status']=='1' && $item['unlock_req']=='0')
                                                    { ?>
                                                        <a data-toggle="modal" onClick="ir_edit(<?=$cnt;?>);" style="cursor:pointer; "><img width="25" src="<?= $config['base_url'] ?>themes/default/image/edit_icon.png" alt="Edit" ></a>
                                                    <? } 
                                                    else
                                                    { ?>
                                                ...
                                                <td>
                                                <?php   
												if($item['unlock_req']=='1' && $item['ir_status']=='4' && $item['delete_status']=='1') 
                                                { ?>
                                                	<a  onClick="unlock_req(<?=$cnt;?>)"><i class="fa fa-key fa-2x reason_view" aria-hidden="true"><span class="tooltiptext">Unlock </span></i></a>
                                                <?php 
												}
                                                else
                                                { ?>
                                                ...
                                                { ?>
                                                <a class="btn btn-danger" disabled>REJECT</a></td>
                                                <?php
                                                } ?>
                                                </td>
											</tr>
                ...
                <div class="modal-body"> 
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 ">
                            ...
                            <input type="hidden" name="ir_gp_id" id="ir_gp_id"/>
                        </div>
