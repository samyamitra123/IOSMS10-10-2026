...
?>
    <div class="unlock_forward " align="right" style="padding-right:25px;">
		...
		{ ?>
        	<a  data-bs-toggle="modal" href=""><i class="fa fa-unlock-alt fa-2x reason_view" aria-hidden="true" style="padding-right:5px;" onClick="unlock_action('unlock&<?php echo $cryptoGraph->encode($emp_data[0]['emp_id_pk'],4);?>');"><span class="tooltiptext">Unlock Request Forward</span></i></a>
		<?php
		} ?>
        
        <a data-bs-toggle="modal" href=""><i class="fa fa-ban fa-2x reason_view" aria-hidden="true" style="color:#db5151" onClick="unlock_action('reject&<?php echo $cryptoGraph->encode($emp_data[0]['emp_id_pk'],4);?>');"><span class="tooltiptext">Unlock Request Reject</span></i></a>
    </div>
<? 
}?>    
...
<div id="accordion">
    ...
    <div id="attraction">
        <table border="0" width="100%">
            <tr>
                <td  class="text_r" style="width:25%" >Notification number of the Appointment :</td>
