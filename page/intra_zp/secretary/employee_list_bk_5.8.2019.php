                            ...
                            <div class="table-responsive">
								...
								if(count($arr))
                                {
									foreach($arr as $item)
									{
										...
										{
											$status='<a value="'.$item['emp_id_pk'].'" id="show_rsn'.$cnt.'" onclick="show_reason('.$cnt.')" class="reason_view" data-toggle="modal" data-target="#reject_reason" style="cursor:pointer;"><span style="color:RED;font-weight:bold">REJECTED BY AEO</span></a>';
										}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="btn-group">
                <a class="btn btn-success finz_but" data-toggle="modal" data-target="#forward"><span id="unlock_for_span" style="display:none;">Unlock Request </span>Forward</a>
                <a class="btn btn-danger rej_but" data-toggle="modal" data-target="#reject"><span id="unlock_rej_span" style="display:none;">Unlock Request </span>Reject</a>  
