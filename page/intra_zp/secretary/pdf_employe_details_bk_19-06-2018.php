...
function fun_emp_type($val){
  ...
  $Employee_ID_val=$emp_data[0]['emp_id_const']; 
	...
	{
		$emp_desig_first_app='GP&nbsp;'.fun_desig($emp_data[0]['emp_desig_first_app'],$desig_data);
	}
	else
	{
		$emp_desig_first_app=fun_desig($emp_data[0]['emp_desig_first_app'],$desig_data);
	}
...
$mpdf->WriteHTML('<div class="segment">
				...
				<tr>
					...
					<td style="width:25%;">'.fun_desig( $emp_data[0]['emp_desig'],$desig_data).'</td>
				</tr>
				<tr>
