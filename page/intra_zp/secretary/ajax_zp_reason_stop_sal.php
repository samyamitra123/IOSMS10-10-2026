...
<td  width="25%"><input type="text" class="form-control upper_case" id="claimant_name" name="claimant_name" placeholder="" autocomplete="off" value="<?=$emp_branch_code ?>"></td>
...
<td  width="25%"><input type="text" class="form-control" autocomplete="off" placeholder="MOBILE NO" name="claimant_mob" id="claimant_mob" maxlength="10" value="<?=$mobile_no?>" onKeyPress="return keyRestrict(event,'0123456789');">
</tr>
</table>
</div>
