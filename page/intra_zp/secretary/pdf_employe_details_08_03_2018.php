...
$mpdf->WriteHTML('<div class="segment">
				...
				<tr>
					...
					<td style="width:25%;">'.fun_emp_type($emp_data[0]['zp_emp_type']).'</td>
				</tr>
				<tr>
...
$mpdf->WriteHTML('<div class="segment">
						...
						<table border="0" width="100%" style="font-size: 11px;vertical-align: bottom;">
				<tr>
					<td  class="col1" style="color: #1F6377;font-weight: bold;width:25%;font-family: "Arial Narrow";font-style: italic;" >Notification number of confirming the Appointment :</td>
					...
					<td style="width:25%;">'.fun_common( $emp_data[0]['emp_desig'],$code_data).'</td>
				</tr>
				<tr>
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['conf_dt_flag'],$code_data).'</td>
...
$mpdf->WriteHTML('<div class="segment">
               ...
               $mpdf->WriteHTML(' <tr>
				...
				$mpdf->WriteHTML('<tr>
					...
					<td style="width:25%;">'.fun_payband($emp_data[0]['emp_pay_band']).'</td>
					<td class="col3" style="color: #1F6377;font-weight: bold;width: 25%;;font-family: "Arial Narrow";font-style: italic;">Pay Scale :</td>
				<td style="width:25%;">'.fun_payscale($emp_data[0]['emp_pay_scale']).'</td>
				</tr>
				<tr>
					...
					<td style="width:25%;">'.fun_grade_pay($emp_data[0]['emp_grade_pay']).'</td>
				</tr>',2);
                }
                $mpdf->WriteHTML('<tr>
...
$mpdf->WriteHTML('<div class="segment">
			...
			if($emp_data[0]['zp_emp_type'] == 365 || $emp_data[0]['zp_emp_type'] == 367)
			{
				$mpdf->WriteHTML('
					...
					<td style="width:25%;">'.fun_common($emp_data[0]['spouse_medical_allowance'],$code_data).'</td>',2);
			}
				$mpdf->WriteHTML('
				</tr>
				<tr>
...
else if($emp_data[0]['emp_status']=='1' && $emp_data[0]['emp_unlock_status']=='0')
{
...
else if($emp_data[0]['emp_status']=='1' && $emp_data[0]['emp_unlock_status']=='1')
{
	$mpdf->WriteHTML('<span style="color:RED;font-weight:bold">WAITING FOR UNLOCK</span>');		
}
else if($emp_data[0]['emp_status']=='1' && $emp_data[0]['emp_unlock_status']=='2')
{
	$mpdf->WriteHTML('<span style="color:RED;font-weight:bold">UNLOCK REQUEST FORWARDED TO AEO</span>');		
}
