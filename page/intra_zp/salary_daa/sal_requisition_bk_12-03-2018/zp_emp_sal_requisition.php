	...
	function ptaxCal(){
		...
		if($('#p_tax').val() > max_ptax || $('#p_tax').val()==''){
			...
			var overdrawn = $('#overdrawn').val();
				...
				var deduct = parseInt(gpf)+parseInt(pfl)+parseInt(ptax)+parseInt(itax)+parseInt(overdrawn)+parseInt(gsli)+parseInt(reduct3)+parseInt(adv_sal)+parseInt(hra_deduc);
...
function reduc(value){
		...
		function hra_deduction(){
			...
			if(hra_deduc=='' || hra_deduc=='0'){
				...
				var adv_sal = $('#adv_sal').val();
				var hra_deduc=0;
				var deduct = parseInt(gpf)+parseInt(pfl)+parseInt(ptax)+parseInt(itax)+parseInt(overdrawn)+parseInt(gsli)+parseInt(hra_deduc);
				var total_deduct = parseInt(gross)-parseInt(deduct);
...
//			}
		...
		{
			$.post('<?= $config['base_url'] ?>page/intra_ps/da/sal_requisition/cal_ptax.php?gross='+gross, function(data){
				// alert(data);
				 $('#p_tax').val(data);
				/* var data=data;
				return(data);*/
