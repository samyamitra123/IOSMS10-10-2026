...
$db = new database();
$upd = $db->update("UPDATE mad_employee_salary_save
						SET status_flag = 2
					WHERE
						municipality_id_fk = '".$municipality_code."'
...
if($upd && $security){
	//echo "in if";
					...
					header('Location:'.$config['base_url'].'page/intra_mad/ddo_deo/sal_requisition/emp_sal_requisition.php');
					exit(0);
}
