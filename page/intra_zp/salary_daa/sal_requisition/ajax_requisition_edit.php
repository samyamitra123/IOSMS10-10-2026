...
function getEmpAmount($type,$dise,$emp_id_pk){
	...
	if($type == 'pay_in_pay_band'){     //Checked
		$arr = $db->fetch_table("select emp_pay_in_payband from prd_employee_master where emp_id_pk='".$emp_id_pk."' AND ropa_status='2'");
	...
	where emp_id_pk='".$emp_id_pk."' AND ropa_status='2'");
	...
	$arr = $db->fetch_table("select interim_relief from prd_employee_master where emp_id_pk='".$emp_id_pk."' AND ropa_status='2'");
...
INNER JOIN prd_dise_gradepay_master as gd 
ON trim(emp.emp_grade_pay)=gd.grade_code
where emp_id_pk='".$emp_id_pk."' AND emp.ropa_status='2'");         //Checked   //interim_relief, emp_pay_in_payband has been added by 
...
$arr = $db->fetch_table("select cpf from prd_employee_salary_save where (status_flag=1 or status_flag=2 or status_flag=3) AND delete_status=1  AND emp_id_fk='$emp_id_pkk' AND salary_monthyear='".date('Ym')."' AND zp_id_fk='".$dise."' AND ropa_status='2'");
...
if($type=='gpf')
{
$arr = $db->fetch_table("select gpf from prd_employee_salary_save where status_flag=1 AND delete_status=1  AND emp_id_fk='$emp_id_pk' AND salary_monthyear='".date('Ym')."' AND zp_id_fk='".$dise."' AND requisition_type='".$requisition_type."' AND ropa_status='2'");
if($arr[0]['gpf'])
{
return $arr[0]['gpf'];
}
...
$arr = $db->fetch_table("select i_tax from prd_employee_salary_save where (status_flag=1 or status_flag=2 or status_flag=3) AND delete_status=1  AND emp_id_fk='$emp_id_pkk' AND salary_monthyear='".date('Ym')."' AND zp_id_fk='".$dise."' AND ropa_status='2'");
...
$arr = $db->fetch_table("select overdrawn from prd_employee_salary_save where (status_flag=1 or status_flag=2 or status_flag=3) AND delete_status=1  AND emp_id_fk='$emp_id_pkk' AND salary_monthyear='".date('Ym')."' AND zp_id_fk='".$dise."' AND ropa_status='2'");
...
$arr = $db->fetch_table("select conv_allow from prd_employee_salary_save where (status_flag=1 or status_flag=2 or status_flag=3) AND delete_status=1  AND emp_id_fk='$emp_id_pkk' AND salary_monthyear='".date('Ym')."' AND zp_id_fk='".$dise."' AND ropa_status='2'");
if($arr[0]['conv_allow']){
...
AND emp_id_fk='$emp_id_pk' AND zp_id_fk='".$dise."' AND ropa_status='2'");
...
//66666666666666666666666666666666666666666666666666
    ...
    foreach ($tch as $key) 
    {
		...
		and em1.emp_status='11' and sus.delete_status='0' AND em1.ropa_status='2' ORDER BY slno DESC
		");
...
$sal_save=	$db->fetch_table("SELECT 
							...
							AND zp_id_fk='".$dise."' 
							AND emp_id_fk='$emp_id_pk' AND requisition_type='".$requisition_type."' AND ropa_status='2'");
...
and sus.delete_status='0' AND em1.ropa_status='2' ORDER BY slno DESC");
...
<tr>
	...
	<td>
		...
		where status_flag=1 AND delete_status=1  AND emp_id_fk='".$tch[0]['emp_id_pk']."' AND zp_id_fk='".$dise."' 
		AND requisition_type='".$requisition_type."' AND ropa_status='2' ");
