...
else
{
	...
	/*if($_SESSION['location']['district_id']=='2')
	{
		echo $total_allowance."-". $gross."-".$total_allowance-$total_deductions."--".$net."&--".$total_allowance."--".$total_deductions;
	...
	$hra_details_fetch=$db->fetch_table(" SELECT emp_gvt_hra_type,emp_gvt_hra_ammount FROM prd_employee_master WHERE emp_id_pk='".$crypto->decode($emp_id_pk,4)."' AND emp_spouse_res='251' AND zp_id_fk='".$_SESSION['location']['district_id']."' AND ropa_status='2' ");
	...
	if($arr[0]['salary_type'])
	{
		...
		$ins = $db->insert("INSERT INTO prd_employee_salary_save(slno,latestupdate_time, latestupdate_ip_address, zp_id_fk, empcd, 
																...
																hra_deduction,hra_loan_cause,other_deduction_cause,zp_emp_type,emp_desig,other_loan_deduction, ropa_status
																)
																...
																'$no_salary_cause_msg','$interim_relief','".$requisition_type."','0','".$total_loan_deduction."','".$hra_deduction."','".$hra_loan."','".$other_deduction_cause."','".$zp_emp_type."','".$emp_desig."','".$other_loan_deduction."',
																'$ropa_status')");	
	...
	else
	{
		...
		$ins = $db->insert("INSERT INTO prd_employee_salary_save(slno,latestupdate_time, latestupdate_ip_address, zp_id_fk, empcd, 
																...
																'".$other_deduction_cause."','".$zp_emp_type."','".$emp_desig."','".$other_loan_deduction."', '$ropa_status')");
