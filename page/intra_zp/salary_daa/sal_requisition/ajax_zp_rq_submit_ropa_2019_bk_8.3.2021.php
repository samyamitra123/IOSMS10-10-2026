...
else
{
	...
	$i_tax = $_POST['i_tax'];
	$gsli = $_POST['gsli'];
	$other_loan_deduction = $_POST['other_loan_deduction'];
	...
	$total_allowance=$consolidated_pay+$pay_in_band+$da+$hra+$ma+$conv_allow+$hill_allow+$interim_relief;
	...
	{ 
		...
		hra_deduction,hra_loan_cause,other_deduction_cause,zp_emp_type,emp_desig,other_loan_deduction, ropa_level, ropa_status
		)
		...
		'$no_salary_cause_msg','$interim_relief','".$requisition_type."','0','".$total_loan_deduction."','".$hra_deduction."','".$hra_loan."','".$other_deduction_cause."','".$zp_emp_type."','".$emp_desig."','".$other_loan_deduction."', '$grade_pay', '$ropa_status')");	
	...
	{ 
		...
		'".$other_deduction_cause."','".$zp_emp_type."','".$emp_desig."','".$other_loan_deduction."', '$grade_pay', '$ropa_status')");
