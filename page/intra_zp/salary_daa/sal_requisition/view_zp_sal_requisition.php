...
$tch= $db->fetch_table("SELECT sal.ps_id_fk,tch.emp_status, sal.empcd, 
       ...
       sal.overdrawn, sal.salary_type, sal.cause, sal.part_day, sal.consolidated_pay,sal.total_loan_deduction,sal.gsli,sal.consolidated_pay,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.hra_deduction,sal.ropa_status,
										tch.emp_first_name,
										tch.emp_second_name,
										tch.emp_last_name,
									...
									INNER JOIN 
										...
										WHERE
											...
											AND sal.status_flag in('1','2','3','4')  AND is_saved='1' AND sal.delete_status='1' AND salary_monthyear='".date('Ym')."' AND is_saved='1' AND requisition_type='".$requisition_type."' AND sal.ropa_status=='2' order by tch.emp_first_name ;
								");
