...
//$hbl_loan = 0;
$festival_loan =0;
$total_deduct = $gpf+$pfl+$cpf_deduct+$ptax+$itax+$gsli+$overdrawn+$festival_loan+$festival_loan+$other_loan_deduction;	
...
$overdrawn=0;
/////////// gondogol //////////////////
$total_deduct = $gpf+$pfl+$cpf_deduct+$ptax+$itax+$gsli+$overdrawn+$other_loan_deduction;
...
<td width="65%" style="text-align:left; "><p><input type="checkbox" name="n7" id="reduction_type1" class="cls6" value="1" <?php  if($hra_loan_cause==1) { ?>checked="checked" <?php } ?>>&nbsp;&nbsp;&nbsp;<b>HRA Deduction/Licence Fees</b></p>
...
<tr>
  <td class="row_heading">CONSOLIDATED PAY</td>
 <td><?php echo '111'.'--' .$consolidated_pay; ?></td>
