...
function generate_excel()
{
	...
	var month=$('#month').val();
	var type=$('#type').val();
	window.location.href= "salary_requisition_excel.php?year="+year+"&month="+month+"&type="+type;
}
...
//alert(11);
$('#year,#month,#type').change(function(){
...
<div class="border"></div>
		...
		?>
              ...
              <div class="col-sm-3"></div>
                        <label for="inputPassword3" class="col-sm-3 control-label" style="margin-top:.23cm; color:#0070A3;">Select Employee Type<span class="star_color">*</span>:</label>
                   <div class="col-sm-3">
                         <select class="form-control upper_case" name="type" id="type" style="width:226px;">
                            <option value="">-Please Select-</option>
                            <option value="<?php echo $crypto->encode(366,4);?>" >GOVERNMENT EMPLOYEE</option>
                            <option value="<?php echo $crypto->encode(367,4);?>" >GRANT-IN -AID EMPLOYEE</option>
						
                           </select>		
                  </div>
                </div>
              
               <div class="col-sm-12" style=" margin-top:17px;"></div>
                        
            <div class="form-group">
              <div class="col-sm-3"></div>
                        <label for="inputPassword3" class="col-sm-3 control-label" style="margin-top:.23cm; color:#0070A3;">Select Year<span class="star_color">*</span>:</label>
                   <div class="col-sm-4">
                         <select class="form-control upper_case" name="year" id="year" style="width:226px;">
                            <option value="">-Please Select-</option>
                  ...
                  <div class="col-sm-12" style=" margin-top:17px;"></div>
                    <div class="form-group">
                       <div class="col-sm-3"></div>
                        <label for="inputPassword3" class="col-sm-3 control-label" style="margin-top:.23cm;color:#0070A3;">Select Month<span class="star_color">*</span>:</label>
                           <div class="col-sm-3">
                          <select class="form-control upper_case" name="month" id="month" style="width:226px;" >
                            <option value="">-Please Select-</option>
                  ...
                  <div class="col-sm-12" style="margin-top:15px">
                     <div class="col-sm-5"></div>
                        <div style="display:none;" id="report" ><a class="btn btn-info btn-sm" onClick="generate_excel();"><i class="fa fa-file-text"></i>&nbsp;Download Salary Requistion Report</a>
                     </div>
                   </div>
			    </div> 
		     </div>
