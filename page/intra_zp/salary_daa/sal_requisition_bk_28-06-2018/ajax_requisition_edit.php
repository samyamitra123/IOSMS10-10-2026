...
$paychange = $db->fetch_table("SELECT paychange_id_pk, paychange_ip, paychange_fromdate, paychange_todate, 
       ...
       overdrawn, salary_type, cause,gp_code, part_day,gsli,consolidated_pay,festival_loan,festival_loan_cause,total_loan_deduction from prd_employee_salary_save
	    where 
	           ...
	           if($tch[0]['emp_spouse_res']=='251'){ 
				  ...
				  //  $hbl_loan = $sal_chk[0]['hbl_loan'];
					...
					//$full_net_salary = $full_gross_salary-$total_deduct;
					 $ptax;
				     $total_deduct = $gpf+$ptax+$itax+$gsli+$overdrawn+$festival_loan+$ssl+$scl+$scc+$arrear_amount+$hra_deduction;
...
input[type="checkbox"] {
   ...
   <tr id="reduction_type" >
                    ...
                    <td width="65%" style="text-align:left; "><p><input type="checkbox" name="n7" id="reduction_type1" class="cls6" value="1" <?php  if($other_deduction==1) { ?>checked="checked" <?php } ?>>&nbsp;&nbsp;&nbsp;<b>HRA Deduction</b></p>
