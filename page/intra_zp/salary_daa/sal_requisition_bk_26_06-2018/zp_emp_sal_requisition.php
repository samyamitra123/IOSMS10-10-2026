...
<div id="dialog-confirm" title="Do you want to finalize your requisition?">
      ...
      <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
        <div class="col-sm-12">
<h1 class="heading">Employee Salary Requisition</h1>
...
<?php require_once 'zp_requisition_form.php'; 
		...
		if($('#exist_part_day').val()!=''){
			if(id == '1'){
				...
				$('#i_tax').css('background-color','#FFF');
						...
						var itax = $('#i_tax').val();
						var overdrawn = $('#overdrawn').val();
						var deduct = parseInt(gpf)+parseInt(pfl)+parseInt(cpfd)+parseInt(ptax)+parseInt(itax)+parseInt(overdrawn);
	...
	function ptaxCal(){
		...
		if($('#p_tax').val() > max_ptax || $('#p_tax').val()==''){
			...
			var overdrawn = $('#overdrawn').val();
				...
				var deduct = parseInt(gpf)+parseInt(total_loan_deduction)+parseInt(ptax)+parseInt(itax)+parseInt(overdrawn)+parseInt(gsli)+parseInt(reduct3)+parseInt(adv_sal)+parseInt(hra_deduc);
		...
		function itaxCal(){
			...
			if(itax==''){
				...
				var reduct3=$('#reduct3').val();
				 //var hra_deduc = $('#hra_deduc').val();
				 var total_loan_deduction=$('#total_loan_deduction').val();
				var deduct = parseInt(gpf)+parseInt(ptax)+parseInt(itax)+parseInt(overdrawn)+parseInt(gsli)+parseInt(reduct3)+parseInt(total_loan_deduction);
				//alert(deduct);
				var total_deduct = parseInt(gross)-parseInt(deduct);
				$('#deduct').val(deduct);
				$('#net').val(total_deduct);
...
function reduc(value){
		...
		function hra_deduction(){
			...
			if(hra_deduc=='' || hra_deduc=='0'){
				...
				var hra_dedu=0;
				 var total_loan_deduction=$('#total_loan_deduction').val();
				var deduct = parseInt(gpf)+parseInt(total_loan_deduction)+parseInt(ptax)+parseInt(itax)+parseInt(overdrawn)+parseInt(gsli)+parseInt(hra_dedu);
				...
				if(parseInt(hra) < parseInt(hra_deduc)){
					
					alert('Please enter the valid HRA Deduction amount.\nHRA Deduction amonut should not be greater than Pay in pay band.');
					$('#hra_deduc').val(0);
					var hra = $('#hra').val();
				    var gross = $('#gross').val();
					//var pfl = $('#pf_loan').val();
...
//==================================================================================================================================================		
			...
			if(overdrawn==''){
				...
				var adv_sal = $('#adv_sal').val();
				var hra_deduc = $('#hra_deduc').val();
		var deduct = parseInt(gpf)+parseInt(total_loan_deduction)+parseInt(ptax)+parseInt(itax)+parseInt(overdrawn)+parseInt(gsli)+parseInt(hra_deduc);
				var total_deduct = parseInt(gross)-parseInt(deduct);
				$('#net').val(total_deduct);
			}else{
