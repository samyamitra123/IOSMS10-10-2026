...
.total{
	...
	width:17%;
			     ...
			     <tr>
                            	<td class="row_heading">Hill Allowance</td>
		...
		var work_days = $('#working_days').val();
			...
			if($('#working_days').val() >= parseInt($('#month_last_date').val()) || $('#working_days').val() == '0'){
				...
				$('#pay_in_band').val('<?php echo $pay_in_band; ?>');
					...
					$('#scl').val('<?php echo $scl; ?>');
					$('#scc').val('<?php echo $scc; ?>');
					$('#total_arrear_deduction').val('<?php echo $arrear_amount; ?>');      
		...
		//alert(582);
			...
			if($('#working_days').val() >= parseInt($('#month_last_date').val()) || $('#working_days').val() == '0'){
				...
				if(work_days==''){
					...
					var gross = parseInt(pay_band)+parseInt(grade_pay)+parseInt(da)+parseInt(interim_relief)+parseInt(hra)+parseInt(ma)+parseInt(conv_allow)+parseInt(hill_allow);
				...
				//var reduct1=$('#reduct1').val();
					...
					deduct = parseInt(gpf)+parseInt(gsli)+parseInt(ptax)+parseInt(itax)+parseInt(overdrawn)+parseInt(reduct3)+parseInt(ssl)+parseInt(scl)+parseInt(scc)+parseInt(total_arrear_deduction);
...
$(document).ready(function(){
	...
	$("#form").submit(function(){
		...
		var gross = Number(pay_in_payband)+Number(grade_pay)+Number(da)+Number(hra)+Number(ma)+Number(conv_allow)+Number(interim_relief);
		//alert(gross);
