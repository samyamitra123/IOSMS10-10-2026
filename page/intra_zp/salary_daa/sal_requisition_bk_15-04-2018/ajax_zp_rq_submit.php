...
else
{
	...
	$total_allowance=$pay_in_band+$grade_pay+$da+$hra+$ma+$conv_allow+$hill_allow+$interim_relief+$emp_bonus;
...
$crypto = new cryptography();
	...
	if($arr[0]['salary_type'])
	{
		...
		$ins = $db->insert("INSERT INTO prd_employee_salary_save(slno,latestupdate_time, latestupdate_ip_address, zp_id_fk, empcd, 
								...
								part_salary_cause,no_salary_cause,interim_relief,requisition_type,gp_id_fk,total_loan_deduction,
								emp_bonus
								)
								...
								'$no_salary_cause_msg','$interim_relief','".$requisition_type."','0','".$total_loan_deduction."',
								'".$emp_bonus."')");	
