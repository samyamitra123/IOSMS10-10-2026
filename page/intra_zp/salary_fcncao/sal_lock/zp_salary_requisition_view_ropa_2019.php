...
$salary_details_fetch= $db->fetch_table("SELECT 
							...
							sal.hbl_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.allowance,
							sal.hra_deduction, tch.emp_first_name, tch.emp_second_name, sal.total_loan_deduction,
							tch.emp_last_name, tch.emp_pay_in_payband,consolidated_pay,sal.other_loan_deduction, sal.ropa_status, sal.ropa_level
							FROM 
...
<form name="salary_for_un" id="salary_for_un" action="zp_lock_unlock_salary_ropa_2019.php" method="post">
