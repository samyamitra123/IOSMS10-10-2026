	...
	else
	{
		...
		{		
			$security = $db->insert("
									...
									");
			$_SESSION["msg"]='<div class="alert alert-success" style="text-align:center;"><strong>Supplementary Salary Locked Successfully...</strong></div>';
			header('Location:zp_salary_requisition_view.php');
		}
		
		else
		{
			$_SESSION["msg"]='<div class="alert alert-danger" style="text-align:center;"><strong>Supplementary Salary Locking failed. Please try again...</strong></div>';
			header('Location:zp_salary_requisition_view.php');
		}
	}
}
