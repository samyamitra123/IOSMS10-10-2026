...
$salary_details_fetch= $db->fetch_table("SELECT 
							...
							tch.emp_last_name, tch.emp_pay_in_payband,consolidated_pay,sal.other_loan_deduction
							FROM 
    	...
    	<div class="modal-dialog modal-sm">
        	<div class="modal-content" >
                ...
                <div class="modal-body"> 
                    <p class="alert alert-warning" id="lock_sal_msg" style="display:none;"><strong><i class="fa fa-exclamation-triangle"></i> Are You Sure To Lock Supplementary Salary Requisition?</strong></p>
