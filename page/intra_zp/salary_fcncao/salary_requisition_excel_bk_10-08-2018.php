...
<table width="100" border="1">
   <tr>
      <th colspan="26" style="text-align:center;"><br /><br />DETAILED SALARY BILL OF Grant-in-aid Employees UNDER <?= $_SESSION['location']['district_name']?> FOR THE MONTH OF <?= GetMonthString($_GET['month']).", ".$_GET['year'] ?><br /><br /></th>
   </tr>
    <tr>
  ...
  <th scope="col">CONSOLIDATED PAY</th>
    ...
    <th scope="col">OUT OF ACCOUNT DEDUCTION</th>
    <th scope="col" style="border:none">NET PAY</th>
  </tr>
  <? $cnt=1; 
$gross=$net=0;
$tot_conv_allow=$tot_payband=$tot_basic=$tot_da=$tot_hra=$tot_ma=$tot_ca=$tot_ha=$tot_cpf=$tot_gross=$tot_gpf=$tot_cpfdeduct=$tot_ptax=$tot_itax=$tot_od=$tot_gsli=$other_loan=$total_loan=$tot_net=0;
   if(count($tch)){foreach ($tch as $key) {?>
  <tr>
    <td scope="row"><?= $cnt;?></td>
    <td><?= $_SESSION['location']['district_name']?></td>
   ...
   <td style="text-align:center;"><?= $key['consolidated_pay']?></td>
    ...
    <td style="text-align:center;"><?= $key['festival_loan']?></td>
      <td style="text-align:center;"><?= $key['total_loan_deduction'] ?></td>
     <td style="text-align:center;"><?= $key['other_loan_deduction'] ?></td>      
...
<tr>
<th colspan="21" style="text-align:right; border:none;"><br /><br /><br />Zilla parishad OF <?= $_SESSION['location']['district_name']?></th>
</tr>
</table>
...
<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
<tr>
<th colspan="21" style="text-align:right; border:none;"><br /><br /><br />Zilla parisad OF <?= $_SESSION['location']['district_name']?></th>
</tr>
</table>
<? } ?>
</table>
