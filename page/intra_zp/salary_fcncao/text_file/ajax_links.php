...
//**************************************************************
	...
	function value_pass(encode_requsition, drn_number, emp_type,monthyear)
	{
		...
		$.post('<?= $config['base_url'] ?>page/intra_zp/salary_fcncao/text_file/xml_file.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type+'&monthyear='+monthyear,function (data) {
