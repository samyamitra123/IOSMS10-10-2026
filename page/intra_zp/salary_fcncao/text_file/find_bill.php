...
$find_bill = $db->fetch_table("
		...
		AND salary_monthyear ='".$yemo."' AND requisition_type='".$requisition_type."'  AND status='1' and zp_emp_type='".$emp_type."'
...
echo json_encode(array('bill'=>$find_bill[0]['bill_no'],'bill_date'=>$bill_entry_time,'priv_drn_number'=>$find_bill[0]['drn_number']));
