                        ...
                        <div class="table-responsive">
                            <div class="form-group">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td width="20%">1.</td>
                                        <td width="20%">Upload Bill Summary To IFMS</td>
                                        <td width="20%">
                                            <div class="link_p2">
												<?php if ($drn_checking[0]['bill_sending_status'] == '2' && $drn_checking[0]['response_code'] == '0') 
												{
                                                	?>
                                                	<img src="<?php echo $config['base_url']; ?>themes/default/image/send_btn.png"  class="img-responsive" style="width:85%; margin:0 auto; opacity:0.5;" />
                                                	<?php
                                                } 
												else 
												{
                                                	?>
                                                	<a style="display:inline-table;" onClick="value_pass('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>');" > <img id="send_bill_sum_id" src="<?php echo $config['base_url']; ?>themes/default/image/send_btn.png"  class="img-responsive" style="width:85%; margin:0 auto; cursor:pointer" /></a>
                                                
                                                	<img id="send_bill_sum_id_disable" src="<?php echo $config['base_url']; ?>themes/default/image/send_btn.png" class="img-responsive" style="width:50%; margin:0 auto; opacity:0.5;display:none;" />
                                                <?php } ?>
                                            </div>
                                        </td>
                                        <td id="status_bill_sum_send"><?php echo ifms_error_description_generate($drn_checking[0]['response_code']); ?> </td>
                                        <td><span id="edit_action_first_row" style="display:none;"></span>
											<?php 
											if ($drn_checking[0]['bill_sending_status'] == '2' && $drn_checking[0]['response_code'] != '0') 
											{
                                            ?>
                                    ...
                                    ?>
                                        <tr>
                                            <td width="20%">2. </td>
                                            <td width="20%">Upload Beneficiary file To IFMS</td>
                                            <td width="20%">
                                                <div class="link_p2">
                                                <?php if ($drn_checking[0]['sftp_benf_sending_status'] == '2') 
                                                {
                                                ?>
                                                    <a class="btn btn-success" style="opacity:0.5;"> SEND TO IFMS</a>
                                                <?php
                                                } 
                                                else 
                                                {
                                                ?>
                                                    <a id="send_value1"  onClick="value_pass_sftp('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>');"><img src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer"></a>
                                                <?php 
                                                } ?>
                                                </div>
                                            </td>
                                            <td id="status1" width="20%"></td>
                                            <td width="20%">
                                                <div>
                                                    ...
                                                    <span id="edit_action_first_row2" onClick="sftp_edit('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>');"><img style="padding-bottom: 10px;" width="25" src="<?= $config['base_url']; ?>themes/default/image/edit_icon.png" alt="Edit"/></span>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                        <td width="20%">3. </td>
                                        <td width="20%">Bill Status View</td>
                                        <td width="20%"><div class="link_p3">
                                        	<a id="view_status"  onClick="value_pass_view('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>');"> <img src="<?php echo $config['base_url']; ?>themes/default/image/status_btn.png" class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer"></a></div>
                                        </td>
                    ...
                    <div class="table-responsive">
                        <div class="form-group">
                            <table width="100%">
                                <tr style="background-color: rgb(221, 247, 255);">
                                    <th colspan="6">
                                    	<h5>BILLING STATUS [ DRN No:<?php echo $drn_checking[0]['drn_number']; ?> ]</h5>
                                    </th>
                                </tr>
                                <tr>
                                    <th scope="col" width="20%">SL NO</th>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <div class="link_p2">
											...
											{
                                            ?>
                                                <a onClick="value_pass('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>', '<?php echo $encode_emp_type; ?>');" > <img id="send_bill_sum_id" src="<?php echo $config['base_url']; ?>themes/default/image/send_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer" /></a>
                                        ...
                                        <td width="20%">
                                            <div class="link_p2">
                                                ...
                                                ?>
                                                    ...
                                                    <a id="send_benf"  style="display:none;"  onClick="value_pass_sftp('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>','<?php echo $encode_emp_type; ?>');"><img src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer;"></a>
                                                <?php
                                                } 
                                                ...
                                                ?>
                                                    ...
                                                    <a id="send_benf"  onClick="value_pass_sftp('<?php echo $encode_requsition; ?>', '<?php echo $encode_drn; ?>','<?php echo $encode_emp_type; ?>');"><img src="<?php echo $config['base_url']; ?>themes/default/image/upload_btn.png"  class="img-responsive" style="width:50%; margin:0 auto; cursor:pointer"></a>
                                                <?php
                                                } 
                                                else 
                                                {
                                ...
                                <tr style="background-color: #DCEDC8;">
                                    ...
                                    <td width="20%" style="background-color: #DCEDC8;">
                                    	<div class="btn btn-default" style=" float:center; cursor:default; color:#1A237E;width:105px;"> &nbsp;<a href="<?= $config['base_url']?>page/api/ifms/zp/download_excel_for_payment_status.php"><i class="fa fa-money fa-2x reason_view" aria-hidden="true" style="color:#33691E;cursor:pointer;" ></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
//**************************************************************
	...
	function value_pass(encode_requsition, drn_number, emp_type)
	{
		$('#page-load').show();
		...
		$.post('<?= $config['base_url'] ?>page/api/ifms/zp/index.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type, function (data) {
	...
	function value_pass_sftp(encode_requsition, drn_number, emp_type)
	{
		//$('#page-load').show();
		var requsition = encode_requsition;
		var drn_no = drn_number;
		$.post('<?= $config['base_url'] ?>page/api/ifms/zp/sftp_index.php?bill_type='+requsition+'&drn_no='+drn_no+'&emp_type='+emp_type, function (data) {
	...
	function benf_status_check()
	{
		...
		$.post('<?= $config['base_url'] ?>page/api/ifms/prd_ifms_cron_job.php?user='+user, function (data) {
			//alert(data);
			$('#page-load').delay(500).fadeOut();
			//$('#status1').html(data); 
			location.reload();
	...
	function done_file_check()
	{
		...
		/*$('#refresh_icon_static').hide();
		$('#refresh_icon_dynamic').show();*/
		$.post('<?= $config['base_url'] ?>page/api/ifms/dot_done_ifms_cron_job.php?user='+user, function (data) {
			$('#page-load').delay(500).fadeOut();
			location.reload();
			//$('#status1').html(data); 
		});
