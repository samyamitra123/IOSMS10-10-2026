                            ...
                            <div class="col-xs-11  ">
                                <div class="offer offer-success">
                                    <div class="offer-content">
                                        <h1 class="heading">Salary BILL SELECTION</h1>
                                        ...
                                        <div class="form-group text-center" >
											...
											{ ?>
                                            	<a class="btn btn-info" href="view_zp_sal_requsition.php?emp_type=<?php echo $cryptoGraph->encode(366,4);?>">Government Employee Salary View</a>
											<?php } 
											else
											{ ?>
											...
											{ ?>
                                            	<a class="btn btn-info" href="view_zp_sal_requsition.php?emp_type=<?php echo $cryptoGraph->encode(367,4);?>">Grant-in-Aid Employee Salary View</a>
											<?php } 
											else
											{ ?>
                                        ...
                                        <div class="form-group text-center" >
                                        	<?php if($employee_type_fetch[0]['total_govt']>0)
											{ ?>
                                            	<a class="btn btn-info" href="text_file.php?emp_type=<?php echo $cryptoGraph->encode(366,4);?>">Government Employee Salary Bill</a>
											<?php } 
											else
											{ ?>
                                            ...
                                            <?php if($employee_type_fetch[0]['total_grant']>0)
											{ ?>
                                            	<a class="btn btn-info" href="text_file.php?emp_type=<?php echo $cryptoGraph->encode(367,4);?>">Grant-in-Aid Employee Salary Bill</a>
											<?php } 
											else
											{ ?>
