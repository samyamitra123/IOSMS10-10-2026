...
<!-- Latest compiled and minified JavaScript -->
    <div class="row" id="cont">
        <div class="col-lg-12 col-md-8 col-sm-8" id="sm-pad"> 
            <div class="col-sm-12">
                <h1 class="heading"><?php if($requisition_type=='1003'){echo "Supplementary ";} ?>Salary Bill Generation</h1>
                ...
                <div id="form_show" > 
                    ...
                    <form class="form-horizontal" id="gp_form" name="gp_form" method="post" >
                        ...
                        <input type="hidden" id="bill_type" name="bill_type" value="<?php echo $_GET['emp_type']; ?>"/>
                         <input type="hidden" id="requisition_type" name="requisition_type" value="<?php echo $_GET['requisition_type']; ?>"/>
...
<script>
	...
	$('#bill_report_month , #bill_report_year').change(function(){
			...
			var emp_type=$('#bill_emp_type').val();
			$.ajax({
				url:'<?php echo $config['base_url'] ?>page/intra_zp/salary_fcncao/text_file/find_bill.php',
				dataType:"json",
				type:'GET',
				data:{
				ye:year,
				...
				$.post('<?php echo $config['base_url'] ?>page/intra_zp/salary_fcncao/text_file/ajax_links.php?priv_drn='+data.priv_drn_number,$('#gp_form').serialize(), function(data){
