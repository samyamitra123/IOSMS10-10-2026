       ...
       sal.overdrawn, sal.salary_type, sal.cause, sal.part_day, sal.total_loan_deduction,sal.gsli,sal.consolidated_pay,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.hra_deduction,sal.other_loan_deduction,
									...
									INNER JOIN 
										...
										WHERE
											...
											AND sal.status_flag in('4') AND is_saved='1' AND sal.delete_status='1' AND salary_monthyear='".date('Ym')."'  AND requisition_type='".$requisition_type."' order by tch.emp_first_name ;
								");
	}
	else
	{
       ...
       sal.overdrawn, sal.salary_type, sal.cause, sal.part_day, sal.total_loan_deduction,sal.gsli,sal.consolidated_pay,sal.other_deduction,sal.cooperative_loan,sal.hbl_loan,sal.hbl_loan,festival_loan,sal.interim_relief,sal.hra_deduction,sal.other_loan_deduction,
									...
									INNER JOIN 
										...
										WHERE
											...
											AND sal.zp_id_fk = '".$_SESSION['location']['district_id']."'
											AND sal.zp_emp_type='".$employee_type."'
											AND sal.status_flag in('4') AND is_saved='1' AND sal.delete_status='1' AND salary_monthyear='".$monthyear."'  AND requisition_type='".$requisition_type."' order by tch.emp_first_name ;
								");
	}		
