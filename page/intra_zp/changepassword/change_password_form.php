...
<div class="border"></div>
	 ...
	 $cryptography=new cryptography(); 
        ...
        <form class="form-horizontal" action="<?= $config['base_url'] ?>page/intra_zp/changepassword/changepassword_insert_submit.php" name="login_form" id="form_emp_contact" method="post" enctype="multipart/form-data" onsubmit="return validForm();">
