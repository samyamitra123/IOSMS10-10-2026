<?php 
    ...
    * 
    */
   class gpUserFetchController extends AuthController
   {
     ...
     function getEmployee()
       {
          ...
          $Query ="SELECT ".$dataFetch." from prd_employee_master as pem
                   ...
                   WHERE pem.gp_id_fk != 0 AND emp_cosolidated_pay = 0 AND pem.emp_status = 1 AND (pem.emp_desig >= '1114' AND pem.emp_desig <= '1124')";
          //print_r($Query); exit;         
