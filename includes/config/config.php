...
$config['base_url'] = "http://172.25.138.175/";

$host="http://172.25.138.175/";
if($host=="http://172.25.138.175/"){
	//@header('location:http://172.25.138.175/');
	$config['base_url'] = "http://172.25.138.175/";	
}else if($host=="http://172.25.138.175/"){
	//@header('location:http://172.25.138.175/');
	$config['base_url'] = "http://172.25.138.175/";
}else{
	//$config['base_url'] = "http://172.25.138.175/";
...
$config['sftp_ip_gp']='202.61.117.96';

$config['sftp_user_name_gp']='gen006';

$config['sftp_user_password_gp']='Wb!fm$.06';
//echo "subikar2";exit;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$config['appointment']=1; // 1 to collect appointment Info 0 to disable
...
if(isset($_SESSION['last_login']))
{
 ...
 if(isset($_SESSION['user_info']['stake_abbr']))
 {
	 
	 $id=$_SESSION['user_info']['stake_user'];
	 
	/*if( (time()-$last_login>1200) && ($_SESSION['location']['ps_id']!='342' || $_SESSION['user_info']['stake_user']!='3299001001' || $_SESSION['user_info']['stake_user']!='3299001' ||$_SESSION['location']['district_id']!='21'))
	{*/
	if( (time()-$last_login>1200) && ($id!='32990011' && $id!='3299001001' && $id!='3299001' && $id!='3299'  && $id!='3206'  && $id!='3208'  && $id!='32990012' ) )
	{
	session_destroy();
