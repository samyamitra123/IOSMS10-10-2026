...
<table width="100%" class="maintable">
	...
	<tr>
	  ...
	  <td colspan="4">
	  <?php if($report['blocks'] != '' || $report['zp'] != ''){ ?>
      <table width="100%">
      	<?php 
        if($report['blocks'] != '') {
...
<style type="text/css">
   ...
   .maintable th{background-color: #916401;
    ...
    .pageHeading{text-align: center; color: #916401; border-bottom: 1px solid #000;text-transform: uppercase;width: 340px;margin: 0 auto;margin-bottom: 10px;padding-bottom: 5px; }
</style>